...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 145; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/graphiccard/b2bcad5fcf62c1c071ce430108fafe19.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Graphic Cards</h6>
                <h3 class="py-4">ZOTAC GeForce GTX 1070 Ti AMP Edition</h3>
                <h2>PKR 38,907</h2>
