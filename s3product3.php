...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 312; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg3/SilverStone Technology ECS07 5-Port SATA Gen3 6Gbps Non-RAID M_2 PCIe Storage Expansion Card, SST-ECS07.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">SilverStone Technology ECS07 5-Port</h3>
                <h2>PKR 14,108</h2>
                <input type="hidden" name="product_id" value="312"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Details</h4>
                <span>The SilverStone Technology ECS07 is a 5-Port SATA/SAS PCIe adapter card, designed to enhance storage capabilities in your system. It offers convenient connectivity for both SATA and SAS drives, expanding your storage options significantly. The PCIe interface ensures high-speed data transfer rates, making it ideal for data-intensive applications. This adapter card is also designed with efficient cooling solutions to maintain optimal performance and reliability for extended use. Whether you're building a storage server or simply need to increase your storage capacity, the ECS07 by SilverStone is a valuable addition that streamlines data management and accessibility in your system.</span>
            </div>
        </div>
        </form>
    </section>
