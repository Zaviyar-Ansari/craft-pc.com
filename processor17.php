...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 109; // Set the product ID to 3
    ...
    <form action="#" method="post">
        ...
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/images (9).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">Intel Xeon E Processor</h3>
                <h2>PKR 31,733</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Xeon E Processor</u></b></h4>
                </div>
                <span>
                    The Intel Xeon E series comprises processors tailored for professional and enterprise computing. Known for reliability and performance, these CPUs are ideal for servers and workstations. Offering features like ECC memory support, they excel in data center operations and virtualization. Xeon E processors are optimized for stability and consistent performance in demanding enterprise environments. Specific details vary based on the particular model within the Xeon E series.</span>
            </div>
        </div>
        </form?>
    </section>
