...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 274; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg/Thermaltake Core P5 Black Edition ATX Open Frame Panoramic Viewing Tt LCS Certified Gaming Computer Case CA-1E7-00M1WN-00.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Featured Products</h6>
                <h3 class="py-4">Thermaltake Core P5 Black Edition PC Case</h3>
                <h2>PKR 9,239</h2>
                ...
                <span>The Thermaltake Core P5 Black Edition is a unique open-frame computer case designed for PC enthusiasts and modders. It features a striking black finish and a transparent acrylic window, allowing you to showcase your hardware components. This case supports multiple form factors, including ATX, Micro ATX, and Mini ITX, giving users flexibility in their builds. The open layout design promotes excellent airflow and easy access for customization. It can be wall-mounted, further enhancing its aesthetic appeal. The Core P5 Black Edition is a popular choice for those looking to create a visually impressive and highly customizable PC build.</span>
            </div>
        </div>
    </form>
    </section>
