...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 194; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/17f650eee0d6273b858510a724a3dbc1.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">Seagate BarraCuda 3.5 HDD 1TB</h3>
                <h2>PKR 10,416</h2>
                <input type="hidden" name="product_id" value="194"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>Seagate BarraCuda 3.5 HDD</u></b>
                </div>
                <span>The Seagate BarraCuda 3.5 HDD is a versatile and reliable hard disk drive designed for various computing needs. With its 3.5-inch form factor, it offers ample storage capacity for your files and applications. Crafted by Seagate, a trusted brand in storage solutions, it guarantees reliability and durability. Whether for gaming, multimedia, or everyday computing tasks, the Seagate BarraCuda HDD delivers dependable performance at an affordable price.
