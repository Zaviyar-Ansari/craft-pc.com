...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 314; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg3/Jonsbo.jpeg"id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">Jonsbo FR925 9 CM ARGB fan</h3>
                <h2>PKR 1,936</h2>
                <input type="hidden" name="product_id" value="314"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Details</h4>
                <span>The Jonsbo FR925 9 CM ARGB fan is a compact yet powerful cooling solution for PCs. Measuring 9 cm, this fan offers efficient cooling for small form factor cases while adding vibrant RGB lighting effects to enhance your system's aesthetics. It's equipped with Addressable RGB (ARGB) technology, allowing you to customize and synchronize the lighting with other components. The FR925 is built with reliable and quiet operation in mind, ensuring both effective cooling and a peaceful computing environment. Whether you're looking to improve airflow and add a touch of style to your PC, the Jonsbo FR925 ARGB fan is a suitable choice for compact setups.</span>
            </div>
        </div>
        </form>
    </section>
