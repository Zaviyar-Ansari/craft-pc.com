...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 212;// Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/images (14).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">Seagate Desktop HDD 1000GB</h3>
                <h2>PKR 7,899</h2>
                <input type="hidden" name="product_id" value="212"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>Seagate Desktop HDD 1000GB</u></b>
                </div>
                <span>
The Seagate Desktop HDD offers a spacious storage capacity of 1000GB at an attractive price of PKR 7,899. Designed for desktop computers, this HDD provides ample space to store your files, documents, and multimedia content with ease. With reliable performance and robust build quality, it ensures smooth operation for your computing needs. Upgrade your desktop's storage capabilities with the Seagate Desktop HDD for a seamless user experience.
