...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 241; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/d680591a8144e88c3f620711e3d9a32d_tn.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4">ALSEYE Max Series 120mm Cooling Fan 3pc set </h3>
                <h2> PKR 23,242</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>ALSEYE Max Series 120mm Cooling Fan 3pc set</u></b>
                </div>
                <span> The ALSEYE Max Series 120mm Cooling Fan 3pc Set – a powerful cooling solution to optimize your PC's performance. With three high-performance fans included in the set, this package offers enhanced airflow to keep your components running efficiently. Each fan features a 120mm size and is designed to provide excellent cooling while maintaining low noise levels. The ALSEYE Max Series fans come with a sleek and durable design, suitable for various PC builds. Whether you're a gamer or a professional user, this fan set ensures effective heat dissipation for improved system stability. Upgrade your cooling setup with the ALSEYE Max Series 120mm Cooling Fan 3pc Set and enjoy cooler and quieter computing.</span>
            </div>
        </div>
    </form>
