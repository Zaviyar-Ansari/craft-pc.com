...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 316; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg3/Case Mod - In Progress - -Tainted Freshly Squeezed- COMPLETE + PICTURES.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">Case Mod Custom PC Case</h3>
                <h2>PKR 1,342</h2>
                <input type="hidden" name="product_id" value="316"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Details</h4>
                <span>A Case Mod Custom PC Case is a bespoke computer chassis designed to reflect the unique style and preferences of the builder. These cases often feature intricate customizations, from creative paint jobs to artistic additions, transforming the appearance of the case into a work of art. Beyond aesthetics, Case Mod Custom PC Cases are often customized for optimal airflow, cable management, and component placement. These cases require meticulous attention to detail and craftsmanship, making them a favorite among modding enthusiasts. Whether you're looking to showcase your creativity or optimize your PC's performance and aesthetics, a Case Mod Custom PC Case offers an individualized and eye-catching solution.</span>
            </div>
        </div>
        </form>
    </section>
