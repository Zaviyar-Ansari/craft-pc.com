...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 2; // Set the product ID to 3
    ...
    <form action="" method="post">
            <div class="row mt-5">
                <div class="col-lg-5 col-md-12 col-12">
                    <img class="img-fluid w-100 pb-1" src="prebuildimg1/Best Gaming PCs Under -1000 for 2020.jpeg" id="MainImg" alt="">
                </div>
                <div class="col-lg-6 col-md-12 col-12">
                    <h6> Home / Pre Build</h6>
                    <h3 class="py-4">Quantum Beast</h3>
                    <h2>PKR 150,000</h2>
                    ...
                    <div class="icon">
                        <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Lain Li Lancool II Mesh RGB</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>AMD Ryzen 5 7600X</u></b></h4>
                        <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>GeForce RTX 4070 Ti 12GB</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>Asus TUF Gaming B650M</u></b></h4>
                        <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>ADATA XPG 16 GB DDR5</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Crucial 1TB</u></b></h4>
                        <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Corsair RM750e</u></b></h4>
                    </div>
                    <span>Unleash gaming prowess with the Lian Li Lancool II Mesh RGB PC featuring an AMD Ryzen 5 7600X and GeForce RTX 4070 Ti 12GB for stellar performance. The ASUS TUF Gaming B650M motherboard ensures stability, paired with ADATA XPG 16GB DDR5 RAM for seamless multitasking. Storage is a breeze with the Crucial 1TB SSD, all powered by the reliable Corsair RM750e. Housed in the stylish Lian Li case, this gaming rig seamlessly combines power and aesthetics for an immersive gaming experience. Elevate your setup with this high-performance, visually striking gaming PC.</span>
