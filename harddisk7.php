...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 199; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/d73b47cc5f50af3a3477c74aaa2fcd0a.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">HITACHI 0S03364 DESKSTAR 4TB</h3>
                <h2>PKR 19,720</h2>
                <input type="hidden" name="product_id" value="199"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>HITACHI 0S03364 DESKSTAR 4TB</u></b>
                </div>
            <span>The Hitachi 0S03364 Deskstar offers ample storage space with its 4TB capacity, suitable for storing large amounts of data including documents, photos, videos, and more. Its reliable performance ensures smooth operations, making it ideal for both personal and professional use. With Hitachi's reputation for quality and durability, this hard drive provides peace of mind for long-term storage needs. Its efficient design and affordable price make it a practical choice for expanding your storage capabilities. Experience reliable storage solutions with the Hitachi 0S03364 Deskstar 4TB hard drive.</span>
            </div>
        </div>
        </form>
    </section>
