...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 213; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/cpucooler/03a293d508ebcf6e8b412a5bda212834.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4"> NZXT T120 Black CPU Air Cooler</h3>
                <h2> PKR 17,130</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/istockphoto-1373113476-612x612 (1).jpg" alt=""> <b><u>NZXT T120 Black CPU Air Cooler </u></b>
                </div>
                <span>The NZXT T120 Black CPU Air Cooler is a high-performance cooling solution designed to keep your CPU running efficiently. With its sleek black design, it adds a touch of style to your system while effectively dissipating heat. Engineered for quiet operation, it ensures a peaceful computing experience even under heavy loads. Its durable construction and advanced cooling technology make it an ideal choice for gamers, content creators, and PC enthusiasts seeking optimal thermal management. Upgrade your cooling system with the NZXT T120 Black CPU Air Cooler for reliable performance and enhanced longevity. </span>
            </div>
        </div>
    </form>
