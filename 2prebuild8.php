...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 28; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/News｜ASUS Global.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">SilentMaster Deluxe</h3>
                <h2>PKR 100,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>ASUS ROG Huracan Case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>AMD Ryzen 5 3600</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GeForce GTX 1660 Super</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>MSI B450 TOMAHAWK MAX</u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>Corsair Vengeance LPX 16GB DDR4</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Kingston A2000 1TB NVMe </u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Cooler Master MWE 550W 80+ Bronze</u></b></h4>
                </div>
                <span>The ASUS ROG Huracan Case accommodates a potent gaming setup, featuring an AMD Ryzen 5 3600 processor and an NVIDIA GeForce GTX 1660 Super GPU for solid gaming performance. The MSI B450 TOMAHAWK MAX motherboard ensures compatibility and reliability for the AMD processor. With Corsair Vengeance LPX 16GB DDR4 RAM, multitasking is smooth and responsive. Storage is provided by a capacious Kingston A2000 1TB NVMe SSD, delivering fast data access. The power supply is a Cooler Master MWE 550W 80+ Bronze unit, offering efficient and reliable power delivery. This configuration creates a well-balanced gaming system housed in the ASUS ROG Huracan Case.</span>
            </div>
        </div>
        </form>
    </section>
