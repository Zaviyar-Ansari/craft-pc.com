...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 297; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/GIGABYTE TRX40 AORUS PRO WiFi.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">GIGABYTE TRX40 AORUS PRO WiFi </h3>
                <h2>PKR 179,260</h2>
                ...
                <span> The GIGABYTE TRX40 AORUS PRO WiFi is a high-end motherboard designed for AMD Ryzen Threadripper processors. It provides an excellent foundation for high-performance computing and content creation with its robust feature set. With support for the TRX40 chipset, this motherboard accommodates Threadripper CPUs with exceptional power and efficiency. It also features Wi-Fi support for seamless connectivity and comes equipped with multiple PCIe slots and M.2 connectors for expandability. The AORUS PRO WiFi is built with GIGABYTE's renowned build quality, ensuring durability and reliability. If you're building a powerful workstation or gaming rig around a Threadripper CPU, this motherboard offers a solid platform for your needs. </span>
