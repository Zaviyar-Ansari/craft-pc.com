...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 284; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg/Memória G_Skill Trident Z RGB, 32GB (2x16GB), 3200MHz, DDR4, CL16 - F4-3200C16D-32GTZR.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">G.Skill Trident Z RGB 32GB</h3>
                <h2>PKR 58,990</h2>
                ...
                <span>The G.Skill Trident Z RGB 32GB RAM kit is a remarkable choice for users who crave both exceptional performance and dazzling aesthetics in their PC build. This memory kit, with its 32GB capacity, delivers ample space for demanding tasks such as content creation, gaming, and more. What sets it apart is its vibrant RGB lighting, which can be customized to match your setup's theme and adds a stunning visual element to your rig. The Trident Z RGB series is renowned for its high-speed performance, boasting impressive data transfer rates for smooth multitasking and application performance. Whether you're a gamer or a content creator, this memory kit elevates your PC's capabilities while enhancing its visual appeal.</span>
            </div>
        </div>
        </form>
    </section>
