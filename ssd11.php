...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 163; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ssd/403139e72270fb7e074fc76904b3500f.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / SSD</h6>
                <h3 class="py-4">MyDigitalSSD BPX 80mm (2280) M.2 PCi 480GB</h3>
                <h2>PKR 21,805</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>MyDigitalSSD BPX 80mm (2280) M.2 PCi 480GB</u></b></h4>
                </div>
                <span>
The MyDigitalSSD BPX 80mm (2280) M.2 PCIe 480GB SSD is a high-quality storage solution designed to enhance your computing experience. With its PCIe interface and M.2 form factor, it delivers impressive data transfer speeds and efficient performance for various tasks. Boasting a generous 480GB capacity, it provides ample storage space for your operating system, applications, and multimedia files. Whether you're a professional or a casual user, this SSD offers reliability and speed to meet your computing needs. Upgrade to the MyDigitalSSD BPX SSD for improved efficiency and responsiveness in your daily computing tasks.</span>
            </div>
        </div>
        </form>
    </section>
