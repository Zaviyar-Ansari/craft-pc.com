...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 281; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg/Gigabyte Z170 Motherboards Shown off - Legacy and Gaming G1 Series Impressive in Designs.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">Gigabyte Z170 Motherboard</h3>
                <h2>PKR 18,899</h2>
                ...
                <span>The Gigabyte Z170 motherboard is a high-performance motherboard designed to support Intel's 6th generation Core processors. With its feature-rich design, it offers a wide range of connectivity options, including USB 3.1 and M.2 slots, ensuring fast data transfer speeds. This motherboard also supports multiple GPUs for gamers and content creators, enhancing graphics capabilities. Its high-quality components and advanced cooling solutions help maintain stable performance, even under heavy workloads. The Gigabyte Z170 motherboard is an excellent choice for those seeking a reliable and feature-packed foundation for their PC build, whether for gaming or professional tasks.</span>
            </div>
        </div>
        </form>
    </section>
