...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 58; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/case/Fractal Design Torrent Clear Tempered Glass E-Atx Mid-Tower Case In White.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Cases</h6>
                <h3 class="py-4">Fractal Design Torrent White E-ATX Tempered Glass</h3>
                <h2>PKR 61,841</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Fractal Design Torrent White E-ATX Tempered Glass</u></b>
                </div>
                <span>
                    The Fractal Design Torrent White E-ATX Tempered Glass is a spacious and stylish computer case designed to accommodate Extended-ATX motherboards. With its clean white color and tempered glass side panel, it offers a sleek and modern aesthetic. The case provides ample room for high-performance components, making it suitable for gaming and content creation setups</span>
            </div>
        </div>
        </form>
    </section>
