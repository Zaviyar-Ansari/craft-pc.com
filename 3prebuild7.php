...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 47; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg3/Thermaltake.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Cosmic Serenity</h3>
                <h2>PKR 190,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Thermaltake Core P5 Case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i7-11700K 8-core</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GeForce RTX 3070 8GB</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>ASUS Prime Z590-A ATX</u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>Corsair Vengeance LPX 32GB DDR4</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Samsung 970 EVO Plus 1TB NVMe M.2</u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>EVGA SuperNOVA 750 G5</u></b></h4>
                </div>
                <span>The Thermaltake Core P5 case showcases the high-performance Intel Core i7-11700K processor and an NVIDIA GeForce RTX 3070 8GB GPU for exceptional gaming and content creation. Supported by the ASUS Prime Z590-A ATX motherboard and Corsair Vengeance LPX 32GB DDR4 RAM, it ensures seamless multitasking. Rapid data access is provided by the Samsung 970 EVO Plus 1TB NVMe M.2 SSD. The system is powered by the reliable EVGA SuperNOVA 750 G5 PSU, delivering stable and efficient power for an immersive computing experience.</span>
            </div>
        </div>
        </form>
    </section>
