...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 60; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/case/InWin D-Frame 2_0.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Cases</h6>
                <h3 class="py-4">In-Win IW-D-FRAME 2.0 BLACK GOLD </h3>
                <h2>PKR 341,602</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>In-Win IW-D-FRAME 2.0 BLACK GOLD</u></b>
                </div>
                <span>
                    The In-Win IW-D-FRAME 2.0 Black Gold is a unique and eye-catching computer chassis with a distinctive design. Featuring a black and gold color scheme, it stands out as a visually appealing case. The open-frame structure provides easy access to components and allows for efficient cooling, making it a suitable choice for users who prioritize both aesthetics and performance in their PC builds.</span>
            </div>
        </div>
        </form>
    </section>
