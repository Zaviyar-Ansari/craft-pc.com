...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 31; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/PCSPECIALIST Tornado R9i Gaming PC - AMD Ryzen 9, RTX 3080 Ti, 2 TB HDD & 1 TB SSD.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">PowerBeast Pro</h3>
                <h2>PKR 150,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Cooler Master TD300 Mesh Case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>AMD Ryzen 5 5600X</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u> NVIDIA GeForce GTX 1660 Super</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u> ASUS Prime B550M-A</u></b></h4>
                    ...
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Corsair CV550 80+ Bronze</u></b></h4>
                </div>
                <span>
                    The Cooler Master TD300 Mesh Case houses a formidable system featuring the AMD Ryzen 5 5600X processor and NVIDIA GeForce GTX 1660 Super graphics, ensuring a powerful gaming experience. The ASUS Prime B550M-A motherboard provides stability and features for seamless integration. With Corsair Vengeance LPX 16GB DDR4 RAM, multitasking is efficient and smooth. Storage is handled by the Kingston A2000 1TB NVMe PCIe M.2 SSD, offering both speed and ample capacity. The system is powered by the reliable Corsair CV550 80+ Bronze PSU, delivering stable and efficient power to the components. This configuration delivers a balanced and high-performing setup for gaming and productivity within the Cooler Master TD300 Mesh Case.</span>
            </div>
        </div>
        </form>
    </section>
