...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 104; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/images (4).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">AMD Ryzen 7-7700X</h3>
                <h2>PKR 74,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>AMD Ryzen 7-7700X</u></b></h4>
                </div>
                <span>The AMD Ryzen 7-7700X is a high-performance CPU part of 7000 series Processor. It features 8 cores and 16 threads, offering excellent multitasking capabilities. With a base clock speed up to 4.5GHz and a max turbo frequency of 5.4 GHz, it delivers strong single-core performance. The processor supports DDR5 memory and PCIe 5.0, enhancing overall system speed. It's well-suited for gaming, content creation, and demanding computing tasks.</span>
            </div>
        </div>
        </form?>
    </section>
