...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 63; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/case/Xigmatek Perseus (1).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Cases</h6>
                <h3 class="py-4">Xigmatek Preseus X5 Cy120 ARGB</h3>
                <h2>PKR 22,999</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Xigmatek Preseus X5 Cy120 ARGB</u></b>
                </div>
                <span>
                    The Xigmatek Preseus X5 Cy120 ARGB is a computer case with integrated cooling features. Featuring ARGB (Addressable RGB) lighting, it adds a vibrant and customizable aesthetic to your build. The case is designed to provide efficient airflow and cooling performance, making it suitable for users who prioritize both aesthetics and thermal management in their PC setups.</span>
            </div>
        </div>
        </form>
    </section>
