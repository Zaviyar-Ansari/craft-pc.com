...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 102; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/dd19d2dd4bc915cddd851ea343530c11.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">Intel Core i7-7820X</h3>
                <h2>PKR 136,799</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i7-7820X</u></b></h4>
                </div>
                <span>
                    The Intel Core i7-7820X is a processor from the Skylake-X series, featuring 8 cores and 16 threads. With a base clock speed of 3.6 GHz and a maximum turbo frequency of 4.3 GHz, it's designed for high-performance computing tasks. Utilizing the LGA 2066 socket and built on the Skylake architecture, it provides strong multi-threaded and single-threaded performance. The i7-7820X is part of Intel's enthusiast-level lineup, offering solid capabilities for gaming, content creation, and other demanding applications. Specific details may vary based on regional availability and exact SKU.</span>
            </div>
        </div>
        </form?>
    </section>
