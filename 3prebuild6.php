...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 46; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg3/CyberPowerPC - Gamer Xtreme Desktop - Intel Core….jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Eclipse Enigma</h3>
                <h2>PKR 155,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Cyber Power PC Case </u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i5-11400 6-core</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GeForce GTX 1660 Super 6GB</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>MSI B560M PRO-VDH Micro ATX </u></b></h4>
                    ...
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Cooler Master MWE 650W</u></b></h4>
                </div>
                <span>The Cyber Power PC case houses a robust system featuring the Intel Core i5-11400 6-core processor and an NVIDIA GeForce GTX 1660 Super 6GB GPU, delivering solid performance for gaming and productivity. The MSI B560M PRO-VDH Micro ATX motherboard ensures stable connectivity, paired with Corsair Vengeance LPX 16GB DDR4 RAM for efficient multitasking. Swift data access is facilitated by the Kingston A2000 500GB NVMe M.2 SSD. The system is powered by the Cooler Master MWE 650W, providing reliable and ample power for a smooth computing experience.
