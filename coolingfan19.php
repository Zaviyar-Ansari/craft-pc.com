...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 252; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            ...
            <div class="col-lg-6 col-md-12 col-12">
                ...
                <h3 class="py-4">Thermaltake Pure 12 ARGB Sync Radiator Fan TT Premium Edition</h3>
                <h2> PKR 12,826 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>Thermaltake Pure 12 ARGB Sync Radiator Fan TT Premium Edition</u></b>
                </div>
                <span>The Thermaltake Pure 12 ARGB Sync Radiator Fan TT Premium Edition, priced at PKR 12,826. This fan is designed to provide efficient cooling for your radiator setup while adding vibrant ARGB lighting effects. With synchronization capabilities, it seamlessly integrates with other TT RGB Plus-compatible components for a unified lighting scheme. Engineered for optimal airflow and heat dissipation, it ensures reliable performance even under heavy loads. Upgrade your cooling system with the Thermaltake Pure 12 ARGB Sync Radiator Fan TT Premium Edition and enjoy both enhanced cooling performance and stunning ARGB illumination. </span>
            </div>
        </div>
    </form>
