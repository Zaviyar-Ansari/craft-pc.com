...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 181; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/powersupply/522f912613d59fdd5266cc2e4c216f73.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Powersupply</h6>
                <h3 class="py-4">Chieftec PowerPlay 750Watt 20+4 pins ATX PS/2</h3>
                <h2>PKR 42,711 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Chieftec PowerPlay 750Watt 20+4 pins ATX PS/2</u></b></h4>
                </div>
                <span> The Chieftec PowerPlay 750Watt is a robust power supply unit featuring 20+4 pins ATX PS/2 compatibility. With its 750-watt capacity, it provides sufficient power for various computing needs. Engineered for reliability, it ensures stable power delivery to your PC components. Crafted by Chieftec, a trusted brand in PC hardware, it guarantees performance and durability. Upgrade your PC's power supply with the Chieftec PowerPlay 750Watt for reliable operation and compatibility.
