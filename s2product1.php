...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 290; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/1056 Aragon 900 water cooling system.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">1056 Aragon 900 water cooling system </h3>
                <h2>PKR 58,093</h2>
                ...
                <span>The 1056 Aragon 900 water cooling system is a remarkable cooling solution for PCs, offering efficient temperature control for high-performance rigs. This all-in-one liquid cooling system boasts a robust radiator and a powerful pump, ensuring effective heat dissipation while maintaining low noise levels. It's compatible with a variety of CPU sockets, making it versatile for different builds. The Aragon 900 comes with a user-friendly design, making installation relatively straightforward. This cooling system is a great choice for enthusiasts and gamers looking to keep their CPU temperatures in check, enhance overclocking capabilities, and maintain a quieter computing environment.  </span>
