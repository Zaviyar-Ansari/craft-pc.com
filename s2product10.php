...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 299; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/Seagate BarraCuda Internal Hard Drive 4TB SATA 6Gb_s 256MB Cache 3_5-Inch (ST4000DM005).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4"> Seagate BarraCuda Internal Hard Drive</h3>
                <h2>PKR 8,800</h2>
                ...
                <span> The Seagate BarraCuda Internal Hard Drive is a reliable storage solution that caters to a variety of needs, from expanding your computer's storage capacity to boosting performance. Available in different capacities, it offers ample space for storing documents, media files, and games. This drive is known for its durability and fast data transfer rates, ensuring smooth and efficient operation. The BarraCuda series is widely appreciated for its versatility, making it a suitable choice for both desktop and laptop upgrades. Whether you require more storage or are building a new system, the Seagate BarraCuda Internal Hard Drive provides a cost-effective and dependable solution. </span>
