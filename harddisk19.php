...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 211; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/images (13).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">Seagate SATA 3.5 Hard Drive 1TB</h3>
                <h2>PKR 8,200</h2>
                <input type="hidden" name="product_id" value="211"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>Seagate SATA 3.5 Hard Drive 1TB</u></b>
                </div>
                <span>
The Seagate SATA 3.5 Hard Drive offers ample storage capacity of 1TB at an affordable price of PKR 8,200. Ideal for both personal and professional use, it provides reliable performance and efficient data storage for your desktop computer or custom-built system. With its SATA interface, this hard drive ensures fast data transfer speeds and seamless integration into your existing setup. Upgrade your storage solution with this dependable Seagate hard drive.</span>
            </div>
        </div>
        </form>
    </section>
