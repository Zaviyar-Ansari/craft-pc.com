...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 80; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/motherboard/32282e9b761a490b189f29bc0440b72e.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Motherboards</h6>
                <h3 class="py-4">ASUS Sabertooth Z170 S</h3>
                <h2>PKR 47,142</h2>
                ...
                <div class="icon">
                    <h4> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>ASUS Sabertooth Z170 S</u></b>
                </div>
                <span>
                    The ASUS Sabertooth Z170 S is a reliable and durable motherboard based on the Intel Z170 chipset. Designed for 6th and 7th generation Intel Core processors, it offers a balance of performance and stability. With TUF components and a unique camouflage design, it emphasizes durability and a distinctive aesthetic. Featuring advanced cooling solutions and customizable LED lighting, it caters to users looking for a robust and visually appealing platform for their gaming or productivity set</span>
            </div>
        </div>
        </form>
    </section>
