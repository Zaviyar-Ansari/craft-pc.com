...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 269; // Set the product ID to 3
        ...
        <form action="#" method="post">
            <div class="row mt-5">
                <div class="col-lg-5 col-md-12 col-12">
                    <img class="img-fluid w-100 pb-1" src="shopprodimg/MSI MEG Z690 GODLIKE Motherboard E-ATX - Intel 12th Gen Processors - 20+2 Phase, DDR5, PCIe 5_0.jpeg" id="MainImg" alt="">
                </div>
                <div class="col-lg-6 col-md-12 col-12">
                    <h6> Home / Shop / Featured Products</h6>
                    <h3 class="py-4">MSI MEG Z690 Motherboard</h3>
                    <h2>PKR 192,499</h2>
                    ...
                    <span>The MSI MEG Z690 motherboard is a top-tier, feature-rich motherboard designed for Intel's 12th generation Alder Lake processors, using the LGA 1700 socket. In an ATX form factor, it's equipped with the Intel Z690 chipset, which supports high-speed DDR5 memory, PCIe 5.0, and USB 3.2 Gen 2x2. With four DDR5 DIMM slots for up to 128GB of memory, multiple PCIe slots, M.2 slots, and various storage options, it offers excellent expansion possibilities. Networking is top-notch with options like 2.5 Gigabit Ethernet, Wi-Fi 6E, and Bluetooth. High-quality audio components, RGB lighting, overclocking features, user-friendly BIOS, and a suite of software tools make this motherboard an attractive choice for gamers, content creators, and PC enthusiasts. Its premium build quality ensures durability, and the specific model may vary in terms of I/O connectivity and additional features.</span>
