...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 91; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/motherboard/This motherboard looks sick.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Motherboards</h6>
                <h3 class="py-4">ASUS MAXIMUS VII FORMULA lGA1150</h3>
                <h2> PKR 137,037</h2>
                ...
                <div class="icon">
                    <h4> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>ASUS MAXIMUS VII FORMULA lGA1150</u></b>
                </div>
                <span>The ASUS MAXIMUS VII FORMULA is a motherboard designed for 4th generation Intel Core processors, utilizing the LGA1150 socket. Built on the Intel Z97 chipset, it offers high-end features for gaming and performance. With an ATX form factor, it supports multiple PCIe slots, DDR3 memory, and advanced overclocking capabilities. The motherboard is part of the Republic of Gamers (ROG) series, known for catering to gaming enthusiasts with premium components and customizable aesthetics. Please note that specifications and availability may vary based on region and updates.</span>
            </div>
        </div>
        </form>
    </section>
