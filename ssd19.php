...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 171; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ssd/eb2df4051b8170357456bc030e6b37c5.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / SSD</h6>
                <h3 class="py-4">Samsung 960 EVO M.2 2TB</h3>
                <h2>PKR 166,149,68</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Samsung 960 EVO M.2 2TB</u></b></h4>
                </div>
                <span>The Samsung 960 EVO M.2 2TB SSD offers exceptional storage capacity and high-performance speed for demanding computing tasks. With its M.2 form factor and NVMe interface, it delivers lightning-fast data transfer speeds, ensuring rapid system boot-up and application loading times. Boasting an impressive 2TB capacity, it provides ample storage space for your operating system, applications, games, and multimedia files. Whether you're a professional user or a gaming enthusiast, this SSD ensures reliable performance and efficient data access. Upgrade to the Samsung 960 EVO SSD for unparalleled speed and storage capacity to meet your computing needs.</span>
            </div>
        </div>
        </form>
    </section>
