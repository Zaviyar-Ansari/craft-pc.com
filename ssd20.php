...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 172; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ssd/fb0f44c1ce6add2687cc67eb87d7d3cc.jpg"" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / SSD</h6>
                <h3 class="py-4">Kingstone NV2 PCIe 4.0 NVMe M.2 250GB</h3>
                <h2>PKR 6,700</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Kingstone NV2 PCIe 4.0 NVMe M.2 250GB</u></b></h4>
                </div>
                <span>
The Kingstone NV2 PCIe 4.0 NVMe M.2 250GB SSD offers fast and efficient storage performance in a compact M.2 form factor. With its PCIe 4.0 interface and NVMe technology, it delivers rapid data transfer speeds, ensuring quick system boot-up and application loading times. Boasting a capacity of 250GB, it provides sufficient space for your operating system, applications, and essential files. This SSD is ideal for upgrading laptops or desktops, offering improved system responsiveness and efficiency. Upgrade to the Kingstone NV2 SSD for reliable and cost-effective storage to enhance your computing experience.</span>
            </div>
        </div>
        </form>
    </section>
