...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 210; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/images (12).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">Seagate SATA 3.5 Hard Drive 4TB</h3>
                <h2>PKR 25,199</h2>
                <input type="hidden" name="product_id" value="210"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>Seagate SATA 3.5 Hard Drive 4TB</u></b>
                </div>
                <span>The Seagate SATA 3.5 Hard Drive offers a spacious 4TB storage capacity, catering to your data storage needs effectively. Its SATA interface ensures swift data transfer rates, enhancing overall system performance. This hard drive is a reliable choice for expanding storage in desktop computers or building custom systems. Backed by Seagate's renowned reliability, it provides peace of mind for your storage requirements.</span>
            </div>
        </div>
        </form>
    </section>
