...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 270; // Set the product ID to 3
        ...
        <form action="#" method="post">
            <div class="row mt-5">
                <div class="col-lg-5 col-md-12 col-12">
                    <img class="img-fluid w-100 pb-1" src="shopprodimg/AMD Ryzen 5 2600X Processor with Wraith Spire Cooler - YD260XBCAFBOX.jpeg" id="MainImg" alt="">
                </div>
                <div class="col-lg-6 col-md-12 col-12">
                    <h6> Home / Shop / Featured Products</h6>
                    <h3 class="py-4">AMD Ryzen 5 2600X Processor</h3>
                    <h2>PKR 27,000</h2>
                    ...
                    <span>The AMD Ryzen 5 2600X is a mid-range processor known for its impressive performance. It features six cores and twelve threads, utilizing the AM4 socket. With a base clock speed of 3.6 GHz and a boost clock of 4.2 GHz, it offers excellent multitasking capabilities. The processor's 12nm Zen+ architecture ensures efficient power usage and enhanced gaming performance. It also includes an unlocked multiplier for overclocking enthusiasts. The Ryzen 5 2600X is a solid choice for gamers and content creators looking for a cost-effective solution for their computing needs.</span>
                </div>
            </div>
            </form>
        </section>
