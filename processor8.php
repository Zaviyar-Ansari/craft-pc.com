...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 100; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/images (14).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">Intel Core i9-9900KS</h3>
                <h2>PKR 149,602</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i9-9900KS</u></b></h4>
                </div>
                <span>The Intel Core i9-9900KS is a special edition processor from the 9th generation Intel Core series. It features 8 cores and 16 threads, with a base clock speed of 4.0 GHz and a maximum turbo frequency of 5.0 GHz across all cores. Utilizing the LGA 1151 socket and built on the Coffee Lake architecture, the i9-9900KS is designed for high-end desktop performance. It is well-suited for gaming, content creation, and other demanding tasks, offering enhanced clock speeds compared to the standard i9-9900K. This processor is known for its strong out-of-the-box performance without the need for manual overclocking. Specific details may vary based on regional availability and exact SKU.</span>
            </div>
        </div>
        </form?>
    </section>
