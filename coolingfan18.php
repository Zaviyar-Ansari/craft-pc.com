...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 251; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/images (27).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4">DEEPCOOL RF 120mm 3in1 Ultra Quite Intelligent PWM Fan</h3>
                <h2>PKR 17,779 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>DEEPCOOL RF 120mm 3in1 Ultra Quite Intelligent PWM Fan</u></b>
                </div>
                <span> The DEEPCOOL RF 120mm 3in1 Ultra Quiet Intelligent PWM Fan, priced at PKR 17,779. This fan set offers high-quality cooling performance with its 120mm size and features intelligent PWM control for optimal airflow and noise reduction. Designed to operate quietly, it ensures a peaceful computing environment. With its versatile 3-in-1 configuration, this fan set provides flexibility for various PC setups. Upgrade your cooling system with the DEEPCOOL RF 120mm 3in1 Ultra Quiet Intelligent PWM Fan and enjoy efficient cooling with minimal noise.</span>
            </div>
        </div>
    </form>
