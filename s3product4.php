...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 313; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg3/Sound Blaster Z PCIe Gaming Sound Card with High Performance Headphone Amp and Beam Forming Microphone.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">Sound Blaster Z PCIe Gaming Sound Card</h3>
                <h2>PKR 53,392</h2>
                <input type="hidden" name="product_id" value="313"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Details</h4>
                <span>The Sound Blaster Z PCIe Gaming Sound Card is a premium audio solution catering to gamers and audio enthusiasts. With support for 5.1-channel surround sound, it enhances the gaming experience with immersive and high-quality audio. This sound card features the SBX Pro Studio technology, providing customizable audio enhancements and crystal-clear sound reproduction. It offers a variety of connectivity options, including headphone and microphone jacks, making it versatile for different audio needs. The Sound Blaster Z is known for its reliability and clear audio output, making it an excellent choice for those looking to elevate their gaming or audio experience on their PC.</span>
            </div>
        </div>
        </form>
    </section>
