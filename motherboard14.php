...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 85; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/motherboard/c7b336d7f3373244ef92c0fc590c6940.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Motherboards</h6>
                <h3 class="py-4">ASUS PRIME Z370-A LGA1151</h3>
                <h2>PKR 48,532</h2>
                ...
                <div class="icon">
                    <h4> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>ASUS PRIME Z370-A LGA1151</u></b>
                </div>
                <span>
                    The ASUS PRIME Z370-A LGA1151 is a motherboard designed for 8th and 9th generation Intel Core processors, utilizing the LGA1151 socket. Built on the Intel Z370 chipset, it offers a balance of performance and features. With an ATX form factor, it provides multiple PCIe slots, DDR4 memory support, and robust power delivery. The motherboard features ASUS OptiMem technology for improved memory stability, and it caters to users seeking a reliable platform for gaming, productivity, and other computing tasks.</span>
            </div>
        </div>
        </form>
    </section>
