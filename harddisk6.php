...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 198; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/d4fad3756c1fbedd67b32236e08bbc99.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">WD Blue SATA Hard Disk 4TB</h3>
                <h2>PKR 13,999</h2>
                <input type="hidden" name="product_id" value="198"> <!-- Set the product ID -->
                ...
                <span>The WD Blue SATA Hard Disk 4TB is a reliable and spacious storage solution suitable for various computing needs. With its 4TB storage capacity, it offers ample space for storing files, documents, and multimedia content. Crafted by Western Digital, a trusted brand in storage solutions, it ensures reliability and durability for long-term use. Whether for personal or professional use, the WD Blue 4TB HDD delivers dependable performance at an affordable price.</span>
            </div>
        </div>
        </form>
    </section>
