...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 193; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/8b00cc4f8a564353a51c922507c24fbe.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">WD Caviar Black 3.5 SATA II HDD</h3>
                <h2>PKR 4,266</h2>
                <input type="hidden" name="product_id" value="193"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>WD Caviar Black 3.5 SATA II HDD</u></b>
                </div>
                <span>The WD Caviar Black 3.5 SATA II HDD is a reliable and high-performance hard disk drive suitable for various computing needs. With its SATA II interface, it offers fast data transfer speeds for efficient storage operations. Crafted by Western Digital, a trusted brand in storage solutions, it guarantees reliability and durability. Upgrade your storage capacity with the WD Caviar Black HDD for seamless data storage and retrieval at an affordable price.</span>
            </div>
        </div>
        </form>
    </section>
