...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 180; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/powersupply/93e21cd45b7b6c12af0b74200bbbee7d.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Powersupply</h6>
                <h3 class="py-4">DARK POWER 12 1000Watt silent high-end Power</h3>
                <h2>PKR 68,533</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>DARK POWER 12 1000Watt silent high-end Power</u></b></h4>
                </div>
                <span>The DARK POWER 12 1000Watt is a silent high-end power supply unit designed for premium PC builds. With its 1000-watt capacity, it provides abundant power for high-performance computing tasks. Engineered for silent operation, it ensures minimal noise disturbance during use. Crafted with top-tier components, the DARK POWER 12 guarantees reliability and stability for your PC components. Elevate your PC's power performance with the DARK POWER 12 1000Watt for a seamless and efficient computing experience. </span>
            </div>
        </div>
        </form?>
    </section>
