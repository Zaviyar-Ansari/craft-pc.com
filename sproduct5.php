...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 273; // Set the product ID to 3
        ...
        <form action="#" method="post">
            <div class="row mt-5">
                <div class="col-lg-5 col-md-12 col-12">
                    <img class="img-fluid w-100 pb-1" src="shopprodimg/Thermaltake Toughpower Grand RGB 1200W Power Supply Unit Review.jpeg" id="MainImg" alt="">
                </div>
                <div class="col-lg-6 col-md-12 col-12">
                    <h6> Home / Shop / Featured Products</h6>
                    <h3 class="py-4">Thermaltake Grand RGB 1200W Power Supply</h3>
                    <h2>PKR 1,929,399</h2>
                    ...
                    <span>The Thermaltake Grand RGB 1200W Power Unit is a high-capacity power supply designed for demanding gaming and enthusiast setups. With a whopping 1200 watts of power, it can easily handle multiple GPUs, high-performance CPUs, and extensive storage configurations. It comes equipped with RGB lighting for aesthetic customization and adds a touch of flair to your system. The power supply is known for its modular design, allowing you to connect only the cables you need, reducing clutter and improving airflow. It features 80+ Gold certification for energy efficiency and stable power delivery. The Thermaltake Grand RGB 1200W is an excellent choice for those seeking a powerful and visually appealing PSU for their high-end PC builds.</span>
                </div>
            </div>
            </form>
        </section>
