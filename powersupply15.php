...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 187; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/powersupply/339164239d7b28431f10aaa4ca4bb672.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Powersupply</h6>
                <h3 class="py-4">Thermaltake Smart M 650 Bronze</h3>
                <h2>PKR 19,956 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u> Thermaltake Smart M 650 Bronze</u></b></h4>
                </div>
                <span>The Thermaltake Smart M 650 Bronze is a reliable power supply unit offering efficient performance. With its 650-watt capacity and Bronze certification, it balances power and efficiency for your PC. Engineered for stability, it ensures consistent power delivery to your components. Crafted by Thermaltake, a trusted brand in PC hardware, it guarantees reliability and performance. Upgrade your PC's power supply with the Thermaltake Smart M 650 Bronze for dependable operation at an affordable price. </span>
            </div>
        </div>
        </form?>
    </section>
