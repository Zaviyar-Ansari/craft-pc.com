...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 45; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg3/amazing case.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Cyber Titan X</h3>
                <h2>PKR 180,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>GameKM War Beast ATX Case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i7-11700K 8-core</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GeForce RTX 3060 12GB</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>ASUS Prime Z590-A ATX </u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>Corsair Vengeance LPX 16GB DDR4</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Samsung 970 EVO Plus 500GB NVMe M.2 </u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>EVGA SuperNOVA 750 G5</u></b></h4>
                </div>
                <span>Housed in the GameKM War Beast ATX Case, this system features an Intel Core i7-11700K processor and an NVIDIA GeForce RTX 3060 12GB GPU for high-performance gaming. Supported by the ASUS Prime Z590-A ATX motherboard and Corsair Vengeance LPX 16GB DDR4 RAM, it ensures smooth multitasking. Rapid data access is guaranteed by the Samsung 970 EVO Plus 500GB NVMe M.2 SSD. The system is powered by the EVGA SuperNOVA 750 G5 PSU, providing reliable and ample power for an immersive computing experience.</span>
            </div>
        </div>
        </form>
    </section>
