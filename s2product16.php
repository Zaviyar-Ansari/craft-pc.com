...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 305; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/Corsair Vengeance RGB Pro DDR4 2666MHz PC4-21300 32GB 2x16GB CL16 Blanca.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4"> Corsair Vengeance RGB Pro DDR4 2666MHz 32GB</h3>
                <h2>PKR 26,003</h2>
                ...
                <span>The Corsair Vengeance RGB Pro DDR4 2666MHz 32GB RAM kit is an excellent choice for both performance and aesthetics. With ample 32GB capacity and a 2666MHz clock speed, it's capable of handling demanding applications, gaming, and content creation tasks. What sets it apart is the vibrant RGB lighting, which can be customized to match your system's theme, providing a visually stunning element to your PC build. Corsair's Vengeance RGB Pro series is known for its reliability and overclocking potential, catering to gamers and power users alike. Whether you're looking to boost your system's memory capacity or enhance its visual appeal, this RAM kit offers a compelling solution.</span>
            </div>
        </div>
        </form>
    </section>
