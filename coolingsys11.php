...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 264; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingsystem/images (37).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4">DIY Liquid Syscooling System</h3>
                <h2>PKR 122,999  </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/resized-images.png" alt=""> <b><u> DIY Liquid Syscooling System </u></b>
                </div>
                <span> The DIY Liquid Syscooling System priced at PKR 122,999. This advanced water cooling system offers superior heat dissipation for your PC components, ensuring optimal performance under heavy workloads. With its high-quality components and efficient design, it provides reliable cooling and durability. The DIY Liquid Syscooling System is easy to install and offers customizable features for enhanced functionality. Upgrade your PC's cooling solution with this premium system for improved thermal management and extended hardware lifespan.</span>
            </div>
        </div>
    </form>
