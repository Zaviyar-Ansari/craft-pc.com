...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 22; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/921a98ab-5752-4cfe-bae7-ec05a7dde541.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">EliteGamer X</h3>
                <h2>PKR 120,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>MZXT Noctis 450 ROG</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u> Intel Core i7-10700K</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>AMD Radeon RX 6700 XT</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>Z590 chipset for AMD or Intel</u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>16GB DDR4 (3200MHz)</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Kingstone 500GB NVMe SSD + Gigabyte 1TB HDD</u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Corsair 650W 80+ Gold </u></b></h4>
                </div>
                <span>
                    The NZXT Noctis 450 ROG case, with its stylish design and ROG aesthetics, accommodates high-performance components. The Intel Core i7-10700K processor, boasting 8 cores and 16 threads, powers the system. The AMD Radeon RX 6700 XT GPU ensures stellar graphics for immersive gaming. A Z590 chipset motherboard supports Intel CPUs and features PCIe 4.0 for future-proofing. Kingston's 16GB DDR4 RAM at 3200MHz facilitates efficient multitasking. Storage includes a Kingston 500GB NVMe SSD and a Gigabyte 1TB HDD. The Corsair 650W 80+ Gold power supply delivers stable and efficient power for this high-end build.</span>
            </div>
        </div>
        </form>
    </section>
