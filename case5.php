...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 53; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/case/7cfd0c50-17e9-4454-bae9-b644b2251bf4.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Cases</h6>
                <h3 class="py-4">JABSON MechWarrior MOD-3</h3>
                <h2>PKR 105,990</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>JABSON MechWarrior MOD-3</u></b>
                </div>
                <span>The JABSON MechWarrior MOD-3 is a distinctive and robust computer case with a design inspired by the MechWarrior theme. Offering a unique aesthetic, this case provides a blend of style and functionality. With its sturdy construction and attention to detail, the JABSON MechWarrior MOD-3 is an appealing choice for gamers and enthusiasts looking for a case that stands out.</span>
            </div>
        </div>
    </form>
    </section>
