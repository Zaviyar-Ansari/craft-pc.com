...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 114; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ram/1cb05a802346af0347ce55b6811485a3.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / RAM</h6>
                <h3 class="py-4">G.SKILL TridentZ RGB 8GB DDR4</h3>
                <h2>PKR 18,150 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>G.SKILL TridentZ RGB 8GB DDR4</u></b></h4>
                </div>
                <span>The G.SKILL TridentZ RGB 8GB DDR4 RAM stands out as a reliable and visually appealing memory solution. Boasting an attractive design with RGB lighting, it adds a touch of flair to your system. With a capacity of 8GB and DDR4 technology, it delivers solid performance for a range of computing tasks. This RAM module strikes a balance between aesthetics and functionality, making it a worthwhile choice for users looking to enhance both the look and speed of their systems.</span>
