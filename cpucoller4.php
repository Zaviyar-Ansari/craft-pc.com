...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 216; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/cpucooler/64dbfe2a9eb0373711622f185974bb24.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4">DEEPCOOL GAMMAXX 400 CPU Cooler 4 Heatpipes 120mm </h3>
                <h2>PKR 13,684 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/istockphoto-1373113476-612x612 (1).jpg" alt=""> <b><u> DEEPCOOL GAMMAXX 400 CPU Cooler 4 Heatpipes 120mm</u></b>
                </div>
                <span> The DEEPCOOL GAMMAXX 400 CPU Cooler features four heat pipes and a 120mm fan, delivering efficient cooling performance for your processor. With its advanced heat dissipation technology, it effectively lowers temperatures during intensive tasks and gaming sessions, ensuring optimal system performance. The sleek design and durable construction make it a reliable choice for enhancing thermal management in your PC build. Upgrade to the GAMMAXX 400 CPU Cooler for superior cooling and improved system stability.</span>
            </div>
        </div>
    </form>
