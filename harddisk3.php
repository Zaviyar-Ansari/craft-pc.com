...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 195; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/55b8f09388a5b47372694be5e6200f99.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">Seagate Desktop 1000GB</h3>
                <h2>PKR 11,000</h2>
                <input type="hidden" name="product_id" value="195"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>Seagate Desktop 1000GB</u></b>
                </div>
                <span>The Seagate Desktop 1000GB is a reliable and spacious hard disk drive suitable for desktop computers. With its 1000GB (1TB) storage capacity, it offers ample space for storing files, documents, and multimedia content. Crafted by Seagate, a trusted brand in storage solutions, it ensures reliability and durability for long-term use. Upgrade your desktop's storage capacity with the Seagate Desktop 1000GB HDD for efficient data storage at an affordable price.</span>
            </div>
        </div>
        </form>
    </section>
