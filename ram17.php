...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 131; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ram/faaa29675440a653c684c4ff15a1e990.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / RAM</h6>
                <h3 class="py-4">Kingston HyperX Predator DDR4 RGB 16GB</h3>
                <h2>PKR 68,208 </h2>
