...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 223; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/cpucooler/c51222ad7324f120bce4842dfbe09597.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4">Hyper 212 RGB Black Edition CPU Air Cooler</h3>
                <h2>PKR 25,587  </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/istockphoto-1373113476-612x612 (1).jpg" alt=""> <b><u> Hyper 212 RGB Black Edition CPU Air Cooler</u></b>
                </div>
                <span> The Hyper 212 RGB Black Edition CPU Air Cooler – a sleek and powerful cooling solution for high-performance computing. With customizable RGB lighting and a stylish black design, it adds flair to any build. Equipped with four direct contact heat pipes and an aluminum fin stack, it efficiently dissipates heat from your CPU. Compatible with a wide range of Intel and AMD sockets, it offers versatility for various system configurations. Ideal for gamers, content creators, and PC enthusiasts seeking reliable cooling performance. Upgrade your setup with the Hyper 212 RGB Black Edition for style and efficiency in one package.
