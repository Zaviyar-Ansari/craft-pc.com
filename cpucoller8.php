...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 220; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/cpucooler/5634bd07dba4f5cc5ea8f1b0e97c8ab7.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4"> Cooler Master V8 GTS</h3>
                <h2> PKR 23,499</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/istockphoto-1373113476-612x612 (1).jpg" alt=""> <b><u> Cooler Master V8 GTS</u></b>
                </div>
                <span>
The Cooler Master V8 GTS offers high-performance cooling for your CPU. With its unique design featuring a horizontal vapor chamber and eight heat pipes, it efficiently dissipates heat to keep your processor running smoothly, even during intense gaming sessions or demanding tasks. The V8 GTS also features dual high-airflow PWM fans for enhanced cooling performance. It's an excellent choice for enthusiasts looking for reliable cooling solutions to maintain optimal CPU temperatures. </span>
            </div>
        </div>
    </form>
