    ...
    <form action="#" method="post">
            <div class="row mt-5">
                <div class="col-lg-5 col-md-12 col-12">
                    <img class="img-fluid w-100 pb-1" src="prebuildimg1/NZXT’s new -700 prebuilt gaming PC is an affordable entry-level option.jpeg" id="MainImg" alt="">
                </div>
                <div class="col-lg-6 col-md-12 col-12">
                    <h6> Home / Pre Build</h6>
                    <h3 class="py-4">NZXT H7 Flow Pre Build</h3>
                    <h2>PKR 292,499</h2>
                    ...
                    <div class="icon">
                        <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>H7 Flow Case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Core i5 10th Gen</u></b></h4>
                        <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>Gigabyte RTX 3070 Ti</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>Mini-ITX </u></b></h4>
                        <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>RGB 32 GB</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>2TB SSD</u></b></h4>
                        <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>850 Power Supply</u></b></h4>
                    </div>
                    <span>The H7 Flow Case with a Core i5 10th Gen processor and a Gigabyte RTX 3070 Ti graphics card. This Mini-ITX system packs a punch with 32 GB of vibrant RGB memory and a spacious 2TB SSD for lightning-fast storage. The 850W power supply ensures stable and efficient performance for an immersive gaming and multitasking experience. The sleek design of the H7 Flow Case complements the cutting-edge components, making it an ideal choice for gamers and enthusiasts seeking both performance and style in a compact form factor.</span>
                </div>
            </div>
        </form>
        </section>
