...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 265; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingsystem/images (38).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4">EK-KIT Classis RGB S360 </h3>
                <h2>PKR 92,658 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/resized-images.png" alt=""> <b><u> EK-KIT Classis RGB S360</u></b>
                </div>
                <span>The EK-KIT Classic RGB S360, priced at PKR 92,658. This water cooling system is designed to enhance your PC's performance and aesthetics. With its efficient cooling capabilities and customizable RGB lighting, it ensures optimal temperature control and visual appeal. The EK-KIT Classic RGB S360 includes all necessary components for easy installation and reliable operation. Upgrade your PC's cooling system with this high-quality kit for improved thermal management and enhanced style. </span>
            </div>
        </div>
    </form>
