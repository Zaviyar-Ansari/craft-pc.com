...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 156; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ssd/9bd9e0936d1433aa822d4088ce37b92c.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / SSD</h6>
                <h3 class="py-4">Samsung 950 PRO NVMe 512GB SSD</h3>
                <h2>PKR 73,899</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Samsung 950 PRO NVMe 512GB SSD</u></b></h4>
                </div>
                <span>The Samsung 950 PRO NVMe 512GB SSD is a high-performance storage solution designed to elevate your computing experience. With its NVMe interface, it offers lightning-fast data transfer speeds and reduced latency, ensuring swift system responsiveness and application loading times. Boasting a generous 512GB capacity, it provides ample space for your operating system, applications, and multimedia files. Samsung's advanced V-NAND technology and dynamic thermal throttling ensure optimal performance and reliability, even under heavy workloads. Upgrade to the Samsung 950 PRO NVMe SSD for unparalleled speed, efficiency, and storage capacity for your computing needs.
</span>
            </div>
        </div>
        </form>
