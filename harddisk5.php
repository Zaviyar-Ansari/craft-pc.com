...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 197; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/bbf230214786be76008353b176204a29.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">WD Caviar Black SATA III 6TB harddisk</h3>
                <h2>PKR 62,883</h2>
                <input type="hidden" name="product_id" value="197"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>WD Caviar Black SATA III 6TB harddisk</u></b>
                </div>
                <span>The WD Caviar Black SATA III 6TB hard disk drive is a high-capacity storage solution designed for demanding computing needs. With its SATA III interface, it offers fast data transfer speeds and seamless compatibility with modern systems. Crafted by Western Digital, a trusted brand in storage solutions, it ensures reliability and durability for long-term use. Whether for gaming, content creation, or data storage, the WD Caviar Black 6TB HDD provides ample space and high performance at a premium price.</span>
            </div>
        </div>
        </form>
    </section>
