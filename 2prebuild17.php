...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 37; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/download.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Galactic Fury</h3>
                <h2>PKR 130,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Kolink Observatory RGB Mid Tower</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i5-11600K</u></b></h4>
                ...
                <span>The Kolink Observatory RGB Mid Tower encases a powerful gaming setup featuring the Intel Core i5-11600K processor and ASUS Dual GeForce GTX 1660 Super, delivering a high-performance gaming experience. The MSI B560M PRO-VDH WIFI motherboard ensures stability and connectivity. Paired with Corsair Vengeance LPX 16GB DDR4 RAM and Kingston A2000 1TB NVMe PCIe M.2 SSD, multitasking and storage are handled with efficiency. The Corsair CV650 80+ Bronze PSU provides reliable and efficient power delivery. This well-balanced configuration housed in the Kolink Observatory combines performance, style, and RGB aesthetics for an immersive gaming setup.
