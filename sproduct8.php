...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 277; // Set the product ID to 3
    ...
    <section class="container sproduct my-5 pt-5"> 
        ...
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg/TEAMGROUP T-Force Delta RGB DDR5 Ram 32GB Kit (2x16GB) 6000MHz (PC5-48000) CL40 Desktop Memory Module Ram (Black) for 600 Series Chipset - FF3D532G6000HC38ADC01.jpeg.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">TEAMGROUP T-Force Delta RGB DDR5
                </h3>
                <h2>PKR 39,990</h2>
                ...
                <span>The TEAMGROUP T-Force Delta RGB DDR5 is a cutting-edge memory module designed for high-performance computing. It adopts the DDR5 standard, offering faster data transfer rates and increased bandwidth compared to DDR4. The most striking feature of this memory is its vibrant RGB lighting, which adds a dynamic visual element to your PC setup. With a sleek and futuristic design, it complements gaming and enthusiast systems. The T-Force Delta DDR5 is available in various capacities and clock speeds, catering to a wide range of user requirements. Whether you're a gamer, content creator, or power user, this memory module offers enhanced performance and aesthetics for your system.</span>
            </div>
        </div>
        </form>
    </section>
