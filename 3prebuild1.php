...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 41; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg3/Thermaltake pc build.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Mystic Fusion</h3>
                <h2>PKR 130,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Thermaltake Core P5</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i5-11400F</u></b></h4>
                ...
                <span>The Thermaltake Core P5 showcases a robust gaming build featuring the Intel Core i5-11400F and ASUS Dual GeForce GTX 1660 Super for powerful gaming performance. The MSI B460M PRO-VDH WIFI motherboard ensures stability and connectivity, while Corsair Vengeance LPX 16GB DDR4 RAM and Kingston A2000 1TB NVMe PCIe M.2 SSD offer efficient multitasking and fast storage. With the reliable Corsair CV650 80+ Bronze PSU, this setup is a blend of performance and aesthetics within the open-frame design of the Thermaltake Core P5.
                </span>
            </div>
        </div>
        </form>
