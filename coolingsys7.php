...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 260; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingsystem/images (33).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                ...
                <span>The DIY PC Water Cooling Kit, available for PKR 35,922. This comprehensive kit offers all the components needed to set up a water cooling system for your PC. With its efficient cooling performance and easy installation process, it ensures optimal temperature management for your components. Upgrade your PC's cooling solution with this kit and enjoy improved performance and reliability. </span>
            </div>
        </div>
    </form>
