...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 208; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/images (10).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">WD SATA Hard Drive 3 TB</h3>
                <h2>PKR 16,755</h2>
                <input type="hidden" name="product_id" value="208"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>WD SATA Hard Drive 3 TB</u></b>
                </div>
                <span>The WD SATA Hard Drive 3TB provides ample storage capacity for your needs. With its SATA interface, it ensures efficient data transfer. Reliable and durable, it's suitable for personal and professional use. Backed by WD's renowned reliability, it offers peace of mind. Perfect for expanding storage or building systems requiring high performance.
