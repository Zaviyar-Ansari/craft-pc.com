...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 243; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/46395514255e9980998dda5ced901db3.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4">Corsair iCUE SP120 RGB ELITE Performance </h3>
                <h2>PKR 22,672 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>Corsair iCUE SP120 RGB ELITE Performance</u></b>
                </div>
                <span>The Corsair iCUE SP120 RGB ELITE Performance Fan offers premium cooling functionality priced at PKR 22,672. With vibrant RGB lighting and a sleek design, it ensures efficient airflow and heat dissipation for optimal performance, even under heavy loads. Compatibility with Corsair's iCUE software allows seamless customization of RGB lighting effects to match your build's theme or sync with other RGB components. Whether gaming or working, this fan delivers both style and performance, enhancing your computing experience. </span>
            </div>
        </div>
    </form>
