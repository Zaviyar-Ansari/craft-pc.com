...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 300; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/Samsung 860 EVO SATA 2_5_ SSD 2TB(MZ-76E2T0B_AM).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">Samsung 860 EVO SATA 2_5_ SSD 2TB </h3>
                <h2>PKR 49,000</h2>
                ...
                <span>The Samsung 860 EVO SATA 2.5" SSD in the 2TB capacity is a high-performance storage solution that significantly enhances your computing experience. Featuring the proven V-NAND technology, this solid-state drive offers reliable and efficient data storage, ensuring fast data access and transfer speeds. The 2TB capacity provides a generous amount of storage space for your documents, games, multimedia, and applications. Samsung's 860 EVO SSD is renowned for its durability and consistent performance, making it an excellent choice for both everyday computing and demanding tasks. Whether you're upgrading your laptop or desktop, this SSD transforms your system's responsiveness and ensures swift application loading times, making it a solid investment for those seeking speed and ample storage capacity.</span>
            </div>
        </div>
        </form>
    </section>
