...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 173; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/powersupply/02f7681d13596ef950c8790856f28e17.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Powersupply</h6>
                <h3 class="py-4">Corsair VS450-450Watt 80 PLUS</h3>
                <h2>PKR 6,200</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Corsair VS450-450Watt 80 PLUS </u></b></h4>
                </div>
                <span> The Corsair VS450 is a 450-watt power supply unit with 80 PLUS certification, offering efficiency and reliability for your PC. Designed by Corsair, a trusted brand, it ensures stable power delivery for smooth performance. Compact and compatible with various systems, it's ideal for both new builds and upgrades. With its quiet operation and cost-effective pricing, the VS450 is a solid choice for powering your computer setup. Upgrade your PC's power performance with the Corsair VS450 today.
