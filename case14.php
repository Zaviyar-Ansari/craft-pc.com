...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 62; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/case/NZXT Custom & Prebuilt Gaming PCs, Parts, Peripherals _ NZXT.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Cases</h6>
                <h3 class="py-4">NZXT Vulcan Black Computer Case</h3>
                <h2>PKR 17,929</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>NZXT Vulcan Black Computer Case</u></b>
                </div>
                <span>
                    The NZXT Vulcan Black Computer Case is a compact and portable chassis designed for gaming enthusiasts. With its unique carry handle and compact form factor, it offers convenience for LAN parties and on-the-go gaming setups. The case is optimized for airflow and supports high-performance components, making it a suitable choice for users who prioritize both mobility and gaming performance in their PC builds.</span>
            </div>
        </div>
        </form>
    </section>
