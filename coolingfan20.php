...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 253; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/xspc-rgb-series--2-pwm-800-2200rpm-5v-3pin-argb-120mm-fan-xs-fan-011-77101-1.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4"> XSPC RGB Series 2</h3>
                <h2>PKR 10,990 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>XSPC RGB Series 2</u></b>
                </div>
                <span> The XSPC RGB Series 2 cooling fan, priced at PKR 10,990. This high-quality fan offers efficient cooling performance while adding vibrant RGB lighting effects to your PC build. Engineered for optimal airflow and heat dissipation, it ensures reliable cooling for your components, even under heavy loads. With its sleek design and customizable RGB lighting, the XSPC RGB Series 2 fan enhances both the aesthetics and performance of your system. Upgrade your cooling setup with the XSPC RGB Series 2 and enjoy a combination of style and functionality for your PC.</span>
            </div>
        </div>
    </form>
