...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 182; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/powersupply/2491effc07e44555bdbd30501fa290f5.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Powersupply</h6>
                <h3 class="py-4"> Corsair RM-550x PC 80 PLUS</h3>
                <h2>PKR 25,751</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Corsair RM-550x PC 80 PLUS </u></b></h4>
                </div>
                <span> The Corsair RM-550x PC is a reliable power supply unit featuring 80 PLUS certification. With its 550-watt capacity, it provides ample power for a variety of computing tasks. Engineered for efficiency, it ensures optimal energy utilization, reducing operational costs. Crafted by Corsair, a trusted brand in PC hardware, it guarantees performance and reliability. Upgrade your PC's power supply with the Corsair RM-550x for efficient operation and peace of mind.</span>
            </div>
        </div>
        </form?>
    </section>
