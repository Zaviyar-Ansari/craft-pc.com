...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 44; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg3/Project Refresh [900D x 780 Ti SLI x Watercooled].jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Vortex Voyager</h3>
                <h2>PKR 175,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Corsair obsidian 900D Case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i5-11600K</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GeForce GTX 1660 Ti </u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>ASUS Prime Z590-P ATX</u></b></h4>
                ...
                <span>
                    Housed in the Corsair Obsidian 900D Case, the system boasts an Intel Core i5-11600K CPU and NVIDIA GeForce GTX 1660 Ti GPU for powerful gaming. With an ASUS Prime Z590-P ATX motherboard and Corsair Vengeance LPX 16GB DDR4 RAM, it ensures efficient multitasking. Swift data access is enabled by the Kingston A2000 500GB NVMe M.2 SSD. The system runs smoothly with the EVGA SuperNOVA 650 G5 PSU, delivering ample power. The case's spacious design complements the high-performance components for an immersive computing experience.</span>
            </div>
        </div>
        </form>
    </section>
