...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 192; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/powersupply/fb46e6e32920acc115e80f4a39ab3946.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Powersupply</h6>
                <h3 class="py-4"> CX Series CX-850Watt 80 Plus Bronze</h3>
                <h2>PKR 25,658</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>CX Series CX-850Watt 80 Plus Bronze </u></b></h4>
                </div>
                <span> The CX Series CX-850Watt is a reliable power supply unit boasting 80 Plus Bronze certification for efficient energy usage. With its 850-watt capacity, it provides ample power for various computing needs. Engineered for stability and performance, it ensures consistent power delivery to your PC components. Crafted by Corsair, a trusted brand in PC hardware, it guarantees reliability and durability. Upgrade your PC's power supply with the CX Series CX-850Watt for dependable operation at an affordable price.</span>
            </div>
        </div>
        </form?>
    </section>
