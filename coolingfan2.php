...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 234; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/images (28).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4"> ALSEYE Max Series 120mm Cooling Fan 3pcs</h3>
                <h2> PKR 23,242</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>ALSEYE Max Series 120mm Cooling Fan 3pcs</u></b>
                </div>
                <span> The ALSEYE Max Series 120mm Cooling Fan 3pcs – a powerful cooling solution to optimize your PC's performance. With a set of three high-performance fans, this package offers enhanced airflow to keep your components running efficiently. The 120mm fans are designed to provide excellent cooling while maintaining low noise levels, ensuring a quiet computing experience. Featuring a sleek and durable design, these fans are suitable for various PC builds. Whether you're a gamer or a professional user, the ALSEYE Max Series Cooling Fan set ensures effective heat dissipation for improved system stability. Upgrade your cooling setup with ALSEYE Max Series and enjoy cooler and quieter computing.</span>
            </div>
        </div>
    </form>
