...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 190; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/powersupply/c264b1ebd7553fe9e6abb8df014eac0c.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Powersupply</h6>
                <h3 class="py-4"> Ocz Faral1ty 1000Watt Individually-sleeved Modular</h3>
                <h2>PKR 142,561</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u> Ocz Faral1ty 1000Watt Individually-sleeved Modular</u></b></h4>
                </div>
                <span> The OCZ Fatal1ty 1000Watt is a high-performance power supply unit featuring individually-sleeved modular cables for easy customization and cable management. With its impressive 1000-watt capacity, it delivers abundant power for demanding gaming and computing tasks. Engineered for reliability and performance, it ensures stable power delivery to your PC components. Crafted by OCZ, a trusted brand in PC hardware, it guarantees quality and durability. Elevate your gaming experience with the OCZ Fatal1ty 1000Watt for reliable operation and customizable power delivery.
