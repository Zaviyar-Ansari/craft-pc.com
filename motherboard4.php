...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 76; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/motherboard/70d56d74b053ab73beef29247a3985cd.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Motherboards</h6>
                <h3 class="py-4">Asus Sabertooth Z170 Mark 1</h3>
                <h2>PKR 56,464</h2>
                ...
                <div class="icon">
                    <h4> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>Asus Sabertooth Z170 Mark 1</u></b>
                </div>
                <span>
                    The Asus Sabertooth Z170 Mark 1 is a durable and reliable motherboard designed for stability and performance. Built on the Intel Z170 chipset, it supports 6th and 7th generation Intel Core processors. With TUF (The Ultimate Force) components and an armored design, it emphasizes durability and protection. The motherboard features advanced cooling solutions and a sleek aesthetic, making it suitable for users looking for a robust and visually appealing platform.</span>
            </div>
        </div>
        </form>
    </section>
