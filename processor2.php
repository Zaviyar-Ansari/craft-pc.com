...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 94; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/7ff8379604c6f1457ffc25c965c87987.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">Intel Core i9-7920X X-Series</h3>
                <h2>PKR 148,974</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i9-7920X X-Series</u></b></h4>
                </div>
                <span>The Intel Core i9-7920X is a part of the X-Series processors, featuring 12 cores and 24 threads. With a base clock speed of 2.9 GHz and Turbo Boost 3.0 technology, it can achieve a maximum turbo frequency of 4.3 GHz. Designed for high-performance computing, it's suitable for demanding tasks such as content creation, video editing, and gaming. The processor utilizes the LGA 2066 socket and is part of Intel's enthusiast-level lineup, providing significant processing power for users who require top-tier performance. Keep in mind that specific details may vary based on regional availability and exact SKU.
