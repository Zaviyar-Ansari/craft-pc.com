...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 282; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg/AC Infinity MULTIFAN S7, Quiet Dual 120mm USB Fan, UL-Certified for Receiver DVR Playstation Xbox Computer Cabinet Cooling.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">AC Infinity MULTIFAN S7</h3>
                <h2>PKR 11,570</h2>
                ...
                <span>The AC Infinity MULTIFAN S7 is a versatile and efficient cooling solution for various applications. With its dual 120mm fans, this unit provides robust airflow to maintain optimal temperature levels within your equipment. Its speed controls allow for customized cooling, adapting to the specific needs of your setup. The MULTIFAN S7 operates quietly, ensuring a peaceful environment, making it ideal for home theaters, AV cabinets, or gaming consoles. The easy installation and durable build of this cooling system make it a valuable addition to any setup that requires enhanced ventilation and temperature management. Whether it's reducing heat in your entertainment center or computer system, the AC Infinity MULTIFAN S7 offers dependable performance.</span>
            </div>
        </div>
        </form>
    </section>
