...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 29; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/Maior E-commerce de Tecnologia e Games da América Latina.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">BudgetBeast Lite</h3>
                <h2>PKR 70,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Itek Bi-Turbo Midi Tower</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i3-10100</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GeForce GTX 1650 Super</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>MSI B450M PRO-VDH MAX</u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>Corsair Vengeance LPX 8GB DDR4</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Kingston A2000 250GB NVMe</u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>EVGA 500 W1, 80+ WHITE</u></b></h4>
                </div>
                <span>
                    The Itek Bi-Turbo Midi Tower hosts a capable gaming setup featuring an Intel Core i3-10100 processor and an NVIDIA GeForce GTX 1650 Super GPU for solid gaming performance. The MSI B450M PRO-VDH MAX motherboard provides a reliable foundation for the Intel processor. With Corsair Vengeance LPX 8GB DDR4 RAM, the system offers decent multitasking capabilities. Storage is handled by a Kingston A2000 250GB NVMe SSD, ensuring swift data access. Powering the system is the EVGA 500 W1, 80+ WHITE power supply, delivering stable and efficient power. This configuration creates an efficient gaming system within the Itek Bi-Turbo Midi Tower.
