...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 286; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg/Samsung 970 EVO Plus NVMe® M_2 SSD 500GB(MZ-V7S500B_AM).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">Samsung 970 EVO Plus NVMe M.2</h3>
                <h2>PKR 14,300</h2>
                ...
                <span>The Samsung 970 EVO Plus NVMe M.2 SSD is a stellar storage solution that combines speed and reliability. With its NVMe interface, this M.2 drive offers blistering read and write speeds, making it ideal for tasks like gaming, video editing, and data-intensive applications. Boasting a generous capacity range, from 250GB to 2TB, it suits a wide array of storage needs. Samsung's V-NAND technology ensures long-lasting performance and data endurance, while the 970 EVO Plus is backed by Samsung's reputation for quality and reliability. Whether you're upgrading your laptop or building a high-performance desktop, this SSD can significantly enhance your system's overall responsiveness and speed.</span>
            </div>
        </div>
        </form>
    </section>
