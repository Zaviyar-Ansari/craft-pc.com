...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 209; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/images (11).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">Seagate 500GB SATA 3.5Inch</h3>
                <h2>PKR 16,500</h2>
                <input type="hidden" name="product_id" value="209"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>Seagate 500GB SATA 3.5Inch</u></b>
                </div>
                <span>The Seagate 500GB SATA 3.5-Inch hard drive offers ample storage space for your data needs. With its SATA interface, it ensures fast and efficient data transfer. Ideal for upgrading existing systems or building new ones, it provides reliable performance. Backed by Seagate's reputation for quality and durability, it's a solid choice for both personal and professional use.
