...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 95; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/89f4962ee2d445c76ab32514829b5297.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">Intel Core i9-9900K</h3>
                <h2>PKR 134,890</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i9-9900K</u></b></h4>
                </div>
                <span>
                    The Intel Core i9-9900K is a high-performance processor from the 9th generation Intel Core series. It features 8 cores and 16 threads, with a base clock speed of 3.6 GHz and a maximum turbo frequency of 5.0 GHz. Built on the LGA 1151 socket and utilizing the Coffee Lake architecture, it delivers strong single-threaded and multi-threaded performance, making it suitable for gaming, content creation, and multitasking. The processor is known for its overclocking capabilities and is widely used in high-end desktop systems. Please note that specific details may vary based on regional availability and exact SKU.</span>
            </div>
        </div>
        </form?>
    </section>
