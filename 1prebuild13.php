...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 13; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg1/ID _ Corsair Carbide Series 300R Gaming Case.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Stealth Shadow X</h3>
                <h2>PKR 130,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Corsair Carbide </u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u> AMD Ryzen 5 5600X</u></b></h4>
                    ...
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>Corsair Vengeance LPX 16GB DDR4</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Kingston A2000 500GB NVMe + Seagate Barracuda 1TB HDD </u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Corsair AX 12000W </u></b></h4>
                </div>
                <span>The Corsair Carbide case houses a potent system featuring the AMD Ryzen 5 5600X processor and NVIDIA GeForce GTX 1660 Super for excellent gaming performance. The MSI B450 TOMAHAWK MAX motherboard ensures stability, paired with 16GB of Corsair Vengeance LPX DDR4 RAM for smooth multitasking. Storage includes a fast Kingston A2000 500GB NVMe SSD and a spacious Seagate Barracuda 1TB HDD. The Corsair AX 1200W power supply, with its robust capacity, provides reliable and efficient energy delivery for this high-end setup. Encased in a sleek design, this PC promises a powerful and immersive computing experience.</span>
