...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 81; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/motherboard/41639c89374811a9ba2fb8fa5da790e9.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Motherboards</h6>
                <h3 class="py-4">ASUS ROG Strix B250F GAMING LGA 1151</h3>
                <h2>PKR 33,099</h2>
                ...
                <div class="icon">
                    <h4> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>ASUS ROG Strix B250F GAMING LGA 1151</u></b>
                </div>
                <span>The ASUS ROG Strix B250F GAMING is a motherboard designed for gaming enthusiasts, utilizing the LGA 1151 socket for 6th and 7th generation Intel Core processors. Featuring the B250 chipset, it offers a balance of performance and affordability. With ASUS Aura Sync RGB lighting, SupremeFX audio, and robust power delivery, it caters to gamers seeking both aesthetics and functionality. Multiple PCIe slots and DDR4 memory support make it suitable for building a capable gaming rig.</span>
            </div>
        </div>
        </form>
    </section>
