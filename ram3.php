...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 115; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ram/2d3d91afbdd80337a2de0435591064d2.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / RAM</h6>
                <h3 class="py-4">DDR4 RAM Memory Asgard 32GB</h3>
                <h2>PKR 19,403 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>DDR4 RAM Memory Asgard 32GB</u></b></h4>
                </div>
                <span>The Asgard 32GB DDR4 RAM Memory offers a substantial boost to your system's performance and multitasking capabilities. With a generous capacity of 32GB, it provides ample space for handling demanding applications and tasks. This DDR4 RAM ensures efficient data transfer rates and responsiveness, contributing to a smoother computing experience. Whether you're into gaming, content creation, or other resource-intensive activities, the Asgard 32GB DDR4 RAM stands as a reliable and capable memory solution for enhancing your system's overall performance.</span>
