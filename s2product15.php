...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 304; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/Cooler Master V8 GTS CPU Cooler Review.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4"> Cooler Master V8 GTS CPU Cooler</h3>
                <h2>PKR 23,499</h2>
                ...
                <span>The Cooler Master V8 GTS CPU Cooler is a high-performance cooling solution designed for enthusiasts and overclockers seeking top-notch thermal management. This cooler boasts a distinctive and robust design, with its horizontal vapor chamber and eight heat pipes efficiently dissipating heat from your CPU. Dual 140mm fans deliver strong airflow while reducing noise levels, ensuring effective cooling even under demanding workloads. The red LED lighting adds a touch of style to your PC build. Compatibility with a wide range of CPU sockets and an easy-to-install design make it a user-friendly choice. If you're looking to maintain low temperatures and elevate the aesthetics of your gaming rig, the V8 GTS is a solid option.</span>
            </div>
        </div>
        </form>
    </section>
