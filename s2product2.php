...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 291; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/Aorus Mark II.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">Aorus Mark II PC Case </h3>
                <h2>PKR 36,755 </h2>
                ...
                <span> The Aorus Mark II PC case is a superb choice for gaming and PC enthusiasts. With its thoughtfully designed chassis, it offers an optimal blend of functionality and aesthetics. The case features excellent cable management options to keep your build organized and maximize airflow, helping to maintain cool temperatures for your components. Aorus is renowned for its quality and attention to detail, and the Mark II is no exception. This case provides ample space for your components and offers a sleek, modern design that enhances the overall look of your gaming rig. Whether you're building a high-performance gaming PC or a stylish workstation, the Aorus Mark II is a compelling option. </span>
