...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 135; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/graphiccard/6c5e97544be87c5330d28e5bce91debe.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Graphic Cards</h6>
                <h3 class="py-4">XFX AMD Radeon RX 580 GTS XXX Edition</h3>
                <h2>PKR PKR 85,516</h2>
