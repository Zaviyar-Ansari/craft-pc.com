...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 49; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/case/Amazon_com_ Thermaltake Tower 100 Racing Green Edition Tempered Glass Mini Tower Computer Chassis Supports Mini-ITX CA-1R3-00SCWN-00 _ Industrial & Scientific.jpeg.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Cases</h6>
                <h3 class="py-4">The Tower 100 Turquoise Mini Chassis</h3>
                <h2>PKR 35,939</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>The Tower 100 Turquoise Mini Chassis</u></b>
                </div>
                <span>The Tower 100 Turquoise Mini Chassis is a compact and stylish case with a unique turquoise finish, providing a distinctive look for your mini PC build. Its space-efficient design allows for easy placement in various environments, while the high-quality construction ensures durability and efficient cooling for your components. With a blend of aesthetics and functionality, it's an ideal choice for those seeking a compact and eye-catching mini chassis.</span>
            </div>
        </div>
        </form>
    </section>
