...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 74; // Set the product ID to 3
...
<body>
    ...
    <a href="cart.php">
        ...
        <span id="ca\rtItemCount" class="badge badge-pill badge-primary"><?php echo $row_count; ?></span>
    </a>
    <a href="home.php">
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/motherboard/3badb6ddcc1243b26595029c5ae5c7f0.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Motherboards</h6>
                <h3 class="py-4">Aorus X299X Aorus MASTER</h3>
                <h2> PKR 169,257</h2>
                ...
                <div class="icon">
                    <h4> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>Aorus X299X Aorus MASTER</u></b>
                </div>
                <span>
                    The Aorus X299X Aorus MASTER is a feature-rich motherboard designed for high-end desktop systems. Supporting Intel's X299 platform, it provides extensive connectivity options, robust power delivery, and advanced cooling solutions. With PCIe 3.0 support, it caters to enthusiasts and professionals seeking top-notch performance for content creation, gaming, and other demanding applications.</span>
            </div>
        </div>
        </form>
    </section>
