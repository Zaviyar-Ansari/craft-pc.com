...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 303; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/Bykski PETG Hose computer cooling system.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4"> Bykski PETG Hose computer cooling system</h3>
                <h2>PKR 1,936</h2>
                ...
                <span>The Bykski PETG Hose computer cooling system is a high-quality and reliable solution for custom liquid cooling setups. Made from durable PETG material, these clear and sturdy tubes provide a clean and professional look to your cooling system. The transparent nature of PETG allows for an elegant and unobstructed view of the coolant flow. These tubes are easy to shape and cut, enabling a customized fit for your specific PC build. Bykski is known for its expertise in water cooling, ensuring that their PETG hose meets the needs of enthusiasts and overclockers looking for efficient cooling solutions while maintaining a visually appealing system. Whether you're a seasoned enthusiast or a newcomer to liquid cooling, the Bykski PETG hose is a reliable choice for achieving excellent thermal performance and aesthetics in your PC.</span>
            </div>
        </div>
        </form>
    </section>
