...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 103; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/images (3).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">Intel Core i7-11700K</h3>
                <h2>PKR 72,500</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i7-1170K</u></b></h4>
                </div>
                <span>The Intel Core i7-11700K is a high-performance CPU part of the 11th Gen Intel Core lineup. It features 8 cores and 16 threads, offering excellent multitasking capabilities. With a base clock speed of 3.6 GHz and a max turbo frequency of 5.0 GHz, it delivers strong single-core performance. The processor supports DDR4 memory and PCIe 4.0, enhancing overall system speed. It's well-suited for gaming, content creation, and demanding computing tasks.</span>
            </div>
        </div>
        </form?>
    </section>
