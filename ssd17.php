...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 169; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ssd/caba0ce0c764c440f58a9436a56c4448.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                ...
                <span>
The Force Series Gen.4 PCIe MP600 1TB NVMe M.2 SSD offers high-speed and reliable storage for your computing needs. With its PCIe Gen.4 interface and NVMe technology, it ensures lightning-fast data transfer speeds, enabling quick access to your files and applications. Boasting a generous 1TB capacity, it provides ample storage space for your operating system, games, multimedia files, and more. Its compact M.2 form factor makes it suitable for various systems, including laptops and desktops. Upgrade to the Force Series MP600 SSD for enhanced performance and efficiency in your computing tasks, all at a competitive price.</span>
            </div>
        </div>
        </form>
    </section>
