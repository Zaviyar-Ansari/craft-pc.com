...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 27; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/ACER Predator Orion 3000 PO3-630 Gaming PC - Intel®Core_ i7, RTX 3060, 1 TB HDD & 512 GB SSD.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">GamingTitan X2</h3>
                <h2>PKR 130,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>ACER Predator Orion 3000 PO3-630</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel®Core_ i7</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>INVIDIA GeForce RTX 3060</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>MSI B550 Tomahawk</u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>Corsair Vengeance LPX 16GB DDR4</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Seagate 1 TB HDD & Kingstone 512GB NVMe SSD</u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Corsair RM650x (650W 80+ Gold)</u></b></h4>
                </div>
                <span>The ACER Predator Orion 3000 PO3-630, powered by an Intel Core i7 processor and featuring an NVIDIA GeForce RTX 3060, delivers a potent gaming experience. The MSI B550 Tomahawk motherboard ensures stability with PCIe 4.0 support. Paired with Corsair Vengeance LPX 16GB DDR4 RAM, the system excels in multitasking. Storage comprises a Seagate 1TB HDD and a Kingston 512GB NVMe SSD for ample and fast storage options. The Corsair RM650x, a 650W 80+ Gold power supply, provides reliable and efficient power for this gaming configuration.</span>
            </div>
        </div>
        </form>
    </section>
