...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 51; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/case/Antec Torque Black _ Red - E-ATX.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Cases</h6>
                <h3 class="py-4">Torque Black/Red ATX Mid Tower</h3>
                <h2>PKR 107,188</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Torque Black/Red ATX Mid Tower</u></b>
                </div>
                <span>
                    The Torque Black/Red ATX Mid Tower is a striking and stylish computer case designed to accommodate ATX-sized motherboards. Featuring a black and red color scheme, it adds a bold aesthetic to your build. With a spacious interior, it provides ample room for high-performance components and efficient cable management, making it an attractive choice for gaming and enthusiast setups.</span>
            </div>
        </div>
        </form>
    </section>
