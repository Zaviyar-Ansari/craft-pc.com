...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 111; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/images (11).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">Intel Xeon Gold </h3>
                <h2>PKR 350,899</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Xeon Gold</u></b></h4>
                </div>
                <span>The Intel Xeon Gold series comprises processors designed for high-performance computing in enterprise and data center environments. These CPUs offer features such as multiple cores, high clock speeds, and support for ECC (Error-Correcting Code) memory. Optimized for stability and reliability, Xeon Gold processors excel in tasks like virtualization, database management, and other data-intensive applications. The specific details, including core count and clock speeds, may vary based on the exact model within the Xeon Gold series.</span>
            </div>
        </div>
        </form?>
    </section>
