...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 301; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/Nvidia Rolls Out TITAN RTX _T-REX_ - the Most Powerful GPU Ever Released.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">Nvidia Rolls Out TITAN RTX T-REX </h3>
                <h2>PKR 691,315</h2>
                ...
                <span>NVIDIA has introduced the TITAN RTX T-REX, a powerful addition to its line of high-end graphics cards. This premium GPU is designed to cater to the demands of professionals and enthusiasts, featuring impressive performance and AI capabilities. With a massive 24GB of GDDR6 memory and support for real-time ray tracing, it's ideal for content creation, scientific computing, and gaming. The TITAN RTX T-REX exemplifies NVIDIA's commitment to cutting-edge technology, offering top-tier performance and AI capabilities that set it apart in the world of GPUs. It's a compelling option for those seeking the ultimate in graphics processing power.</span>
            </div>
        </div>
        </form>
    </section>
