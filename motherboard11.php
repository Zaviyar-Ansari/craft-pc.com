...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 92; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/motherboard/a532bda3297410aee3ef138a2fb869a9.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Motherboards</h6>
                <h3 class="py-4">ASUS ROG MAXIMUS XII APEX</h3>
                <h2>PKR 152,697</h2>
                ...
                <div class="icon">
                    <h4> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>ASUS ROG MAXIMUS XII APEX</u></b>
                </div>
                <span>The ASUS ROG MAXIMUS XII APEX is a high-end motherboard designed for enthusiasts and overclockers. Built on the Intel Z490 chipset, it supports 10th generation Intel Core processors with the LGA 1200 socket. Featuring an E-ATX form factor, robust power delivery, and advanced cooling solutions, it is optimized for extreme performance. The motherboard includes premium components, customizable RGB lighting, and a range of overclocking features, making it an ideal choice for users looking to build a powerful and customized gaming or content creation system.</span>
            </div>
        </div>
    </form>
    </section>
