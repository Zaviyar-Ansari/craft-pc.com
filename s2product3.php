...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 292; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/Antec A400 RGB CPU Cooler Fan Appropriate with_ Intel LGA 775_1150 _ 1151_1155 _ 1156_1366 _ ___.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">Antec A400 RGB CPU</h3>
                <h2>PKR 10,199</h2>
                ...
                <span>The Antec A400 RGB CPU cooler is a standout choice for PC enthusiasts and gamers seeking efficient cooling and a touch of style. Equipped with a capable fan and vibrant RGB lighting, it not only keeps your CPU at optimal temperatures but also enhances your system's aesthetics. The four direct-contact heat pipes and aluminum fins provide effective heat dissipation, ensuring reliable cooling even during demanding tasks. Installation is straightforward, making it user-friendly for builders of all levels. The Antec A400 RGB CPU cooler is a perfect blend of performance and aesthetics for those looking to keep their CPU cool and their system visually appealing.</span>
