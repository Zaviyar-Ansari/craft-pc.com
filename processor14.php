...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 106; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/images (6).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">Intel Core i3-10100 1.8GHZ</h3>
                <h2> PKR 34,257</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i3-10100 1.8GHZ</u></b></h4>
                </div>
                <span>The Intel Core i3-10100 is a processor from the 10th generation Intel Core series. It features 4 cores and 8 threads, with a base clock speed of 3.6 GHz. It appears there might be a discrepancy in the clock speed you mentioned (1.8 GHz). The i3-10100 is known for providing entry-level performance suitable for everyday computing tasks, including web browsing, office applications, and light multitasking. Built on the Comet Lake architecture and utilizing the LGA 1200 socket, it offers a cost-effective solution for budget-friendly desktop systems. Specific details may vary based on regional availability and exact SKU.</span>
            </div>
        </div>
        </form?>
    </section>
