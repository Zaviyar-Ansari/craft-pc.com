...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id =302; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/ATC700 Key Features _ CPU Cooler - GIGABYTE Bangladesh.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">ATC700 Key Features CPU Cooler-GIGABYTE </h3>
                <h2>PKR 4,800</h2>
                ...
                <span>The ATC700 Key Features CPU Cooler by GIGABYTE is a standout cooling solution designed to keep your CPU operating at optimal temperatures. This high-performance cooler boasts a unique design, featuring a dual 120mm fan setup and a six high-performance copper heat pipe configuration. These features ensure efficient heat dissipation, making it ideal for overclocked systems and demanding workloads. The RGB Fusion 2.0 lighting system allows for customized aesthetics, allowing you to match your build's style. With support for various CPU sockets, this cooler is versatile and easy to install, catering to a wide range of systems. Whether you're a gamer or a content creator, the ATC700 offers both exceptional cooling and visual appeal to elevate your PC setup.</span>
            </div>
        </div>
        </form>
    </section>
