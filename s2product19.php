...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 308; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/Cooler Master MasterCase Maker 5t - Boîtier PC - Garantie 3 ans LDLC _ Muséericorde.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4"> Cooler Master MasterCase Maker 5t Boîtier PC
                </h3>
                <h2>PKR 42,048</h2>
                ...
                <span>The Cooler Master MasterCase Maker 5t PC case is a standout choice for gamers and enthusiasts looking for a versatile and stylish case. Featuring a distinctive design with red accents, this case offers ample space for high-performance components and efficient cable management. It's equipped with a top handle for portability and customizable lighting for added aesthetics. The MasterCase Maker 5t also supports multiple cooling options, ensuring efficient heat dissipation during intense gaming sessions. Whether you're building a powerful gaming rig or a customized workstation, this case provides a blend of functionality and aesthetics to meet your needs.</span>
            </div>
        </div>
        </form>
    </section>
