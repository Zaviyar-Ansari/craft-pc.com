...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 43; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg3/Computers.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Nova Knight</h3>
                <h2>PKR 140,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>H.E.MechWarrior MOD-3 Case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i5-10400 6-core</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GeForce GTX 1650 Super 4GB</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>MSI B460M PRO-VDH Micro ATX</u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>Crucial Ballistix 16GB DDR4</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Kingston A2000 250GB NVMe M.2</u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Corsair CV550, CV Series</u></b></h4>
                </div>
                <span>The H.E. MechWarrior MOD-3 Case accommodates a powerful setup featuring the Intel Core i5-10400 6-core processor and an NVIDIA GeForce GTX 1650 Super 4GB GPU, providing a balanced performance for various tasks. The MSI B460M PRO-VDH Micro ATX motherboard and Crucial Ballistix 16GB DDR4 RAM ensure stable and efficient multitasking capabilities. Swift data storage is provided by the Kingston A2000 250GB NVMe M.2 SSD. The system is powered by the reliable Corsair CV550, CV Series PSU, ensuring a steady and efficient power supply for a smooth computing experience.</span>
            </div>
        </div>
        </form>
    </section>
