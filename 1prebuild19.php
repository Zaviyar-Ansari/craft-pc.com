...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 19; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg1/H710 Series _ Gaming PC Cases.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4"> NZXT H710 ATX</h3>
                <h2>PKR 365,433</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>NZXT H710 ATX </u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>AMD Ryzen 7 5800X</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u> NVIDIA GeForce RTX 3070  </u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>ASUS TUF Gaming B550-PLUS </u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>Corsair Vengeance LPX 32GB DDR4 </u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Kingston A2000 3TB NVMe M.2 </u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Corsair CX650M - A reputable 650W </u></b></h4>
                </div>
                <span>
                    The NZXT H710 ATX system is driven by the potent AMD Ryzen 7 5800X processor and the high-performance NVIDIA GeForce RTX 3070 graphics card for robust gaming experiences. The ASUS TUF Gaming B550-PLUS motherboard provides a stable foundation with essential features. With 32GB of Corsair Vengeance LPX DDR4 RAM, the system ensures efficient multitasking. Storage is handled by a spacious 3TB Kingston A2000 NVMe M.2 SSD for fast and ample storage. The Corsair CX650M, a reputable 650W power supply, delivers reliable and efficient power to the components, completing a balanced and powerful PC setup.</span>
            </div>
        </div>
        </form>
    </section>
