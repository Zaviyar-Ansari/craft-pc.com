...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 227; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories//cpucooler/images (15).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4">Cooler Master Standard Cooler i50 </h3>
                <h2>PKR 3,521 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/istockphoto-1373113476-612x612 (1).jpg" alt=""> <b><u> Cooler Master Standard Cooler i50</u></b>
                </div>
                <span>The Cooler Master Standard Cooler i50 – an affordable cooling solution designed to keep your CPU running smoothly. With its compact and efficient design, this cooler provides reliable heat dissipation for optimal performance. Equipped with a quiet fan, it ensures efficient airflow while maintaining low noise levels. Its compatibility with various Intel and AMD sockets makes it suitable for a wide range of system configurations. Upgrade your cooling setup without breaking the bank with the Cooler Master Standard Cooler i50 and enjoy enhanced performance for your daily computing needs. </span>
            </div>
        </div>
    </form>
