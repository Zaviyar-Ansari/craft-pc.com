...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 48; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg3/Thermaltake Glacier 360 Liquid-Cooled PC (AMD Ryzen 5 5600X, RTX 3060, 16GB 3600Mhz DDR4 ToughRAM RGB Memory, 1TB NVMe M_2, WiFi, Win 10 Home) Gaming Desktop Computer S3WT-B550-G36-LCS,White.jpeg.jpeg.jpeg"
                    id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Chrono Catalyst</h3>
                <h2>PKR 145,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Thermaltake Glacier 360 Case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u></u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GeForce GTX 1660 6GB</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>MSI B460M PRO-VDH Micro ATX </u></b></h4>
                    ...
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Cooler Master MWE 550W</u></b></h4>
                </div>
                <span>The Thermaltake Glacier 360 case houses a powerful Intel Core i5-10400F processor and an NVIDIA GeForce GTX 1660 6GB GPU for smooth gaming. With a reliable MSI B460M PRO-VDH Micro ATX motherboard and Corsair Vengeance LPX 16GB DDR4 RAM, it delivers efficient multitasking. Fast storage is ensured by the Kingston A2000 500GB NVMe M.2 SSD. The system is powered by a Cooler Master MWE 550W PSU, ensuring stable and efficient performance.</span>
            </div>
        </div>
        </form>
    </section>
