...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 40; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/PCSPECIALIST Vortex ST-S Gaming PC - Intel®Core_ i7, RTX 3070, 2 TB HDD & 512 GB SSD (1).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Nebula Nova</h3>
                <h2>PKR 140,000 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>PCSPECIALIST Vortex ST-S Gaming Case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i5-11600K</u></b></h4>
                ...
                <span>
                    The PCSPECIALIST Vortex ST-S Gaming Case hosts a potent gaming setup featuring the Intel Core i5-11600K processor and ASUS Dual GeForce RTX 3060 for impressive gaming performance. Supported by the MSI B560M PRO-VDH WIFI motherboard, it ensures stability and connectivity. Corsair Vengeance LPX 16GB DDR4 RAM, coupled with the Kingston A2000 1TB NVMe PCIe M.2 SSD, provides efficient multitasking and swift storage. The reliable Corsair EVGA 600 BQ, 80+ Bronze PSU, completes this configuration for a powerful and stable gaming experience.</span>
            </div>
        </div>
        </form>
    </section>
