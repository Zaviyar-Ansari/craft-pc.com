...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 249; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/images (25).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4"> Phanteks 120mm LED Case Fan</h3>
                <h2>PKR 5,699</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>Phanteks 120mm LED Case Fan</u></b>
                </div>
                <span> The Phanteks 120mm LED Case Fan, priced at PKR 5,699. This fan offers efficient cooling performance with its 120mm size and features vibrant LED lighting to enhance the aesthetics of your PC build. Ideal for improving airflow and maintaining optimal temperatures for your components. Upgrade your case cooling with the Phanteks 120mm LED Case Fan and enjoy both functionality and style in your system.</span>
            </div>
        </div>
    </form>
