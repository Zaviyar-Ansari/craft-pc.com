...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 97; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/images (1).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">Intel Pantium Gold</h3>
                <h2>PKR 28,120</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Pantium Gold</u></b></h4>
                </div>
                <span>The Intel Pentium Gold is a series of budget-friendly processors aimed at entry-level computing needs. These CPUs provide basic performance for everyday tasks such as web browsing, office applications, and light productivity. They are characterized by dual-core or quad-core configurations and are often used in budget-friendly desktops and low-cost laptops. While not designed for demanding tasks like gaming or intensive content creation, Intel Pentium Gold processors offer a cost-effective solution for users with basic computing requirements. Specific details, such as clock speeds and core configurations, may vary across different Pentium Gold models.</span>
            </div>
        </div>
        </form?>
    </section>
