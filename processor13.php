...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 105; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/images (5).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">Intel Core i5-9600K</h3>
                <h2>PKR 47,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i5-9600K</u></b></h4>
                </div>
                <span>The Intel Core i5-9600K is a processor from the 9th generation Intel Core series. It features 6 cores and 6 threads, with a base clock speed of 3.7 GHz and a maximum turbo frequency of 4.6 GHz. Built on the Coffee Lake architecture and utilizing the LGA 1151 socket, the i5-9600K delivers strong performance for gaming and general computing tasks. Known for its overclocking capabilities, it's a popular choice among users seeking a balance of price and performance. Specific details may vary based on regional availability and exact SKU.</span>
            </div>
        </div>
        </form?>
    </section>
