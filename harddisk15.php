...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 207; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/images (9).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">WD SATA Hard Drive 5TB</h3>
                <h2>PKR 36,000</h2>
                <input type="hidden" name="product_id" value="207"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>WD SATA Hard Drive 5TB</u></b>
                </div>
                <span>The WD SATA Hard Drive 5TB offers expansive storage with 5TB capacity. It ensures fast data transfer rates via SATA interface. Reliable and durable, it suits personal and professional needs. Backed by WD's reputation, it guarantees performance. Ideal for upgrading or building systems requiring high-capacity storage.</span>
            </div>
        </div>
        </form>
    </section>
