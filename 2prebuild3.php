...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 23; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/Acer Predator Orion 3000 gaming desktop now configurable with an Intel Core i7-11700 and Nvidia GeForce RTX 3070.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">MegaMultitasker 3000</h3>
                <h2>PKR 110,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Acer Predator Orion 3000</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i7-11700</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>Nvidia GeForce RTX 3070</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u></u>MSI B550 Tomahawk</b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>16GB DDR4 (3200MHz)</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u> Corsair 500GB NVMe SSD + Seagate 500GB HDD</u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>NVIDIA GeForce GTX 1660 Super</u></b></h4>
                </div>
                <span>The Acer Predator Orion 3000, equipped with an Intel Core i7-11700, delivers a powerful gaming experience. With the Nvidia GeForce RTX 3070, graphics performance is exceptional, ensuring an immersive gameplay environment. The MSI B550 Tomahawk motherboard, featuring PCIe 4.0 support, provides a robust foundation for the system. Corsair's 16GB DDR4 RAM at 3200MHz ensures efficient multitasking and smooth gaming. Storage includes a Corsair 500GB NVMe SSD for quick system responsiveness and a Seagate 500GB HDD for added storage capacity. Additionally, the system features the reliable Nvidia GeForce GTX 1660 Super for excellent 1080p gaming performance.                </span>
            </div>
        </div>
        </form>
    </section>
