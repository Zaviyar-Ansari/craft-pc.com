...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 201; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/f92e30278cfa4790e7ebb10a7ae07514.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">WD Black 3.5-Inch</h3>
                <h2>PKR 58,999</h2>
                <input type="hidden" name="product_id" value="201"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>WD Black 3.5-Inch</u></b>
                </div>
                <span>The WD Black 3.5-Inch hard drive boasts high-performance storage with a spacious capacity. Engineered for durability and speed, it ensures rapid data access and transfer rates, ideal for gaming and content creation. Its 3.5-inch form factor ensures compatibility with desktop setups. With WD Black branding, it signifies top-tier performance and reliability. Upgrade your system with the WD Black 3.5-Inch hard drive for enhanced storage capabilities.
