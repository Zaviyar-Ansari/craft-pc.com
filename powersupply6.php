...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 178; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/powersupply/9a15d375fdb7cd4e648b54cc24238fc6.jpg"" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Powersupply</h6>
                <h3 class="py-4"> NOx Power Supply atx hummer 650Watt</h3>
                <h2>PKR 25,104</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u> NOx Power Supply atx hummer 650Watt</u></b></h4>
                </div>
                <span> The NOx Power Supply ATX Hummer 650Watt stands out as a robust unit providing reliable power for your PC setup. Featuring a 650-watt capacity, it ensures smooth performance across various components. Specifically designed for ATX compatibility, it seamlessly fits into standard PC cases, offering versatility in system builds. Engineered to deliver stable power output, the NOx Hummer contributes to the longevity and performance of your hardware. Elevate your PC's power supply with the NOx Hummer 650Watt, offering dependable performance at an affordable price.</span>
            </div>
        </div>
        </form?>
    </section>
