...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 144; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/graphiccard/ac4fe8ccbae500c3d0e18ae615db9e5a.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Graphic Cards</h6>
                <h3 class="py-4">ASUS GeForce RTX 2080 O8G ROG STRIX OC</h3>
                <h2>PKR 191,399</h2>
