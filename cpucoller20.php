...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 232; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/cpucooler/2904c7457dc17ca32b904a173a218db9.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4"> Corsair H55 RGB 120mm Liquid CPU Cooler</h3>
                <h2> PKR 21,600</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/istockphoto-1373113476-612x612 (1).jpg" alt=""> <b><u> Corsair H55 RGB 120mm Liquid CPU Cooler</u></b>
                </div>
                <span> The Corsair H55 RGB 120mm Liquid CPU Cooler – a high-performance cooling solution designed to enhance your system's performance. With its sleek design and vibrant RGB lighting, this cooler adds a touch of style to your setup while efficiently cooling your CPU. Featuring a 120mm radiator and a reliable pump design, it offers excellent heat dissipation for maximum performance. Equipped with a quiet fan, it ensures optimal airflow without compromising on noise levels. Compatible with various Intel and AMD sockets, it provides versatility for different system configurations. Elevate your cooling system with the Corsair H55 RGB and enjoy improved performance and aesthetics for your gaming or productivity needs.</span>
            </div>
        </div>
    </form>
