...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 279; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg/Antec Torque.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">Antec Torque</h3>
                <h2>PKR 11,446</h2>
                ...
                <span>The Antec Torque PC case is a distinctive, open-air chassis designed for PC enthusiasts and modders. Its angular, striking design and dual tempered glass panels make it a visually stunning choice for showcasing high-end hardware. The open-frame structure maximizes airflow and accessibility, making it easy to build and customize your system. It supports E-ATX motherboards, and the dual-chamber layout separates components for cleaner cable management and improved cooling. The case also accommodates multiple radiators and fans for efficient cooling solutions. The Antec Torque is a premium option for users who prioritize both aesthetics and performance in their PC builds.</span>
            </div>
        </div>
        </form>
    </section>
