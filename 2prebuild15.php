...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 35; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/Predator Orion Series Desktops to Feature New 9th Gen Intel Core Desktop Processors to Deliver Powerful Gaming Experiences.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Predator Orion Series case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u> Intel Core i5-11400</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>ASUS Dual GeForce RTX 3060 </u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>ASUS Prime B560M-A</u></b></h4>
                ...
                <span>
                    The Predator Orion Series case houses a formidable gaming setup, featuring the Intel Core i5-11400 for robust performance. The graphics are powered by the ASUS Dual GeForce RTX 3060, ensuring immersive gaming experiences. Paired with the ASUS Prime B560M-A motherboard and Corsair Vengeance LPX 16GB DDR4 RAM, the system delivers stability and efficient multitasking. Storage is handled by the Kingston A2000 1TB NVMe PCIe M.2 SSD, providing both speed and ample capacity. The system is powered by the reliable Corsair EVGA 600 BQ, 80+ Bronze PSU, ensuring efficient and stable power delivery for a well-rounded gaming rig.</span>
            </div>
        </div>
        </form>
    </section>
