...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 214; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/cpucooler/7b0f63c7616f6360c004f3e573a74f4f.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4">Cryoring H7 Tower Cooling Fan</h3>
                <h2> PKR 28,507</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/istockphoto-1373113476-612x612 (1).jpg" alt=""> <b><u> Cryoring H7 Tower Cooling Fan</u></b>
                </div>
                <span>
The Cryorig H7 Tower Cooling Fan is a premium cooling solution designed to maintain optimal temperatures for your CPU. Featuring a tower-style design, it efficiently dissipates heat while minimizing noise levels, ensuring a quiet computing experience. With its sleek and modern aesthetic, it enhances the overall look of your system. Engineered for high performance, it provides reliable cooling for intense gaming sessions, content creation, and demanding tasks. Upgrade your PC's cooling system with the Cryorig H7 Tower Cooling Fan for improved thermal management and enhanced performance. </span>
            </div>
        </div>
    </form>
