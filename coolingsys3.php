...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 256; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingsystem/images (29).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4"> Master Liquid Maker 240</h3>
                <h2>PKR 43,559 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/resized-images.png" alt=""> <b><u>Master Liquid Maker 240  </u></b>
                </div>
                <span>
The Master Liquid Maker 240, an advanced water cooling system designed to provide superior thermal management for your PC components. With its efficient cooling capabilities, this system ensures optimal performance and reliability, even during demanding tasks such as gaming or content creation. The Master Liquid Maker 240 offers easy installation and customizable features, allowing you to tailor the cooling setup to your specific needs. Upgrade your PC's cooling solution with the Master Liquid Maker 240 and experience enhanced performance and longevity for your system components. </span>
            </div>
        </div>
    </form>
