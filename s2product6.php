...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 295; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/Intel Core i9-7900X X-Series Processor 10 Cores up to 4_3 GHz Turbo Unlocked LGA2066 X299 Series 140W.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">Intel Core i9-7900X X-Series4_3 </h3>
                <h2>PKR 115,080</h2>
                ...
                <span> The Intel Core i9-7900X X-Series processor is a powerhouse designed for demanding computing tasks. With 10 cores and 20 threads, it delivers exceptional multi-core performance, making it ideal for tasks like content creation, video editing, and high-end gaming. The processor operates at a base clock speed of 3.3GHz, which can be boosted to 4.3GHz for increased performance when needed. This CPU is part of Intel's high-performance X-Series lineup, offering advanced features like Turbo Boost Max Technology 3.0 and support for quad-channel DDR4 memory. Whether you're a professional content creator or a hardcore gamer, the i9-7900X is a formidable choice for top-tier performance. </span>
