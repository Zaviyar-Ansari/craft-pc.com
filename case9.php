...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 57; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/case/15 Best Cases For Water Cooling 2023 – Mid, Full & Super Tower Options _ PC Mecca.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Cases</h6>
                <h3 class="py-4">Crystal Series 570X RGB ATX Mid-Tower Case</h3>
                <h2>PKR 30,500</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Crystal Series 570X RGB ATX Mid-Tower Case</u></b>
                </div>
                <span>The Crystal Series 570X RGB ATX Mid-Tower Case is an aesthetically pleasing and feature-rich chassis designed for ATX builds. With tempered glass panels on four sides, it provides a clear view of your components and RGB lighting. The mid-tower form factor strikes a balance between space efficiency and component support, making it an attractive choice for users looking to showcase their builds with vibrant RGB illumination.</span>
            </div>
        </div>
        </form>
    </section>
