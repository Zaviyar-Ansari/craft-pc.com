...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 107; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/images (7).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">Intel Core i9-11900K</h3>
                <h2>PKR 104,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i9-11900K</u></b></h4>
                </div>
                <span>
                    The Intel Core i9-11900K is a processor from the 11th generation Intel Core series, codenamed Rocket Lake. It features 8 cores and 16 threads, with a base clock speed of 3.5 GHz and a maximum turbo frequency of 5.3 GHz. Utilizing the LGA 1200 socket and built on the Cypress Cove architecture, the i9-11900K is designed for high-performance computing tasks, including gaming and content creation. It represents one of Intel's flagship CPUs, offering strong single-threaded and multi-threaded performance. Specific details may vary based on regional availability and exact SKU.</span>
            </div>
        </div>
        </form?>
    </section>
