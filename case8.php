...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 56; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/case/Sharkoon ELITE SHARK CA700 PC Case Review.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Cases</h6>
                <h3 class="py-4">Sharkoon ELITE SHARK CA700 PC Case</h3>
                <h2>PKR 376,298</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Sharkoon ELITE SHARK CA700 PC Case</u></b>
                </div>
                <span>
                    The Sharkoon ELITE SHARK CA700 PC Case is a high-performance chassis featuring a stylish design with ample space for components. With its mid-tower form factor, it strikes a balance between size and functionality. The case is designed to accommodate gaming and high-performance setups, offering a mix of aesthetics and practicality for PC enthusiasts.</span>
            </div>
        </div>
        </form>
    </section>
