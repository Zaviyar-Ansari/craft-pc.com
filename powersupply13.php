...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 185; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/powersupply/9521e8e16132062b93f37e237db466f3.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Powersupply</h6>
                <h3 class="py-4">Corsair RMe1000Watt ATX 3.0 </h3>
                <h2>PKR 50,202</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Corsair RMe1000Watt ATX 3.0</u></b></h4>
                </div>
                <span> The Corsair RMe1000Watt is a powerful power supply unit featuring ATX 3.0 compatibility. With its 1000-watt capacity, it provides ample power for high-performance computing tasks. Engineered for efficiency and reliability, it ensures stable power delivery to your PC components. Crafted by Corsair, a trusted brand in PC hardware, it guarantees performance and durability. Elevate your PC's power supply with the Corsair RMe1000Watt for reliable operation and compatibility.
