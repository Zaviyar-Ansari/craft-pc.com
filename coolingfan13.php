...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 245; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/cl-f100-pl12sw-a-min.webp" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4"> Thermaltake Riing Quad 12 RGB Radiator Fan/3 Pack</h3>
                <h2> PKR 36,280 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>Thermaltake Riing Quad 12 RGB Radiator Fan/3 Pack </u></b>
                </div>
                <span> The Thermaltake Riing Quad 12 RGB Radiator Fan 3-Pack – a comprehensive cooling solution designed to enhance your PC's performance and aesthetics. Each fan features vibrant RGB lighting and a unique quad-ring design, adding a striking visual element to your build. Engineered for efficient airflow and heat dissipation, these fans ensure optimal cooling for your components, even under heavy workloads. With compatibility with Thermaltake's RGB Plus software, you can customize the lighting effects to match your build's theme or sync them with other RGB components. Upgrade your cooling system with the Thermaltake Riing Quad 12 RGB Radiator Fan 3-Pack and enjoy superior cooling performance with customizable RGB lighting effects.</span>
            </div>
        </div>
    </form>
