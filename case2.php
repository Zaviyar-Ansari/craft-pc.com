...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 50; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/case/3024ac8c-3cfe-41d7-9c52-ede2bc36efeb.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Cases</h6>
                <h3 class="py-4">Corsair Alpha Mid-Tower</h3>
                <h2>PKR 25,384</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Corsair Alpha Mid-Tower</u></b>
                </div>
                <span>
                    The Corsair Alpha Mid-Tower is a sleek and versatile case designed for optimal airflow and cable management. With a minimalist aesthetic, it provides ample space for high-performance components and liquid cooling solutions. Its tempered glass side panel offers a clear view of your build while maintaining a clean and modern look.</span>
            </div>
        </div>
        </form>
    </section>
