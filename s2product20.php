...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 309; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/GIGABYTE TRX40 DESIGNARE (sTRX AMD TRX40_Direct 16+3 Phase VRM_Fins-Array Heatsink_Gen 4 AIC with 4.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">GIGABYTE TRX40 DESIGNARE Motherboard </h3>
                <h2>PKR 265,228</h2>
                ...
                <span>The GIGABYTE TRX40 DESIGNARE motherboard is a high-end and feature-rich option designed for enthusiasts and professionals seeking exceptional performance. Built for AMD Ryzen Threadripper processors, it offers a robust foundation for content creation and high-performance computing. The TRX40 chipset provides extensive connectivity and support for high-speed storage and memory, making it suitable for demanding workloads. This motherboard also stands out with its sleek design, customizable RGB lighting, and durable build quality. Whether you're building a workstation for video editing or a gaming rig for high-end performance, the TRX40 DESIGNARE combines style and substance to cater to your computing needs.</span>
            </div>
        </div>
        </form>
    </section>
