...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 315; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg3/NZXT Phantom.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">NZXT Phantom Custom PC Case</h3>
                <h2>PKR 2,100</h2>
                <input type="hidden" name="product_id" value="315"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Details</h4>
                <span>The NZXT Phantom Custom PC Case is a premium chassis known for its unique and striking design. This full-tower case offers extensive space for high-performance components and efficient cable management, ensuring a clean and organized interior. The Phantom series is appreciated for its cooling capabilities, featuring multiple fan mounts and liquid cooling support. With a robust build quality and durability, this case is well-regarded among enthusiasts and gamers. It also includes customizable lighting options for a personalized look. The NZXT Phantom Custom PC Case is a solid choice for those seeking a spacious and visually appealing case to house their powerful gaming or workstation build.</span>
            </div>
        </div>
        </form>
    </section>
