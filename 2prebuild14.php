...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 34; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/Thermaltake - AH-370 Gaming PC - AMD Ryzen 7 3700X CPU - NVIDIA GeForce RTX 3070 - 3600Mhz DDR4 Memory - NVMe 1TB M_2.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Stealth Vortex</h3>
                <h2>PKR 135,000 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Thermaltake AH-370 Gaming Case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i5-11400</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>ASUS Dual GeForce GTX 1660 Super</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>ASUS Prime B560M-A </u></b></h4>
                ...
                <span>The Thermaltake AH-370 Gaming Case shelters a high-powered gaming setup featuring the Intel Core i5-11400 and ASUS Dual GeForce GTX 1660 Super. Supported by the ASUS Prime B560M-A motherboard and 16GB Corsair Vengeance LPX DDR4 RAM, it ensures stable performance and seamless multitasking. Storage is handled by the Kingston A2000 1TB NVMe PCIe M.2 SSD, offering both speed and ample capacity. The system is powered by the reliable Corsair CV650 80+ Bronze PSU, delivering efficient and stable power. This compact powerhouse combines style and substance for an immersive gaming experience.</span>
            </div>
        </div>
        </form>
    </section>
