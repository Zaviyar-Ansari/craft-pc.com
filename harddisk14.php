...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 206; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/images (8).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">WD SATA Hard Drive 1TB</h3>
                <h2>PKR 12,000</h2>
                <input type="hidden" name="product_id" value="206"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>WD SATA Hard Drive 1TB</u></b>
                </div>
                <span>The WD SATA Hard Drive with a generous 1TB storage capacity, available at a competitive price of PKR 12,000. This reliable hard drive is ideal for storing a wide range of digital content, including documents, photos, videos, and more. With its SATA interface, it ensures fast and efficient data transfer speeds for smooth performance. Whether you're upgrading your desktop computer or expanding your storage capabilities, the WD SATA Hard Drive offers dependable performance and ample storage space. Trust in Western Digital's renowned quality and reputation for a reliable storage solution that meets your needs.</span>
            </div>
        </div>
        </form>
    </section>
