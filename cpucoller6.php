...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 218; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/cpucooler/8b90e310acc42322dc3f475a1abb3be3.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4">cryoring CPU Cooler Single Fan Side Flow AMD, H7 V2 </h3>
                <h2>PKR 10,352 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/istockphoto-1373113476-612x612 (1).jpg" alt=""> <b><u> cryoring CPU Cooler Single Fan Side Flow AMD, H7 V2</u></b>
                </div>
                <span>The Cryorig H7 V2 CPU Cooler offers efficient cooling performance with its single fan side flow design, optimized for AMD processors. With its compact size and powerful airflow, it effectively dissipates heat to keep your CPU running smoothly. The H7 V2 is a reliable choice for users seeking effective cooling solutions at an affordable price point.
