...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 33; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/PCSPECIALIST Official Fnatic Gaming PC - AMD Ryzen 7, RX 6800 XT, 2 TB HDD & 500 SSD.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Phoenix Ascendant</h3>
                <h2>PKR 140,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>PC Specialist official Fantic Case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>AMD Ryzen 5 5600X</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>ASUS Dual GeForce RTX 3060 </u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u> MSI MAG B550 TOMAHAWK </u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u> Corsair Vengeance LPX 16GB DDR4</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Kingston A2000 1Tb NVMe PCIe M.2 </u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Corsair CV650 80+ Bronze</u></b></h4>
                </div>
                <span>The PC Specialist Official Fantic Case encapsulates a high-performance gaming system, featuring the AMD Ryzen 5 5600X processor and ASUS Dual GeForce RTX 3060 for exceptional gaming prowess. The MSI MAG B550 TOMAHAWK motherboard ensures stability and offers advanced features for seamless performance. With Corsair Vengeance LPX 16GB DDR4 RAM and Kingston A2000 1TB NVMe PCIe M.2 SSD, the system provides efficient multitasking and swift data access. Powered by the Corsair CV650 80+ Bronze PSU, this setup delivers reliable and efficient power to sustain peak performance. This configuration, housed in the PC Specialist Official Fantic Case, offers a potent combination of power and style for an immersive gaming experience.
