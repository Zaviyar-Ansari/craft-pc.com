...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 271; // Set the product ID to 3
        ...
        <form action="#" method="post">
            <div class="row mt-5">
                <div class="col-lg-5 col-md-12 col-12">
                    <img class="img-fluid w-100 pb-1" src="shopprodimg/Msi Mpg A750Gf 750W 80+ Gold Certified Modular Atx Power Supply Unit.jpeg" id="MainImg" alt="">
                </div>
                <div class="col-lg-6 col-md-12 col-12">
                    <h6> Home / Shop / Featured Products</h6>
                    <h3 class="py-4">MSI Mpg A75Gf 80+ Power Supply</h3>
                    <h2>PKR 46,882</h2>
                    ...
                    <span>The MSI MPG A75GF is a power supply unit known for its 80+ certification, indicating high efficiency. It offers reliable power delivery for your PC components, ensuring stable performance. With a wattage rating suitable for most gaming and productivity setups, it caters to a broad range of system configurations. The PSU features multiple connectors for various components, including GPUs, motherboards, and storage devices. Its robust build quality and active PFC (Power Factor Correction) contribute to better voltage regulation and overall system reliability. The MSI MPG A75GF is a solid choice for those seeking a dependable and efficient power supply for their computing needs.</span>
                </div>
            </div>
            </form>
        </section>
