...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 38; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/Memory PC Gamer Intel i7-9700K 8 x 3,6 GHz, 32 Go DDR4 RAM, 480 Go SSD + 2000 Go HDD, 8 Go RT___.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Cyber Serenity</h3>
                <h2>PKR 150,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Aero Cool RGB Gaming Case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i7-11700K</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>ASUS Dual GeForce RTX 3060</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>MSI B560M PRO-VDH WIFI </u></b></h4>
                    ...
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u> Corsair EVGA 600 BQ, 80+ Bronze</u></b></h4>
                </div>
                <span>The Aero Cool RGB Gaming Case houses a powerful gaming setup featuring the Intel Core i7-11700K and ASUS Dual GeForce RTX 3060, delivering exceptional performance. With the MSI B560M PRO-VDH WIFI motherboard, stability and connectivity are ensured. Corsair Vengeance LPX 16GB DDR4 RAM and Kingston A2000 1TB NVMe PCIe M.2 SSD provide efficient multitasking and swift storage. The system is powered by the reliable Corsair EVGA 600 BQ, 80+ Bronze PSU, delivering stable and efficient power for a high-performance gaming experience. This configuration combines power, style, and RGB aesthetics within the Aero Cool RGB Gaming Case.</span>
            </div>
        </div>
        </form>
    </section>
