...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 11; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg1/Tempered Glass Gaming Computer Case.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Galactic Core Master</h3>
                <h2>PKR 190,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u> Core P3 Tempered Glass</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>AMD Ryzen 5 5600X </u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GeForce GTX 1660 Ti </u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u> ASUS TUF Gaming B450-PLUS</u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u> G.Skill Ripjaws V Series 16GB DDR4  </u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u> Crucial P3 500GB NVMe + Seagate Barracuda 2TB HDD</u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>EVGA 750 W1 </u></b></h4>
                </div>
                <span>The Core P3 Tempered Glass houses a potent AMD Ryzen 5 5600X and NVIDIA GeForce GTX 1660 Ti combo for solid gaming performance. Supported by the ASUS TUF Gaming B450-PLUS motherboard and 16GB of G.Skill Ripjaws V Series DDR4 RAM, it ensures stability and efficient multitasking. Storage includes a fast Crucial P3 500GB NVMe SSD alongside a spacious Seagate Barracuda 2TB HDD. The EVGA 750 W1 power supply provides reliable energy delivery for this high-performance setup. In a sleek design, this PC is a compelling choice for gamers and content creators alike.</span>
