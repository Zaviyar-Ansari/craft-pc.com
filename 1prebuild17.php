...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 17; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg1/Компьютеры для игр, дома, офиса.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Titan Tech Tower</h3>
                <h2> PKR 160,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>AA Tiger Alienware </u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i7-12700K </u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GeForce RTX 3060 </u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>MSI MAG B560 TOMAHAWK </u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>Corsair Vengeance LPX 16GB DDR4 </u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Kingston A2000 500GB NVMe M.2 & Seagate Barracuda 2TB </u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>EVGA 600 W1 </u></b></h4>
                </div>
                <span>The AA Tiger Alienware features an Intel Core i7-12700K processor for powerful computing, complemented by an NVIDIA GeForce RTX 3060 for impressive gaming graphics. The MSI MAG B560 TOMAHAWK motherboard ensures stability and essential features. With 16GB of Corsair Vengeance LPX DDR4 RAM, the system facilitates smooth multitasking. Storage is managed by a fast 500GB Kingston A2000 NVMe M.2 SSD for quick access, paired with a spacious 2TB Seagate Barracuda HDD for additional storage needs. The EVGA 600 W1 power supply provides reliable and efficient power delivery for the components, completing a high-performance gaming setup.</span>
