...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 307; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/ASRock Fatal1ty X399 Professional Gaming.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">ASRock Fatal1ty X399 Professional Gaming </h3>
                <h2>PKR 276,083</h2>
                ...
                <span>The ASRock Fatal1ty X399 Professional Gaming motherboard is a top-tier choice for enthusiasts and gamers seeking exceptional performance and features. Designed for AMD Ryzen Threadripper processors, it offers a robust foundation for high-end computing and gaming setups. This motherboard supports the AMD X399 chipset, providing extensive connectivity options and impressive multitasking capabilities. With its reliable build quality, ample expansion slots, and customizable RGB lighting, the Fatal1ty X399 strikes a balance between aesthetics and functionality. Whether you're building a powerful workstation or gaming rig, this motherboard caters to both performance and style, making it a compelling choice for demanding users.</span>
            </div>
        </div>
        </form>
    </section>
