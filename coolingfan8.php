...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 240; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/images (21).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4"> Thermaltake EX14 RGB PC Cooling FaN TT Premium Edition</h3>
                <h2>PKR 28,344,096 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>Thermaltake EX14 RGB PC Cooling FaN TT Premium Edition</u></b>
                </div>
                <span>The Thermaltake EX14 RGB PC Cooling Fan TT Premium Edition – an advanced cooling solution designed to optimize your PC's performance while adding a touch of style. With vibrant RGB lighting and a sleek design, this fan enhances the aesthetic appeal of your build. Engineered for efficient airflow and heat dissipation, it keeps your components cool even under heavy workloads. The TT Premium Edition ensures top-notch quality and reliability, offering peace of mind for your system's cooling needs. Compatible with various setups, the Thermaltake EX14 RGB Fan is the perfect choice for gamers, content creators, and enthusiasts seeking both performance and aesthetics. Upgrade your cooling system with the Thermaltake EX14 RGB PC Cooling Fan TT Premium Edition and enjoy superior cooling performance with style.
