...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 247; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            ...
            <div class="col-lg-6 col-md-12 col-12">
                ...
                <h3 class="py-4"> NZXT Are, RGB LED Fan</h3>
                <h2>PKR 19,920 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>NZXT Are, RGB LED Fan</u></b>
                </div>
                <span> The NZXT Are RGB LED Fan – a sleek and stylish addition to your PC cooling setup. With its vibrant RGB lighting, this fan adds a pop of color and personality to your build. Engineered for efficient airflow and heat dissipation, it ensures optimal cooling performance for your components, even under demanding workloads. The NZXT Are fan is compatible with various setups and offers easy installation, making it suitable for both novice and experienced builders alike. Elevate your PC's aesthetics and cooling capabilities with the NZXT Are RGB LED Fan.</span>
            </div>
        </div>
    </form>
