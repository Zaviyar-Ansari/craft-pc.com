...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 283; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg/AMD A10-5800K Black Edition is a Top Trinity with Turbo at 4_2GHz.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">AMD A10-5800k Black Edition</h3>
                <h2>PKR 27,537</h2>
                ...
                <span>The AMD A10-5800K Black Edition processor is a notable choice for those seeking a balanced blend of performance and affordability. Featuring quad-core processing with a base clock speed of 3.8GHz, it offers respectable computing power for everyday tasks and light gaming. What sets this APU (Accelerated Processing Unit) apart is its integrated Radeon HD 7660D graphics, which eliminates the need for a separate graphics card in budget gaming setups. Overclocking enthusiasts will appreciate the 'Black Edition' label, indicating unlocked multiplier support for fine-tuning performance. While it may not compete with the latest processors, the A10-5800K remains a solid option for budget-conscious users looking to build a capable system.</span>
            </div>
        </div>
        </form>
    </section>
