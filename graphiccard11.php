...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 143; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/graphiccard/abd8c28f4ef2c5292b0002d3200b2d4f.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Graphic Cards</h6>
                <h3 class="py-4">EVGA GeForce GTX 480</h3>
                <h2>PKR 2,038</h2>
