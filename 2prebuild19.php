...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 39; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/PCSPECIALIST ESL Tournament Gaming PC - Intel®Core i7, RTX 3070, 2 TB HDD & 512 GB SSD.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Mirage Master</h3>
                <h2>PKR 130,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Master Box K500L Case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i5-11600K</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>ASUS Dual GeForce GTX 1660 Super</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>MSI B560M PRO-VDH WIFI </u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>Corsair Vengeance LPX 16GB DDR4</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Kingston A2000 500GB NVMe PCIe M.2</u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u> Corsair CV650 80+ Bronze </u></b></h4>
                </div>
                <span>The Master Box K500L Case hosts a formidable gaming setup, featuring the Intel Core i5-11600K processor and ASUS Dual GeForce GTX 1660 Super for robust gaming performance. Supported by the MSI B560M PRO-VDH WIFI motherboard, it ensures stability and connectivity. Corsair Vengeance LPX 16GB DDR4 RAM provides efficient multitasking, complemented by the speedy Kingston A2000 500GB NVMe PCIe M.2 SSD for responsive storage. The Corsair CV650 80+ Bronze PSU delivers reliable and efficient power. With its sleek design and practical features, the Master Box K500L completes this configuration, offering a balanced gaming experience with style.
