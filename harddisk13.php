...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 205; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/images (7).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">Westren Digital WD1000 Hard Drive 6TB</h3>
                <h2>PKR 33,000</h2>
                <input type="hidden" name="product_id" value="205"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>Westren Digital WD1000 Hard Drive 6TB</u></b>
                </div>
                <span>The Western Digital WD1000 Hard Drive, boasting an impressive 6TB storage capacity at a competitive price of PKR 33,000. This high-capacity drive provides ample space to store your vast collection of files, including documents, photos, videos, and more. Designed for reliability and performance, it ensures seamless operation for various computing tasks, whether you're a professional or a home user. With Western Digital's trusted quality and reputation, the WD1000 Hard Drive offers a dependable storage solution to meet your needs. Upgrade your storage capabilities with this robust and spacious hard drive from Western Digital.
</span>
            </div>
        </div>
        </form>
