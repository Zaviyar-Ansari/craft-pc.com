...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 118; // Set the product ID to 3
...
<li class="nav-item">
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ram/62e2b916058482fb0f273eb886d13ccc.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / RAM</h6>
                <h3 class="py-4">PNY 16\gb XLR8 Gamming DDR4</h3>
                <h2>PKR 13,000</h2>
    ...
    <script>
        ...
        function addToCart() {
            // Get product details
            var productName = "Your Product Name"; // Update with actual product name
            var productPrice = 1000; // Update with actual product price
            var quantity = parseInt(document.querySelector('.sproduct input').value);
            ...
            var existingItemIndex = existingCartItems.findIndex(item => item.name === productName);
            ...
            // Provide visual feedback to the user (you can customize this part)
