...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 242; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/6146CBG6wpL._AC_UF1000,1000_QL80_.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4"> GTRACING 3pcs 120mm RGB</h3>
                <h2> PKR 18,969</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>GTRACING 3pcs 120mm RGB</u></b>
                </div>
                <span>The GTRACING 3pcs 120mm RGB Fan Set – a dynamic cooling solution to enhance your PC experience. With three high-quality fans included, this set offers optimal airflow to keep your components cool and running smoothly. Each fan features vibrant RGB lighting, adding a stylish flair to your build. Engineered for efficient cooling, these 120mm fans ensure reliable performance under demanding tasks. Compatible with various PC setups, the GTRACING RGB Fan Set is perfect for gamers, content creators, and enthusiasts alike. Elevate your cooling system with the GTRACING 3pcs 120mm RGB Fan Set and enjoy both performance and aesthetics in one package. </span>
            </div>
        </div>
    </form>
