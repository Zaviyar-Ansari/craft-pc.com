...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 32; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/PCSPECIALIST Tornado R5i Gaming PC - AMD Ryzen 5, GTX 1660 Ti, 1 TB HDD & 512 GB SSD.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Quantum Blaze</h3>
                <h2>PKR 120,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>PC Specialist Tornado R5</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>AMD Ryzen 5 3600</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>ASUS Dual GeForce GTX 1660 Super </u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u> MSI B450 TOMAHAWK MAX</u></b></h4>
                ...
                <span>The PC Specialist Tornado R5 is a gaming powerhouse, featuring the robust AMD Ryzen 5 3600 processor for seamless multitasking. Its graphics prowess is driven by the ASUS Dual GeForce GTX 1660 Super, ensuring smooth and immersive gaming experiences. The MSI B450 TOMAHAWK MAX motherboard provides a stable foundation for this dynamic duo. With Corsair Vengeance LPX 16GB DDR4 RAM, the system handles multitasking effortlessly. Storage is both fast and spacious, thanks to the Kingston A2000 1TB NVMe PCIe M.2 SSD. The Corsair CV550 80+ Bronze PSU ensures reliable and efficient power delivery, completing this gaming rig with style and performance.</span>
            </div>
        </div>
        </form>
    </section>
