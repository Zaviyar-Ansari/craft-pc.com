...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 296; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/masterliquid-maker-240-600x600.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">masterliquid maker-240 </h3>
                <h2>PKR 56,699 </h2>
                ...
                <span> The Cooler Master MasterLiquid Maker 240 is a top-tier liquid cooling solution designed to keep your CPU running at optimal temperatures, especially during intense computing tasks and gaming. It features a dual-chamber pump for efficient cooling and a radiator with a sizeable surface area for effective heat dissipation. This cooler is also highly versatile, compatible with various CPU sockets, making it a fitting choice for a range of builds. The Maker 240 incorporates a sleek design and its customizable RGB lighting allows you to add a touch of personalization to your system. If you're seeking high-performance cooling with aesthetic flair, this liquid cooler is an excellent choice. </span>
