...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 244; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/All-Platform-Compatible-Tdp150W-RGB-Lighting-Effect-Gaming-Desktop-PC-Cooling.webp" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4">Segotep Bezer 12 Case Fan 120.. ARGB Lights </h3>
                <h2> PKR 7,366</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>Segotep Bezer 12 Case Fan 120.. ARGB Lights</u></b>
                </div>
                <span> The Segotep Bezer 12 Case Fan 120 with ARGB lights. This fan offers both style and functionality for your PC setup. With its 120mm size and ARGB lighting, it adds a vibrant and dynamic touch to your system. Designed to provide efficient cooling, it ensures optimal airflow to keep your components running smoothly. Upgrade your case cooling with the Segotep Bezer 12 and enjoy enhanced aesthetics and performance.</span>
            </div>
        </div>
    </form>
