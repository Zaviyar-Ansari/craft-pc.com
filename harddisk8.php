...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 200; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/f7db628c6e9338194cf72c5743d0d14e.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">Toshiba MQ01ABD Series 1TB</h3>
                <h2>PKR 8,348</h2>
                <input type="hidden" name="product_id" value="200"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>Toshiba MQ01ABD Series 1TB</u></b>
                </div>
                <span>The Toshiba MQ01ABD Series offers a 1TB storage capacity, providing ample space for storing various types of data such as documents, media files, and applications. With its compact size and efficient design, it's suitable for use in laptops, external enclosures, and other devices requiring reliable storage. This series is known for its consistent performance and durability, making it a trusted choice for everyday computing needs. Whether you're a student, professional, or casual user, the Toshiba MQ01ABD Series 1TB drive offers dependable storage at an affordable price point. Experience peace of mind with Toshiba's renowned quality and reliability in storage solutions.</span>
            </div>
        </div>
        </form>
    </section>
