...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 235; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/Untitled-design-1.png" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4"> Thermaltake Riing 12 LED RGB Radiator fan Sync Edition</h3>
                <h2>PKR 7,100 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>Thermaltake Riing 12 LED RGB Radiator fan Sync Edition</u></b>
                </div>
                <span>The Thermaltake Riing 12 LED RGB Radiator Fan Sync Edition – the perfect cooling solution to elevate your PC's performance and aesthetics. With its vibrant RGB lighting and sleek design, this fan adds a stylish touch to your system. Equipped with advanced LED technology, it offers customizable lighting effects to match your build's theme. Designed specifically for radiator use, it provides efficient heat dissipation to keep your components cool under pressure. Compatible with various setups and featuring synchronization capabilities, it allows for seamless integration with other RGB components. Upgrade your cooling system with the Thermaltake Riing 12 LED RGB Radiator Fan Sync Edition for enhanced performance and visual appeal.
