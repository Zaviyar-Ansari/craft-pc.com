...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 7; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg1/Gaming PCs - Gaming Desktops.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Zenith Zephyr</h3>
                <h2>PKR 140,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>CLX HORUS GAMING PC</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u> AMD Ryzen 5 3600</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GTX 1650 Super</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>MSI B450 Tomahawk Max</u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>8GB DDR4</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>500GB NVMe</u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Corsair CV550 (550W, 80+ Bronze)</u></b></h4>
                </div>
                <span>The CLX Horus Gaming PC boasts a formidable AMD Ryzen 5 3600 processor and NVIDIA GTX 1650 Super for immersive gaming experiences. Equipped with the reliable MSI B450 Tomahawk Max motherboard, it ensures stable performance. The 8GB DDR4 RAM provides decent multitasking capability, and the 500GB NVMe storage ensures fast data access. Powered by a Corsair CV550 (550W, 80+ Bronze) PSU, this system strikes a balance between performance and efficiency, making it a solid choice for gamers on a budget.</span>
