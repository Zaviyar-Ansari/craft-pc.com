...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 138; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/graphiccard/31d5b8987d05a33f233c981875ac3cbf.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Graphic Cards</h6>
                <h3 class="py-4">NVIDIA GT 710 Grpahic Card</h3>
                <h2>PKR 12,000</h2>
