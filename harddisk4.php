...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 196; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/7416787a1ac987dc46121db177508029.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">WD Black 4TB</h3>
                <h2>PKR 58,999</h2>
                <input type="hidden" name="product_id" value="196"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>WD Black 4TB</u></b>
                </div>
                <span>The WD Black 4TB is a high-capacity and high-performance hard disk drive designed for demanding computing tasks. With its spacious 4TB storage capacity, it offers ample space for storing large files, games, and multimedia content. Crafted by Western Digital, a trusted brand in storage solutions, it ensures reliability and durability for long-term use. Whether for gaming, content creation, or data-intensive applications, the WD Black 4TB HDD delivers exceptional performance and storage capabilities at a premium price.</span>
            </div>
        </div>
        </form>
    </section>
