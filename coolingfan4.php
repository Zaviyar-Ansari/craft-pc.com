...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 236; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/images (23).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4"> Thermaltake Riing 12 LED RGB Fan (3 fan pack)</h3>
                <h2> PKR 19,838</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>Thermaltake Riing 12 LED RGB Fan (3 fan pack)</u></b>
                </div>
                <span> The Thermaltake Riing 12 LED RGB Fan 3-Pack – the ultimate cooling solution for your PC setup. With three high-performance fans included, this pack offers optimal airflow to keep your components running smoothly. Each fan features vibrant RGB lighting, adding a stunning visual element to your build. The Riing 12 fans are designed for maximum cooling efficiency, ensuring your system stays cool even during intense gaming sessions or heavy workloads. Compatible with various setups and equipped with synchronization capabilities, these fans allow for seamless integration with other RGB components. Elevate your cooling setup with the Thermaltake Riing 12 LED RGB Fan 3-Pack and enjoy both performance and aesthetics in one package.
