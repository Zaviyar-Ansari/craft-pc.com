...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 239; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/images (22).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4"> NZXT ARE RGB</h3>
                <h2>PKR 19,838 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>NZXT ARE RGB</u></b>
                </div>
                <span> The NZXT ARE RGB Fan – a sleek and stylish cooling solution designed to enhance your PC build. With its vibrant RGB lighting, this fan adds a dynamic visual element to your setup. Engineered for efficient airflow, it helps keep your components cool during intense gaming sessions or demanding workloads. Compatible with various setups, the NZXT ARE RGB Fan offers versatility for different system configurations. Whether you're a gamer or a professional user, this fan delivers both performance and aesthetics to elevate your PC experience. Upgrade your cooling system with the NZXT ARE RGB Fan and enjoy enhanced airflow and stunning RGB lighting effects.</span>
            </div>
        </div>
    </form>
