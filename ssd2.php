...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 154; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ssd/3f7880f8ab21c9d757f8d8a353a6e100.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / SSD</h6>
                <h3 class="py-4">Lexar Pro NM800 SSD 1TB PCIe Gen4 NVMe M.2</h3>
                <h2>PKR 2,816,144</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Lexar Pro NM800 SSD 1TB PCIe Gen4 NVMe M.2</u></b></h4>
                </div>
                <span>
The Lexar Pro NM800 SSD offers blazing-fast storage performance with its PCIe Gen4 NVMe M.2 interface. With a spacious 1TB capacity, it provides ample room for your high-resolution media files, games, and applications. Designed for professionals and enthusiasts alike, this SSD delivers exceptional speed and responsiveness, making it ideal for demanding workloads and gaming sessions. Its advanced features, including advanced wear leveling, error correction, and thermal management, ensure reliability and longevity. Upgrade to the Lexar Pro NM800 for lightning-fast data transfer speeds and uncompromising performance for your computing needs.</span>
            </div>
        </div>
        </form>
    </section>
