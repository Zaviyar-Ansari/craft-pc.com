...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 258; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingsystem/images (31).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4">DIY Liquid Cooling</h3>
                <h2>PKR 30,474  </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/resized-images.png" alt=""> <b><u>DIY Liquid Cooling  </u></b>
                </div>
                <span>The DIY Liquid Cooling system. This water cooling solution offers efficient heat dissipation for your PC components. With its customizable configuration options, it provides flexibility to suit your build. The DIY Liquid Cooling system ensures optimal performance and reliability, even under heavy workloads. Upgrade your PC's cooling setup with this comprehensive solution for enhanced thermal management. </span>
            </div>
        </div>
    </form>
