...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 233; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/fan-pack-1.png" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4"> MSI MAX F12A-3 120mm ARGB</h3>
                <h2>PKR 15,134 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>MSI MAX F12A-3 120mm ARGB</u></b>
                </div>
                <span>The MSI MAX F12A-3 120mm ARGB Fan – a dynamic addition to your PC cooling setup. Featuring a sleek design and vibrant ARGB lighting, this fan not only keeps your system cool but also adds a touch of style. With a sizeable 120mm diameter, it provides ample airflow to effectively dissipate heat from your components. Equipped with ARGB lighting, it offers customizable illumination to match your build's aesthetic. Compatible with a variety of setups, including gaming rigs and workstations, it ensures reliable cooling performance. Upgrade your system's cooling with the MSI MAX F12A-3 120mm ARGB Fan and experience both style and functionality. </span>
            </div>
        </div>
    </form>
