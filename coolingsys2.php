...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 255; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingsystem/61nm2nZsccL._AC_UF894,1000_QL80_.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4">DIY Liquid Cooling System Pack</h3>
                <h2>PKR 19,530  </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/resized-images.png" alt=""> <b><u> DIY Liquid Cooling System Pack </u></b>
                </div>
                <span>The DIY Liquid Cooling System Pack provides an all-in-one solution to keep your PC running cool and efficient. With its water cooling system, you can effectively dissipate heat from your components, ensuring optimal performance even during intense tasks. This pack includes all necessary components and accessories for easy installation, making it suitable for both novice and experienced PC builders. Upgrade your cooling setup with the DIY Liquid Cooling System Pack and experience improved thermal management and quieter operation for your PC. </span>
            </div>
        </div>
    </form>
