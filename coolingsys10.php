...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 263; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingsystem/images (36).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                ...
                <span> The DIY PC Water Cooling Kit, priced at PKR 38,544. This kit provides a complete water cooling solution for your PC, ensuring efficient heat dissipation and optimal performance. With its easy-to-install components and comprehensive design, it offers convenience and reliability. Upgrade your PC's cooling system with this kit for improved thermal management and enhanced performance.</span>
            </div>
        </div>
    </form>
