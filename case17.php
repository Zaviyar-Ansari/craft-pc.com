...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 64; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/case/TORQUE BLACK _ WHITE is the Best Cheap Gaming PC Mid Tower Case in australia with E-ATX_Aluminum_USB 3_1 Type-C_Tempered Glass Side Panels - Antec.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Cases</h6>
                <h3 class="py-4">Antex TOEQUE White/Black Aluminum ATX Mid Tower</h3>
                <h2>PKR 121,047</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Antex TOEQUE White/Black Aluminum ATX Mid Tower</u></b>
                </div>
                <span>The Antec TORQUE White/Black Aluminum ATX Mid Tower is a stylish and high-quality computer case with a distinctive design. With its white and black aluminum construction, it offers a sleek and modern aesthetic. The mid-tower form factor strikes a balance between size and component support, making it suitable for building a powerful and visually appealing gaming or workstation PC.</span>
            </div>
        </div>
        </form>
    </section>
