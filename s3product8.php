...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 317; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg3/download.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">GeForce RTX 2080 super</h3>
                <h2>PKR 69,161</h2>
                <input type="hidden" name="product_id" value="317"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Details</h4>
                <span>The GeForce RTX 2080 Super is a high-end graphics card by NVIDIA, offering remarkable gaming performance and ray tracing capabilities. With 8GB of GDDR6 memory and a potent GPU, it handles the most demanding games with ease. It's a part of the RTX series, enabling real-time ray tracing and AI-powered features for incredible visual realism. The 2080 Super is highly popular among gamers and content creators, striking a balance between power and value. It's equipped with advanced cooling solutions, ensuring efficient and quiet operation during long gaming sessions. For those seeking top-tier gaming and graphics performance, the RTX 2080 Super is a formidable choice.
                </span>
            </div>
        </div>
        </form>
