...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 215; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/cpucooler/629c65c1c9fde98112d87cffc195d912.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4"> ATC700 CPU Air Cooler</h3>
                <h2>PKR 24,094 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/istockphoto-1373113476-612x612 (1).jpg" alt=""> <b><u> ATC700 CPU Air Cooler</u></b>
                </div>
                <span>The ATC700 CPU Air Cooler offers efficient cooling performance for your processor, keeping temperatures in check during demanding tasks and gaming sessions. Its robust design and advanced cooling technology ensure optimal heat dissipation, maintaining system stability under heavy loads. With its sleek and modern appearance, it adds a touch of style to your PC build. Upgrade your cooling solution with the ATC700 CPU Air Cooler for reliable performance and enhanced thermal management. </span>
            </div>
        </div>
    </form>
