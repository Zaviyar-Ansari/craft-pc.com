...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 54; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/case/Corsair Graphite Series 780T Full Tower PC Case - White (CC-9011059-WW).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Cases</h6>
                <h3 class="py-4">Graphite Series 780T white Full-Tower Case</h3>
                <h2>PKR 29,500</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Graphite Series 780T white Full-Tower Case</u></b>
                </div>
                <span>
                    The Graphite Series 780T White Full-Tower Case is a spacious and elegant computer chassis offering ample room for high-performance components. With its full-tower design, it provides excellent airflow and accommodates large cooling solutions. The white color adds a clean and stylish touch, making it an attractive choice for users seeking both functionality and aesthetics in their PC build.</span>
            </div>
        </div>
        </form>
    </section>
