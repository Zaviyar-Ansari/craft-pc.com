...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 289; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg/Gigabyte GeForce GTX 1080 Ti 11GB Gaming OC Black.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">Gigabyte GeForce GTX 1080 Ti 11GB</h3>
                <h2>PKR 129,999</h2>
                ...
                <span>The Gigabyte GeForce GTX 1080 Ti 11GB is a high-end graphics card that caters to the demands of gamers and professionals. With a massive 11GB of GDDR5X memory, it provides ample capacity for rendering complex graphics and running resource-intensive applications. This GPU is based on the powerful GTX 1080 Ti architecture, offering exceptional gaming performance and supporting 4K gaming with ease. Gigabyte's Windforce cooling system ensures efficient heat dissipation and quiet operation even during heavy loads. It also features customizable RGB lighting for added aesthetics. If you're seeking top-notch gaming and rendering performance, the GTX 1080 Ti 11GB is a strong contender.</span>
            </div>
        </div>
    </form>
    </section>
