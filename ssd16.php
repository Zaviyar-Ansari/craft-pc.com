...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 168; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ssd/acecd10f075c7de1dcdef3135d3fda4b.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / SSD</h6>
                <h3 class="py-4">Force Series Gen.4 PCIe MP600 1TB NVMe M.2 SSD</h3>
                <h2>PKR 34,900</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Force Series Gen.4 PCIe MP600 1TB NVMe M.2 SSD</u></b></h4>
                </div>
                <span>The Force Series Gen.4 PCIe MP600 1TB NVMe M.2 SSD is a high-performance storage solution designed to elevate your computing experience. With its PCIe Gen.4 interface and NVMe technology, it delivers lightning-fast data transfer speeds, ensuring seamless multitasking and quick access to your files. Boasting a spacious 1TB capacity, it provides ample storage space for your operating system, applications, games, and multimedia files. Its compact M.2 form factor makes it suitable for use in laptops, desktops, and small form factor systems. Upgrade to the Force Series MP600 SSD for reliable and efficient storage performance to meet your computing needs.</span>
            </div>
        </div>
        </form>
    </section>
