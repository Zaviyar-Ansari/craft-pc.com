...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 266; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingsystem/images (39).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4"> DIY Water Cooling System Pack</h3>
                <h2> PKR 28,999</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/resized-images.png" alt=""> <b><u> DIY Water Cooling System Pack </u></b>
                </div>
                <span> The DIY Water Cooling System Pack priced at PKR 28,999. This comprehensive pack offers an efficient water cooling solution for your PC, ensuring optimal performance and temperature regulation. With its easy installation process and inclusive components, it provides convenience and reliability. Upgrade your PC's cooling system with this pack for improved thermal efficiency and enhanced performance.</span>
            </div>
        </div>
    </form>
