...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 167; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ssd/a2afb1bae9b29062fa8cbab5f905242d.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / SSD</h6>
                <h3 class="py-4">Samsung 970 PRO NVMe M.2 SSD 512GB</h3>
                <h2>PKR 45,099</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Samsung 970 PRO NVMe M.2 SSD 512GB</u></b></h4>
                </div>
                <span>The Samsung 970 PRO NVMe M.2 SSD 512GB offers exceptional storage performance in a compact M.2 form factor. With its NVMe interface, it delivers blazing-fast data transfer speeds, significantly improving system responsiveness and reducing load times for applications and files. Boasting a generous 512GB capacity, it provides ample space for your operating system, games, multimedia files, and more. Designed for professionals and enthusiasts, this SSD features advanced V-NAND technology and dynamic thermal throttling for enhanced reliability and durability. Upgrade to the Samsung 970 PRO SSD for unparalleled speed and efficiency in your computing tasks.
</span>
            </div>
        </div>
        </form>
