...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 36; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/Predator Orion _ Predator _ Acer United States.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Aurora Pulse</h3>
                <h2>PKR 115,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Predator Orion case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u> Intel Core i5-10400F</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u> ASUS Dual GeForce GTX 1660 Super</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>MSI B460M PRO-VDH WIFI</u></b></h4>
                ...
                <span>The Predator Orion case shelters a potent gaming system featuring the Intel Core i5-10400F processor and ASUS Dual GeForce GTX 1660 Super for immersive gaming experiences. Supported by the MSI B460M PRO-VDH WIFI motherboard, it ensures stability and connectivity. With 16GB Corsair Vengeance LPX DDR4 RAM and a Kingston A2000 1TB NVMe PCIe M.2 SSD, multitasking and storage needs are met efficiently. The Corsair CV550 80+ Bronze PSU delivers reliable and efficient power. This setup creates a balanced gaming rig within the Predator Orion case, combining performance and style.</span>
            </div>
        </div>
        </form>
    </section>
