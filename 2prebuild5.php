...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 25; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/CiT Goblin Mesh Gaming Case Black_Green Interior USB3 12cm Green LED Toolless.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">UltimateWorkstation 5000 PKR 180,000</h3>
                <h2>PKR </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Spirit of Gamer X-Fighter 31 Green</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i7-12700K</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GeForce RTX 3070</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u> ASUS ROG Strix Z690-F Gaming WiFi</u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>32GB DDR4 (3200MHz)</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Samsung 970 EVO Plus 1TB NVMe</u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u> EVGA SuperNOVA 750 G5</u></b></h4>
                </div>
                <span>
                    The Spirit of Gamer X-Fighter 31 Green, armed with an Intel Core i7-12700K and NVIDIA GeForce RTX 3070, ensures high-end gaming performance. The ASUS ROG Strix Z690-F Gaming WiFi motherboard provides a feature-rich platform. Featuring 32GB of DDR4 RAM at 3200MHz, multitasking is seamless. Storage is handled by a Samsung 970 EVO Plus 1TB NVMe SSD, offering swift data access. The system is powered by the EVGA SuperNOVA 750 G5, a reliable 750W 80+ Gold power supply, ensuring stability for this potent configuration.</span>
            </div>
        </div>
        </form>
    </section>
