...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 6; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg1/Best Gaming PC.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Nebula Nova Elite</h3>
                <h2>PKR 160,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Dark Flash Knight</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>AMD Ryzen 5</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>GTX 1660 Super</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>Gigabyte B450M Ds3H</u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>lexar 16GB 3200MHZ</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Lexar 256 NVMe</u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Ease 550W 80+ Bronze</u></b></h4>
                </div>
                <span>The Dark Flash Knight featuring an AMD Ryzen 5 processor and GTX 1660 Super offers a balanced gaming experience. The Gigabyte B450M DS3H motherboard ensures stability, while Lexar's 16GB 3200MHz RAM enhances multitasking efficiency. With a Lexar 256GB NVMe for swift data access, this system strikes a good balance between performance and storage. The Ease 550W 80+ Bronze power supply ensures reliable energy delivery, making it a solid choice for mid-range gaming and productivity.</span>
