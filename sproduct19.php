...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 288; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg/Marken-SSD mit 1 TByte krass reduziert_ Warum nicht jeder hier zugreifen sollte.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">Marken-SSD mit 1 TByte</h3>
                <h2>PKR 45,377</h2>
                ...
                <span>A 1TB branded SSD (Solid State Drive) is a robust storage solution that provides ample capacity for various data storage needs. SSDs offer faster data access and transfer speeds compared to traditional HDDs, leading to quicker system responsiveness and application loading times. With 1TB of storage space, you can store a significant amount of data, including documents, multimedia files, and even games. Whether you're upgrading your laptop or desktop, this high-capacity SSD can significantly improve overall system performance and reduce load times, making it a reliable choice for those in need of speed and ample storage space.</span>
            </div>
        </div>
        </form>
    </section>
