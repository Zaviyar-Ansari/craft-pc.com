...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 59; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/case/Jonsbo Mod3 RGB Cristal Templado USB 3_0.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Cases</h6>
                <h3 class="py-4">Jonsbo MOD3 Big-Tower ShowCase Tempered Glass</h3>
                <h2>PKR 85,139</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Jonsbo MOD3 Big-Tower ShowCase Tempered Glass</u></b>
                </div>
                <span>The Jonsbo MOD3 Big-Tower Showcase with Tempered Glass is a large and visually striking computer case designed to display your components in style. With its big-tower form factor and tempered glass panels, it offers a clear view of the internal components. The showcase design is suitable for users who want to showcase their high-end hardware configurations with an emphasis on aesthetics.
                </span>
            </div>
        </div>
        </form>
