...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 228; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/cpucooler/images (16).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                ...
                <span>The Corsair H55 RGB 120mm Liquid CPU Cooler – a high-performance cooling solution designed to elevate your system's performance. Featuring a sleek design and vibrant RGB lighting, this cooler adds style to your setup while keeping your CPU cool under pressure. With its 120mm radiator and efficient pump design, it offers excellent heat dissipation for maximum performance. Equipped with a quiet fan, it ensures optimal airflow without compromising on noise levels. Compatible with various Intel and AMD sockets, it provides versatility for different system configurations. Upgrade your cooling system with the Corsair H55 RGB and experience enhanced performance and aesthetics for your gaming or productivity needs. </span>
            </div>
        </div>
    </form>
