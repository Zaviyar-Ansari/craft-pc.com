...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 222; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/cpucooler/cc7ed87fe88617e4a1e1619d876c41da.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4">Cooler MasterAir Maker 8 </h3>
                <h2> PKR 38,199 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/istockphoto-1373113476-612x612 (1).jpg" alt=""> <b><u>Cooler MasterAir Maker 8</u></b>
                </div>
                <span> The Cooler Master Air Maker 8 is a premium CPU cooler designed to deliver top-tier cooling performance for high-performance systems. Featuring a unique 3D Vapor Chamber base and an eight-heat pipe design, it efficiently dissipates heat from your processor, ensuring stable operation even during intense computing tasks or gaming sessions. The Air Maker 8 boasts a customizable LED lighting system, allowing you to personalize your PC build's aesthetics. With its robust construction and advanced cooling technologies, the Cooler Master Air Maker 8 is an excellent choice for enthusiasts seeking exceptional cooling performance and aesthetics.</span>
            </div>
        </div>
    </form>
