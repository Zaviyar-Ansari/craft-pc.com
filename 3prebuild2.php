...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 42; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg3/Thermaltake Versa N21 Black Edition Translucent Window Panel SPCC ATX Mid Tower Computer Chassis CA-1D9-00M1WN-00.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Zenith Horizon</h3>
                <h2>PKR 170,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Thermaltake Versa N21 Black Case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i5-11400 6-core</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GeForce GTX 1660 Super 6GB</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>ASUS Prime B560M-A Micro ATX </u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>Corsair Vengeance LPX 16GB DDR4</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Kingston A2000 500GB NVMe M.2</u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>EVGA 600 W1, 80+ WHITE 600W</u></b></h4>
                </div>
                <span>
                    The Thermaltake Versa N21 Black Case holds a powerful configuration featuring the Intel Core i5-11400 6-core processor and an NVIDIA GeForce GTX 1660 Super 6GB GPU for excellent gaming and productivity. Supported by the ASUS Prime B560M-A Micro ATX motherboard and Corsair Vengeance LPX 16GB DDR4 RAM, it ensures smooth multitasking. Swift data access is guaranteed by the Kingston A2000 500GB NVMe M.2 SSD. The system is powered by the EVGA 600 W1, 80+ WHITE 600W PSU, providing reliable and efficient power for a seamless computing experience.
