...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 110; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/images (10).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">Intel Xeon E Series </h3>
                <h2>PKR 168,430</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Xeon E Series</u></b></h4>
                </div>
                <span>The Intel Xeon E series consists of processors designed for professional and enterprise-level computing tasks. These CPUs are known for their reliability, stability, and performance in server environments. They are commonly used in workstations and servers, offering features such as ECC (Error-Correcting Code) memory support and enhanced security features. The specific details, including core count and clock speeds, can vary depending on the particular model within the Xeon E series.</span>
            </div>
        </div>
        </form?>
    </section>
