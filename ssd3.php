...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 155; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ssd/04d539030daef35ef77cfc44ee5dc1d6.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / SSD</h6>
                <h3 class="py-4">Corsair Force Series MP510 1920GB M.2 SSD</h3>
                <h2>PKR 32,382</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Corsair Force Series MP510 1920GB M.2 SSD</u></b></h4>
                </div>
                <span>The Corsair Force Series MP510 M.2 SSD offers high-performance storage with a massive 1920GB capacity. Utilizing the latest NVMe PCIe Gen3 x4 interface, it delivers rapid data transfer speeds for quick system boot-up, file transfers, and application loading. Ideal for gamers, content creators, and professionals, this SSD provides ample space for large files and demanding applications. Its robust design ensures reliability and durability, while advanced features like dynamic thermal throttling maintain optimal performance under heavy workloads. Upgrade your system with the Corsair Force Series MP510 for a seamless and responsive computing experience.</span>
            </div>
        </div>
        </form>
    </section>
