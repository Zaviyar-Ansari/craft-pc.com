...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 101; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/a72cec11bbca7d01a1656168a2bd545c.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">AMD Ryzen™ 9 5900X series</h3>
                <h2>PKR 96,363</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>AMD Ryzen™ 9 5900X series</u></b></h4>
                </div>
                <span>The AMD Ryzen 9 5000 series is a high-performance lineup featuring CPUs with 12 to 16 cores based on the Zen 3 architecture. Known for significant improvements in gaming and multi-threaded tasks, these processors offer top-tier performance for enthusiasts and professionals. With simultaneous multithreading (SMT) support and enhanced efficiency, they excel in gaming, content creation, and demanding applications. The Ryzen 9 5000 series showcases AMD's commitment to delivering exceptional desktop computing performance.                </span>
            </div>
        </div>
        </form?>
    </section>
