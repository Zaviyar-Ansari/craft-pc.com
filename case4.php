...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 52; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/case/c367f0a2-3c77-4d47-8257-8d2b92c2eb48.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Cases</h6>
                <h3 class="py-4">X2 SIRYUS</h3>
                <h2>73,655</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>X2 SIRYUS</u></b>
                </div>
                <span>The X2 SIRYUS case is a sleek and modern computer chassis designed to house your components efficiently. With its minimalist design, it offers a clean and professional aesthetic for your build. The case is equipped with features to support various configurations, providing a versatile platform for different PC setups.</span>
            </div>
        </div>
        </form>
    </section>
