...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 219; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/cpucooler/9c47195d65b628c9eb26e53dc3fc517c.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4"> Artic Freezer 34 eSport DUO|Tower CPU Cooler</h3>
                <h2>PKR 14,626 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/istockphoto-1373113476-612x612 (1).jpg" alt=""> <b><u> Artic Freezer 34 eSport DUO|Tower CPU Cooler</u></b>
                </div>
                <span>The Arctic Freezer 34 eSport DUO Tower CPU Cooler is designed to provide exceptional cooling performance for your PC. With its dual-fan configuration and tower design, it efficiently dissipates heat, keeping your CPU temperature in check even under heavy loads. The Freezer 34 eSport DUO ensures optimal airflow and low noise levels, making it an ideal choice for gamers and enthusiasts seeking reliable cooling solutions.
