...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 153; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ssd/0a6b2bbfd57762735a7474e7bb55cb95.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / SSD</h6>
                <h3 class="py-4">Crusial MX500 250GB SSD 2.5inch</h3>
                <h2>PKR 10,135</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Crusial MX500 250GB SSD 2.5inch</u></b></h4>
                </div>
                <span>The Crucial MX500 250GB SSD offers reliable and fast storage performance in a compact 2.5-inch form factor. With its SATA interface, it ensures seamless connectivity to your system, whether it's a laptop or desktop. Boasting a generous 250GB capacity, it provides ample space for your operating system, applications, and files, enhancing overall system responsiveness. Its advanced features, including AES 256-bit hardware encryption and integrated power loss immunity, ensure your data remains secure and protected. Upgrade to the MX500 SSD for improved speed, reliability, and peace of mind for your storage needs.
