...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 170; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ssd/d79a51296f840f3965d977e3a850a20f.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / SSD</h6>
                <h3 class="py-4">WD Blue SATA SSD M.2 2280 PC SSD 1TB</h3>
                <h2>PKR 21,118</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>WD Blue SATA SSD M.2 2280 PC SSD 1TB</u></b></h4>
                </div>
                <span>
The WD Blue SATA SSD M.2 2280 PC SSD 1TB offers reliable and efficient storage performance in a compact M.2 form factor. With its SATA interface, it ensures seamless connectivity to your desktop or laptop, making it an ideal choice for system upgrades. Boasting a spacious 1TB capacity, it provides ample space for your operating system, applications, games, and multimedia files. This SSD enhances overall system responsiveness and reduces load times for faster computing experiences. Upgrade to the WD Blue SATA SSD for improved speed, reliability, and efficiency in your computing tasks.</span>
            </div>
        </div>
        </form>
    </section>
