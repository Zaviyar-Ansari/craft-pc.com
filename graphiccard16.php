...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 148; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/graphiccard/d8abeb9a719b627191eda6d194b06b0c.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Graphic Cards</h6>
                <h3 class="py-4">PULSE AMD Radeon RX 6600</h3>
                <h2>PKR 62,719</h2>
