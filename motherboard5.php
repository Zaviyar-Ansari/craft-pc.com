...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 77; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/motherboard/288a76fc09368c8caacbc6a836a734d0.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Motherboards</h6>
                <h3 class="py-4">GIGABYTE Z370 AORUS Gaming 5</h3>
                <h2>PKR 93,029</h2>
                ...
                <div class="icon">
                    <h4> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>GIGABYTE Z370 AORUS Gaming 5</u></b>
                </div>
                <span>
                    The GIGABYTE Z370 AORUS Gaming 5 is a gaming-centric motherboard built on the Intel Z370 chipset. Designed for 8th and 9th generation Intel Core processors, it delivers excellent gaming performance. Featuring RGB Fusion lighting, Smart Fan 5 technology, and advanced audio solutions, it caters to gamers seeking both style and functionality. With multi-GPU support and robust power delivery, it's a solid choice for enthusiasts looking to build a high-performance gaming rig.</span>
            </div>
        </div>
        </form>
    </section>
