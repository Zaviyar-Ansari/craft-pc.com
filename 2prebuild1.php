...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 21; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/3e0116f6-a546-4c2f-9f2e-0398e0170580.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Speed Demon XT</h3>
                <h2>PKR 90,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>MSI Meg Aegis Ti5</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i5-11400</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>AMD Radeon RX 5600 XT</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>ASUS Prime B560M-A Micro ATX</u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>Corsiar 16GB DDR4</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Kingstone 1Tb NVMe SSD</u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u> Corsair CV550 550W 80+ Bronze</u></b></h4>
                </div>
                <span>The MSI Meg Aegis Ti5 features an Intel Core i5-11400 CPU and AMD Radeon RX 5600 XT GPU for robust performance. Paired with an ASUS Prime B560M-A Micro ATX motherboard, it provides a compact yet powerful setup. Corsair's 16GB DDR4 RAM ensures smooth multitasking, and the Kingstone 1TB NVMe SSD offers fast storage. The system is powered by a reliable Corsair CV550 550W 80+ Bronze PSU, delivering ample power for this configuration.</span>
            </div>
        </div>
    </form>
    </section>
