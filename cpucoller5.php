...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 217; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/cpucooler/7cf8c40de49522b853519e320fc16bbf.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4"> ID-COOLING SE-914-XT Black/White Cooler 131mm</h3>
                <h2>PKR 9,975 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/istockphoto-1373113476-612x612 (1).jpg" alt=""> <b><u> ID-COOLING SE-914-XT Black/White Cooler 131mm</u></b>
                </div>
                <span> The ID-COOLING SE-914-XT Black/White Cooler stands out with its sleek design and efficient cooling capabilities. Measuring 131mm in height, it provides ample clearance for most PC builds while delivering excellent heat dissipation for your CPU. The black and white color scheme adds a stylish touch to your system. With its reliable performance and affordable price, the SE-914-XT is a great choice for users seeking effective CPU cooling without breaking the bank.
