...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 238; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/images (26).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4">MSI Rainbow Fan Pack </h3>
                <h2> PKR 64,089</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>MSI Rainbow Fan Pack</u></b>
                </div>
                <span>The MSI Rainbow Fan Pack – a comprehensive cooling solution to elevate your PC setup. This pack includes multiple high-performance fans equipped with vibrant RGB lighting, creating a mesmerizing rainbow effect. Engineered for optimal airflow and heat dissipation, these fans ensure efficient cooling for your components, even under heavy workloads. With synchronization capabilities, they seamlessly integrate with other RGB components, allowing you to customize your build's lighting scheme. Whether you're a gamer or a content creator, the MSI Rainbow Fan Pack offers both style and performance to enhance your computing experience. Upgrade your cooling system with this premium fan pack and enjoy a visually stunning and efficiently cooled PC setup. </span>
            </div>
        </div>
    </form>
