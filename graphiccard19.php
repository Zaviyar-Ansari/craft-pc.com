...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 151; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/graphiccard/f228439516f73579e191be51319203ef.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Graphic Cards</h6>
                <h3 class="py-4">EVGA GeForce GTX 1080 Ti SC Hydro Copper</h3>
                <h2>PKR 140,761</h2>
