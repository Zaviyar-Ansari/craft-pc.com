...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id =9; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg1/960x0.webp" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">NZXT H9 Elite</h3>
                <h2>PKR 340,716</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>NZXT H9 Elite</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u> AMD Ryzen 7 3700X</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GeForce RTX 3060 </u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u> MSI B550 Gaming Edge</u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u> Corsair Vengeance LPX 32GB DDR4</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u> Samsung 970 500GB NVMe + Seagate 2TB HDD</u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u> EVGA SuperNOVA 650 G5</u></b></h4>
                </div>
                <span>
                    The NZXT H9 Elite houses a robust gaming setup featuring the AMD Ryzen 7 3700X processor and the potent NVIDIA GeForce RTX 3060 GPU for immersive gaming experiences. The MSI B550 Gaming Edge ensures stability and efficient system management. With Corsair Vengeance LPX 32GB DDR4 RAM, multitasking is a breeze, while the combination of a Samsung 970 500GB NVMe SSD and Seagate 2TB HDD offers both speed and ample storage. The EVGA SuperNOVA 650 G5 power supply ensures reliable and efficient power delivery, making this PC configuration a powerhouse for gaming and content creation.</span>
