...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 137; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/graphiccard/0d6d8cdcc6da2bfee711c55056b49cbc.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Graphic Cards</h6>
                <h3 class="py-4">Sapphire VAPOR-X AMD Radeon R9 290 TRI-X OC</h3>
                <h2>PKR 134,954</h2>
