...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 294; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/MAINGEAR F131.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">MAINGEAR F131 Case </h3>
                <h2>PKR 28,667</h2>
                ...
                <span>The MAINGEAR F131 case is a premium chassis designed for discerning PC enthusiasts and gamers. With its sleek and modern design, it not only provides a stylish home for your components but also offers exceptional functionality. This case supports high-end hardware configurations and efficient cooling solutions, ensuring that your system runs smoothly even under heavy loads. MAINGEAR is renowned for its meticulous attention to detail and build quality, making the F131 a top choice for those who demand both performance and aesthetics in their PC builds. Whether you're assembling a high-performance gaming rig or a powerful workstation, the MAINGEAR F131 case is a top-tier option.</span>
