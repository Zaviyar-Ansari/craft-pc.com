...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 186; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/powersupply/97287016cd4ad5ea2892ea78feca0b01.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Powersupply</h6>
                <h3 class="py-4"> EVGA SuperNOVA 750 G5</h3>
                <h2>PKR 34,209</h2>
                ...
                <span>The EVGA SuperNOVA 750 G5 is a high-quality power supply unit designed to meet the demands of modern computing. With its 750-watt capacity, it provides ample power for a variety of PC configurations. Engineered for efficiency and reliability, it ensures stable power delivery to your components. Crafted by EVGA, a trusted brand in PC hardware, it guarantees performance and durability. Elevate your PC's power supply with the EVGA SuperNOVA 750 G5 for reliable operation and peace of mind. </span>
            </div>
        </div>
        </form?>
    </section>
