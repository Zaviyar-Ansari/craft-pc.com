...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 224; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/cpucooler/deepcool-ak400-cooler-price-in-pakistan-4-19643-838230-190923051634788.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4">DeepCool AK400 </h3>
                <h2> PKR 9,975</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/istockphoto-1373113476-612x612 (1).jpg" alt=""> <b><u> DeepCool AK400</u></b>
                </div>
                <span>The DeepCool AK400 CPU Air Cooler – an affordable yet effective solution for keeping your processor cool under pressure. Designed with a streamlined black exterior, it adds a touch of style to your system without breaking the bank. Equipped with four heat pipes and an optimized fin design, it efficiently dissipates heat for reliable performance. Compatible with a variety of Intel and AMD sockets, it offers versatility for different setups. Whether you're gaming or tackling demanding tasks, the AK400 ensures your CPU stays cool and responsive. Upgrade your cooling solution with the DeepCool AK400 and experience enhanced performance without compromising your budget. </span>
            </div>
        </div>
    </form>
