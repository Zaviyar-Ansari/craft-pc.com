...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 71; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="mainprodimg/pordimg3.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Featured Products</h6>
                <h3 class="py-4">EVGA GeForce GTX TITAN 2</h3>
                <h2>PKR 17,699</h2>
                <input type="hidden" name="product_id" value="71"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Details</h4>
                <span>The EVGA GeForce GTX TITAN 2 is a high-end graphics card engineered for gamers and professionals who demand exceptional performance. With cutting-edge GPU technology and a substantial VRAM capacity, this card excels at handling the most demanding games and content creation tasks. It supports real-time ray tracing, delivering stunning visuals and realism. EVGA is known for its high-quality build and cooling solutions, ensuring efficient and quiet operation even under heavy workloads. If you're a serious gamer or content creator seeking the best in graphics performance, the GTX TITAN 2 is a formidable choice that guarantees top-tier performance and visuals.</span>
            </div>
        </div>
        </form>
    </section>
