...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 278; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg/[M] G_SKILL TridentZ 32GB 3200MHz DDR4 (F4-3200C15D-32GTZ) Memory Kit Review.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">G.SKILL TridentZ 32GB 3200MHz DDR4</h3>
                <h2>PKR 13,990</h2>
                ...
                <span>The G.SKILL TridentZ 32GB 3200MHz DDR4 is a high-performance memory kit known for its speed and reliability. This 32GB (2x16GB) dual-channel kit is designed for enthusiasts and content creators seeking seamless multitasking. Operating at 3200MHz, it offers a balance of speed and stability for various tasks, including gaming and content rendering. The TridentZ series features a sleek, stylish design with an aluminum heatspreader and customizable RGB lighting, enhancing the aesthetics of your system. It is compatible with Intel and AMD platforms, making it a versatile choice for a wide range of PC builds. G.SKILL is recognized for its quality, and the TridentZ series is a popular option for those seeking high-capacity, high-speed RAM modules.</span>
            </div>
        </div>
        </form>
    </section>
