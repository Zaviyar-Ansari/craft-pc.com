...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 202; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/images (4).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">WD Blue SATA Hard Disk 2TB</h3>
                <h2>PKR 13,999</h2>
                <input type="hidden" name="product_id" value="202"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>WD Blue SATA Hard Disk 4TB</u></b>
                </div>
                <span>The WD Blue SATA Hard Disk with 2TB of storage capacity provides ample space for storing your files, documents, photos, videos, and more. With reliable SATA interface connectivity, it ensures fast data transfer speeds for efficient performance. Designed for durability and longevity, this hard disk is ideal for everyday computing tasks, including multimedia storage, gaming, and general use. Its WD Blue branding signifies quality and reliability, making it a trusted choice for expanding your storage needs without breaking the bank. Upgrade your storage solution with the WD Blue SATA Hard Disk for dependable performance and ample capacity.
