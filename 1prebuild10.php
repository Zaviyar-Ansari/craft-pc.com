...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 10; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg1/Desktops by Digital Storm.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Phoenix Horizon VR</h3>
                <h2>PKR 170,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Digital Strom BOLT X </u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>AMD Ryzen 5 5600X </u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GTX 1660 Super </u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>  MSI B450 Tomahawk Max</u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>Corsair Vengeance LPX 16GB DDR4</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Kingston A2000 500GB NVMe SSD </u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>  Cooler Master MWE 650W</u></b></h4>
                </div>
                <span>
                    The Digital Storm BOLT X features an AMD Ryzen 5 5600X processor and NVIDIA GTX 1660 Super, delivering powerful gaming performance. The MSI B450 Tomahawk Max motherboard ensures stability and efficient system management. With Corsair Vengeance LPX 16GB DDR4 RAM, multitasking is seamless, complemented by a speedy Kingston A2000 500GB NVMe SSD for fast data access. The Cooler Master MWE 650W power supply ensures reliable energy delivery. Encased in a sleek design, this PC is a balanced gaming rig for an immersive computing experience.</span>
