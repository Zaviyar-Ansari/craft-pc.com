...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 248; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/images (24).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4">EK-Loop Fan FPT 140 D-RGB White</h3>
                <h2> PKR 5,630</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>EK-Loop Fan FPT 140 D-RGB White</u></b>
                </div>
                <span>The EK-Loop Fan FPT 140 D-RGB White – a premium cooling solution designed to elevate your PC's performance and aesthetics. With its sleek white design and dynamic RGB lighting, this fan adds a touch of style to your build. Engineered for efficient airflow and heat dissipation, it ensures optimal cooling performance for your components, even under heavy workloads. The EK-Loop Fan FPT 140 D-RGB White is compatible with various setups and offers easy installation, making it suitable for both novice and experienced builders alike. Upgrade your cooling system with this high-quality fan and enjoy improved performance and visual appeal. </span>
            </div>
        </div>
    </form>
