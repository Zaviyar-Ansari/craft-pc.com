...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 159; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ssd/86f19eb0d1e3995d0147ef4f7aa3d82a.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / SSD</h6>
                <h3 class="py-4">Super Talent DX3 M.2 SSD 240GB</h3>
                <h2>PKR 6,195</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Super Talent DX3 M.2 SSD 240GB</u></b></h4>
                </div>
                <span>
The Super Talent DX3 M.2 SSD 240GB offers reliable and efficient storage in a compact form factor. With its M.2 interface, it delivers fast data transfer speeds, ensuring smooth system performance and quick access to your files. Boasting a capacity of 240GB, it provides sufficient space for your operating system, applications, and essential data. Ideal for upgrading laptops or desktops, this SSD offers enhanced responsiveness and improved overall system efficiency. Upgrade to the Super Talent DX3 M.2 SSD for a reliable and cost-effective storage solution to meet your computing needs.</span>
            </div>
        </div>
        </form>
    </section>
