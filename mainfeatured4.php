...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 72; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="mainprodimg/pordimg4.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Featured Products</h6>
                <h3 class="py-4">MSI A320M-A PRO</h3>
                <h2>PKR 15,500</h2>
                <input type="hidden" name="product_id" value="72"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Details</h4>
                <span>The MSI A320M-A PRO is an entry-level micro-ATX motherboard designed for cost-effective PC builds. It supports AMD Ryzen processors, offering a budget-friendly platform for everyday computing and light gaming. While it lacks some of the advanced features of higher-end motherboards, it provides essential connectivity options and reliability for basic computing needs. The A320M-A PRO is compact, making it suitable for smaller PC cases, and it includes an M.2 slot for faster storage options. Overall, this motherboard is an excellent choice for those on a budget or building a simple, no-frills PC.</span>
            </div>
        </div>
        </form>
    </section>
