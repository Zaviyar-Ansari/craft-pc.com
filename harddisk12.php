...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 204; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/images (1).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">PC Hard Drive 3TB</h3>
                <h2>PKR 26,725</h2>
                <input type="hidden" name="product_id" value="204"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>PC Hard Drive 3TB</u></b>
                </div>
                <span>The PC Hard Drive, a reliable storage solution offering a spacious 3TB capacity to accommodate all your digital needs. Perfect for storing a multitude of files, from documents to multimedia content, this hard drive ensures ample space for your data. Engineered for compatibility with desktop systems, it seamlessly integrates into your setup, providing reliable performance for everyday computing tasks. Whether you're a professional requiring extensive storage or a home user seeking to expand your digital library, the PC Hard Drive delivers dependable storage at an accessible price point. Upgrade your storage capabilities effortlessly with the PC Hard Drive and unlock a world of possibilities for your computing experience.
</span>
            </div>
        </div>
        </form>
