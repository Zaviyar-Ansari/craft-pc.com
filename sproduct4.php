...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 272; // Set the product ID to 3
        ...
        <form action="#" method="post">
            <div class="row mt-5">
                <div class="col-lg-5 col-md-12 col-12">
                    <img class="img-fluid w-100 pb-1" src="shopprodimg/MSI GeForce GTX 1070 8GB Armor OC.jpeg" id="MainImg" alt="">
                </div>
                <div class="col-lg-6 col-md-12 col-12">
                    <h6> Home / Shop / Featured Products</h6>
                    <h3 class="py-4">MSI GeForce GTX 1070 8GB</h3>
                    <h2>PKR 277,399</h2>
                    ...
                    <span>The MSI GeForce GTX 1070 is a graphics card renowned for its 8GB of GDDR5 memory, making it a powerhouse for gaming and content creation. Built on NVIDIA's Pascal architecture, it boasts 1920 CUDA cores and a base clock of 1506 MHz, ensuring high-performance capabilities. The card offers support for VR gaming and can handle demanding titles with ease. It features multiple display outputs, making it suitable for multi-monitor setups. The MSI version typically includes enhanced cooling solutions and customizable RGB lighting, making it a popular choice among gamers and enthusiasts for its reliability and performance.</span>
                </div>
            </div>
            </form>
        </section>
