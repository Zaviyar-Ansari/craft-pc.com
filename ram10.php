...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 122; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ram/a3c9880046febdb42748879becd68b39.jpg"" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / RAM</h6>
                <h3 class="py-4">HyperX Beast 16GB DDR3</h3>
                <h2>PKR 22,777</h2>
