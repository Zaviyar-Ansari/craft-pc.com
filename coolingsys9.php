...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 262; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingsystem/images (35).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4">DIY PC Water Cooling Kit </h3>
                <h2>PKR 34,566 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/resized-images.png" alt=""> <b><u> DIY PC Water Cooling Kit</u></b>
                </div>
                <span>The DIY PC Water Cooling Kit priced at PKR 34,566. This comprehensive kit offers an efficient water cooling solution for your PC, ensuring optimal performance and temperature control. With easy installation and a range of components included, it provides convenience and reliability. Upgrade your PC's cooling system with this kit for improved thermal efficiency and enhanced performance. </span>
            </div>
        </div>
    </form>
