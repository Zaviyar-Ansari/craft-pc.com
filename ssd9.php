...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 161; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ssd/5311d82d9635d747afdb4b21148963a9.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / SSD</h6>
                <h3 class="py-4">Samsung 980 SSD 1TB PCIe 3.0x4 NVMe M.2 2280</h3>
                <h2>PKR 19,679</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Samsung 980 SSD 1TB PCIe 3.0x4 NVMe M.2 2280</u></b></h4>
                </div>
                <span>The Samsung 980 SSD 1TB PCIe 3.0x4 NVMe M.2 2280 is a high-performance storage solution designed to boost your system's speed and efficiency. With its PCIe 3.0x4 interface and NVMe technology, it offers rapid data transfer speeds, ensuring smooth multitasking and quick access to your files. Boasting a generous 1TB capacity, it provides ample space for your operating system, applications, and multimedia files. Its compact M.2 2280 form factor makes it ideal for use in laptops, desktops, and small form factor systems. Upgrade to the Samsung 980 SSD for reliable and lightning-fast storage performance to meet your computing needs.</span>
            </div>
        </div>
        </form>
    </section>
