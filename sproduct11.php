...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 280; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg/Power supply unit (PSU) computer Aigo AK600 W.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">Aigo AK600-W Power Unit</h3>
                <h2>PKR 8,670</h2>
                ...
                <span>The Aigo AK600-W Power Unit is an essential component for reliable computer operation. With its robust design and high-quality construction, it ensures a stable and efficient power supply to your system. Boasting a range of safety features, this PSU offers protection against voltage fluctuations and short circuits. It is an ideal choice for both gaming rigs and workstations, thanks to its versatility and performance. The Aigo AK600-W Power Unit is an excellent option for anyone seeking a dependable and consistent power source for their computer setup.</span>
            </div>
        </div>
        </form>
    </section>
