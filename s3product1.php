...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 310; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg3/CiT F3 Micro-ATX PC Gaming Case, MATX & ITX Motherboard Support, Windowed Side Panel, SD_TF Card Reader Built-In, 2 x 120mm Purple LED Fans Included _ Black _ Purple Stripe.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">CiT F3 Micro-ATX PC Gaming Case</h3>
                <h2>PKR 13,371</h2>
                <input type="hidden" name="product_id" value="310"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Details</h4>
                <span>The CiT F3 Micro-ATX PC Gaming Case is a budget-friendly option for gamers looking to build a compact yet powerful gaming rig. This case is designed to accommodate Micro-ATX motherboards, making it suitable for smaller setups. It features a stylish design with a transparent side panel, allowing you to showcase your components. The F3 case includes support for multiple cooling fans and has a front panel with USB ports for convenience. While it may not offer the most premium features, the CiT F3 is a practical choice for gamers on a budget who want a compact and visually appealing case for their gaming PC.</span>
            </div>
        </div>
        </form>
    </section>
