...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 267; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingsystem/images (40).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4"> Fursuit Liquid Cooling System </h3>
                <h2> PKR 54,675</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/resized-images.png" alt=""> <b><u>Fursuit Liquid Cooling System</u></b>
                </div>
                <span>The Fursuit Liquid Cooling System priced at PKR 54,675. This advanced water cooling system is specifically designed for fursuits, offering efficient heat dissipation to keep performers comfortable during extended use. With its high-quality components and reliable performance, it ensures optimal temperature regulation for both the wearer and the electronics integrated into the suit. The Fursuit Liquid Cooling System is easy to install and provides customizable features for personalized comfort. Upgrade your fursuit with this innovative cooling solution for enhanced performance and extended wearability. </span>
            </div>
        </div>
    </form>
