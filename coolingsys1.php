...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 254; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingsystem/download.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4">DIY Liquid Cooler120/240/360</h3>
                <h2> PKR 13,168 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/resized-images.png" alt=""> <b><u> DIY Liquid Cooler120/240/360 </u></b>
                </div>
                <span>The DIY Liquid Cooler is available in 120mm, 240mm, and 360mm configurations. This liquid cooling solution offers efficient heat dissipation for your CPU, ensuring optimal performance even during intense tasks. With customizable configuration options, you can choose the size that best fits your PC build. Experience quieter operation and improved cooling performance compared to traditional air coolers. Upgrade your cooling system with the DIY Liquid Cooler and enjoy enhanced thermal management for your computer. </span>
            </div>
        </div>
    </form>
