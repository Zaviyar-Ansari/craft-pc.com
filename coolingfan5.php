...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 237; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/Thermaltake-Pure-Plus-12-RGB-Software-Enabled-Case-Fan-Three-Pack-120mm_6d655199-6732-45ac-8691-52035af67ed4_1.cb063094a24b5e1b4f9509261f60680a.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4">Thermaltake Pure Plus 12 RGB Radiator Fan TT Premium Edition</h3>
                <h2> PKR 15,586 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>Thermaltake Pure Plus 12 RGB Radiator Fan TT Premium Edition</u></b>
                </div>
                <span> The Thermaltake Pure Plus 12 RGB Radiator Fan TT Premium Edition – a premium cooling solution designed to enhance both performance and aesthetics in your PC build. Featuring vibrant RGB lighting and a sleek design, these fans add a touch of style to your setup. With advanced LED technology, you can customize the lighting effects to match your build's theme. Specifically engineered for radiator use, these fans deliver efficient heat dissipation to keep your components cool under pressure. Compatible with various setups and equipped with synchronization capabilities, they seamlessly integrate with other RGB components for a cohesive look. Elevate your cooling system with the Thermaltake Pure Plus 12 RGB Radiator Fan TT Premium Edition and experience superior performance and visual appeal.
