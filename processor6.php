...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 98; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/320df5c3540aec0eed0f714fd8e2b35a.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">Intel Core i7-10700K</h3>
                <h2>PKR 76,877</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i7-10700K</u></b></h4>
                </div>
                <span>
                    The Intel Core i7-10700K is a high-performance processor from the 10th generation Intel Core series. Featuring 8 cores and 16 threads, it has a base clock speed of 3.8 GHz and a maximum turbo frequency of 5.1 GHz. Utilizing the LGA 1200 socket and built on the Comet Lake architecture, it delivers strong multi-threaded and single-threaded performance. The processor is well-suited for gaming, content creation, and other demanding tasks. Known for its overclocking capabilities, the i7-10700K is a popular choice among enthusiasts building high-end desktop systems. Specific details may vary based on regional availability and exact SKU.</span>
            </div>
        </div>
        </form?>
    </section>
