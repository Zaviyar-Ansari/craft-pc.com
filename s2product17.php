...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 306; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/Coolermaster V850 Sfx Gold White Edition 80 Plus Full Modular Sfx Power Supply.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">Coolermaster V850 Sfx Gold White Edition 80 Power Unit </h3>
                <h2>PKR 33,196</h2>
                ...
                <span>The Coolermaster V850 SFX Gold White Edition 80 Power Unit is a high-quality power supply designed for compact PC builds. With an 80 PLUS Gold certification, it ensures efficiency and reliable power delivery. Its compact SFX form factor makes it suitable for small form factor cases without compromising on performance. The striking white design adds a touch of style to your build, and it's fully modular, allowing for clean cable management. The V850 is equipped with all the necessary protections to safeguard your components. Whether you're building a compact gaming rig or a space-efficient workstation, this power unit is a dependable choice for powering your system.</span>
            </div>
        </div>
        </form>
    </section>
