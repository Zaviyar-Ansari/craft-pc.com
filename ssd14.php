...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 166; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ssd/612179742fb138fb76430ea4f528b4fa.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / SSD</h6>
                <h3 class="py-4">ADATA Premier Pro SP900 128GB 2.5 inch SATA</h3>
                <h2>PKR 65,196</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>ADATA Premier Pro SP900 128GB 2.5 inch SATA</u></b></h4>
                </div>
                <span>
The ADATA Premier Pro SP900 128GB 2.5-inch SATA SSD offers reliable and efficient storage performance in a compact form factor. With its SATA interface, it ensures seamless connectivity to your desktop or laptop, making it an ideal choice for system upgrades. Boasting a capacity of 128GB, it provides ample space for your operating system, applications, and essential files. This SSD enhances overall system responsiveness and reduces load times for faster computing experiences. Upgrade to the ADATA Premier Pro SP900 SSD for improved speed, reliability, and efficiency in your computing tasks.
