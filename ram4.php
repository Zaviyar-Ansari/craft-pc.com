...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 116; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ram/2e133aa9170100d2bbe42e474b43c504.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / RAM</h6>
                <h3 class="py-4">Kingston FURY Beast DDR5</h3>
                <h2>PKR 33,562 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>Kingston FURY Beast DDR5</u></b></h4>
                </div>
                <span>The Kingston FURY Beast DDR5 RAM introduces a new level of performance to your system. With the transition to DDR5 technology, this memory module offers improved data transfer rates and enhanced efficiency. The FURY Beast series from Kingston is known for its reliability and durability, ensuring a stable and responsive experience for users engaging in demanding tasks such as gaming or content creation. The cutting-edge DDR5 technology in Kingston FURY Beast brings a significant upgrade, making it a worthy choice for those seeking the latest advancements in memory performance for their systems.</span>
