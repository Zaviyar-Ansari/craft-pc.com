...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 226; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/cpucooler/f68688cd326ea83a79110751a20aca72.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4"> Cpu Cooler 4 Cobre Heatpipe Cooling Fan</h3>
                <h2> PKR 7,697</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/istockphoto-1373113476-612x612 (1).jpg" alt=""> <b><u> Cpu Cooler 4 Cobre Heatpipe Cooling Fan</u></b>
                </div>
                <span> The CPU Cooler with 4 Copper Heatpipes and Cooling Fan – a cost-effective solution for keeping your processor cool and efficient. Designed with four copper heatpipes, this cooler efficiently transfers heat away from your CPU for optimal performance. Equipped with a powerful cooling fan, it ensures consistent airflow to prevent overheating during intense tasks. Its compact design makes it suitable for various PC builds without sacrificing space. Compatible with a range of Intel and AMD sockets, it offers versatility for different system configurations. Upgrade your cooling system with this affordable yet reliable CPU cooler for improved performance and longevity.</span>
            </div>
        </div>
    </form>
