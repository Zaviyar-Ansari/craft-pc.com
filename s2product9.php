...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 298; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/Best Buy_ CLX Gaming Desktop Intel Core i7-8700K 16GB Memory NVIDIA GeForce RTX 2080 Ti 3TB HDD + 480GB SSD White_Blue TGMSETRTH8913WU.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">CLX Gaming Desktop Case </h3>
                <h2>PKR 15,215</h2>
                ...
                <span> The CLX Gaming Desktop is a formidable gaming system designed for enthusiasts who crave top-tier performance and aesthetics. These pre-built PCs are known for their powerful hardware configurations, delivering exceptional gaming and multitasking capabilities. They often feature high-end graphics cards, fast processors, and ample RAM to handle the most demanding titles and applications. CLX systems are renowned for their unique and customizable designs, allowing gamers to express their individuality with striking RGB lighting and custom components. Whether you're a competitive gamer or a content creator, a CLX Gaming Desktop offers an all-in-one solution that combines style and performance, making it a compelling choice for PC gaming enthusiasts. </span>
