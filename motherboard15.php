...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 86; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/motherboard/ecc3e77c8eb05b002ec5d0f67301e855.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Motherboards</h6>
                <h3 class="py-4">ASUS Prime Z390-A Motherboard LGA1151</h3>
                <h2>PKR 57,953</h2>
                ...
                <div class="icon">
                    <h4> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>ASUS Prime Z390-A Motherboard LGA1151</u></b>
                </div>
                <span>The ASUS Prime Z390-A Motherboard is designed for 8th and 9th generation Intel Core processors, utilizing the LGA1151 socket. Built on the Intel Z390 chipset, it offers a robust feature set for gaming and productivity. With an ATX form factor, it provides multiple PCIe slots, DDR4 memory support, and comprehensive connectivity options. ASUS OptiMem technology enhances memory stability, and the motherboard includes ASUS 5-Way Optimization for easy system tuning. It's a reliable choice for users looking to build a versatile and high-performance desktop system.
</span>
            </div>
        </div>
        </form>
