...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 164; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ssd/789104b4d1de184a0004d250e460b6e2.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / SSD</h6>
                <h3 class="py-4">KingSPec N80-120GB SSD M.2 NGFF</h3>
                <h2>PKR 21,121</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>KingSPec N80-120GB SSD M.2 NGFF</u></b></h4>
                </div>
                <span>
The KingSpec N80-120GB SSD M.2 NGFF offers a compact and efficient storage solution for your computing needs. With its M.2 NGFF form factor, it provides seamless integration into laptops, ultrabooks, and small form factor systems. Boasting a 120GB capacity, it offers sufficient space for your operating system, essential applications, and documents. Despite its small size, this SSD delivers reliable performance, ensuring smooth system operation and quick access to your files. Upgrade to the KingSpec N80 SSD for improved speed and efficiency in your daily computing tasks.</span>
            </div>
        </div>
        </form>
    </section>
