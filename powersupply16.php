...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 188; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/powersupply/b820bb40db73c1b439bfae704301b51a.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Powersupply</h6>
                <h3 class="py-4"> MSI MPG A850GF</h3>
                <h2>PKR 38,557</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u> MSI MPG A850GF</u></b></h4>
                </div>
                <span> The MSI MPG A850GF is a high-quality power supply unit designed to meet the demands of modern gaming setups. With its 850-watt capacity, it provides ample power for high-performance computing tasks. Engineered for efficiency and reliability, it ensures stable power delivery to your PC components. Crafted by MSI, a trusted brand in PC hardware, it guarantees performance and durability. Elevate your gaming experience with the MSI MPG A850GF for reliable operation and peace of mind.</span>
            </div>
        </div>
        </form?>
    </section>
