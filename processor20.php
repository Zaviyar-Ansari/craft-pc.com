...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 112; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/images (12).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">Intel Xeon 4116 Dodeca-core Silver</h3>
                <h2>PKR 344,067</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Xeon 4116 Dodeca-core Silver</u></b></h4>
                </div>
                <span>
                    The Intel Xeon Silver 4116 is a dodeca-core (12 cores) processor designed for professional and enterprise-level computing. It is part of the Xeon Silver series, known for its performance and reliability in server environments. With a focus on stability and robustness, Xeon Silver CPUs, including the 4116, are suitable for a range of tasks in data centers and enterprise settings. Specific details, such as clock speeds and features, may vary based on the exact model within the Xeon Silver series.</span>
            </div>
        </div>
    </form?>
    </section>
