...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 12; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg1/lian_li_lancool_ii_mesh_snow_edition_angle_closed_white_1.webp" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Apex Velocity Pro</h3>
                <h2>PKR 210,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>Cyberpunk 2077 case </u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>AMD Ryzen 7 5800X</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u> NVIDIA GeForce RTX 3060</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>ASUS ROG Strix B550-F Gaming </u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u> Corsair Vengeance RGB Pro 32GB DDR4 </u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u> Samsung 970 EVO Plus 1TB NVMe + Seagate Barracuda 2TB HDD</u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>EVGA SuperNOVA 750 G5</u></b></h4>
                </div>
                <span>The Cyberpunk 2077-themed case houses a potent system with an AMD Ryzen 7 5800X and NVIDIA GeForce RTX 3060, ensuring stellar gaming performance. The ASUS ROG Strix B550-F Gaming motherboard and 32GB of Corsair Vengeance RGB Pro DDR4 RAM offer stability and seamless multitasking. Storage combines a fast Samsung 970 EVO Plus 1TB NVMe SSD with a spacious Seagate Barracuda 2TB HDD. Powering this setup is the EVGA SuperNOVA 750 G5, an 80 Plus Gold PSU, providing reliable energy delivery. Encased in the NZXT H510 Elite, this PC delivers an immersive Cyberpunk 2077 experience with high-end specifications.</span>
