...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 96; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/124ee54e460d17b9e49daa4795d0d72c.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">Intel Core i5 12600K</h3>
                <h2>PKR 56,320</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i5 12600K</u></b></h4>
                </div>
                <span>
                    The Intel Core i5-12600K is a processor from the 12th generation Intel Core series, codenamed Alder Lake. It features 10 cores and 16 threads, utilizing a hybrid architecture with a combination of high-performance P-cores and energy-efficient E-cores. With a base clock speed of 3.7 GHz and a maximum turbo frequency, it offers strong performance for gaming, content creation, and multitasking. The processor is compatible with the LGA 1700 socket and supports DDR5 memory. It represents a mid-range option within the Alder Lake lineup, providing a good balance of price and performance. Specific details may vary based on regional availability and exact SKU.</span>
            </div>
        </div>
        </form?>
    </section>
