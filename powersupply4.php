...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 176; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/powersupply/7c53e055aefe0218992bee2204887c09.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Powersupply</h6>
                <h3 class="py-4"> Seasonic FOCUS GX-550Watt</h3>
                <h2>PKR 38,656</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u> Seasonic FOCUS GX-550Watt</u></b></h4>
                </div>
                <span>he Seasonic FOCUS GX-550Watt, a premium power supply unit designed to elevate your PC performance. With its robust construction and advanced features, it ensures reliable and efficient power delivery to your components. Certified for its high efficiency, the FOCUS GX-550Watt minimizes energy wastage, reducing operational costs. Crafted by Seasonic, a trusted name in PSU manufacturing, it guarantees stability and longevity for your system. Whether you're gaming or working, the Seasonic FOCUS GX-550Watt is the ideal choice for powering your setup to new heights of performance and reliability.
