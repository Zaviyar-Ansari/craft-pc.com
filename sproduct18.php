...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 287; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg/ASUS STRIX GTX970-DC2OC-4GD5 NVIDIA GeForce GTX 970 Graphics Card.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">ASUS STRIX GTX970-DC2Oc-4GD5</h3>
                <h2>PKR 46,300</h2>
                ...
                <span>The ASUS STRIX GTX970-DC2OC-4GD5 is a formidable graphics card designed for gamers and enthusiasts seeking exceptional performance. With 4GB of GDDR5 memory and advanced DirectCU II cooling technology, it delivers a smooth and cool gaming experience. The "OC" in its name signifies factory overclocking, pushing the card's clock speeds for enhanced gaming performance right out of the box. Its STRIX design also includes customizable RGB lighting for a touch of personalization. Equipped with ASUS's renowned build quality and reliability, this GPU is a solid choice for those looking to power their gaming rig with a high-performance graphics card.</span>
            </div>
        </div>
        </form>
    </section>
