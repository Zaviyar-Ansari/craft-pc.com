...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 177; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/powersupply/8c639f9c0b9c8220ff11fc9f23907ca8.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Powersupply</h6>
                <h3 class="py-4">Corsair Pro Series Gold AX-650</h3>
                <h2>PKR 25,751 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u> Corsair Pro Series Gold AX-650</u></b></h4>
                </div>
                <span> The Corsair Pro Series Gold AX-650, a high-quality power supply unit designed to meet the demands of modern computing. With its gold-standard efficiency rating, it optimizes energy usage, reducing operational costs while ensuring stable power delivery to your PC components. Crafted by Corsair, a trusted leader in PC hardware, it guarantees reliability and performance for both gaming and professional applications. Compact and versatile, the AX-650 is compatible with a wide range of systems, making it an ideal choice for enthusiasts and professionals alike. Elevate your computing experience with the Corsair Pro Series Gold AX-650 for efficient power delivery and exceptional performance.</span>
            </div>
        </div>
        </form?>
    </section>
