...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 69; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="mainprodimg/pordimg1.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Featured Products</h6>
                <h3 class="py-4">ZNXT pre Build PC</h3>
                <h2>PKR 1,929,399</h2>
                <input type="hidden" name="product_id" value="69"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Details</h4>
                <span>NZXT pre-built PCs offer a convenient and powerful solution for gamers and PC enthusiasts. These systems come with carefully selected components, ensuring top-tier performance right out of the box. NZXT pays attention to aesthetics, with sleek cases and RGB lighting, allowing you to enjoy both style and substance. The build quality is exceptional, and cable management is typically well-executed. NZXT provides various configurations to meet different needs, whether you're looking for a budget-friendly gaming rig or a high-end system for demanding tasks. Overall, NZXT pre-built PCs are a solid choice for those who want a hassle-free, quality gaming experience.</span>
            </div>
        </div>
        </form>
    </section>
