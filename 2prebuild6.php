...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 26; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/CLX Gaming - Gaming PCs, Prebuilt Gaming PCs, PC Builder.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Shadow Nova</h3>
                <h2>PKR 125,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>SkyTech Gaming Case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i5-11600K</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>AMD Radeon RX 6700 XT</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>MSI B550-A PRO (for AMD Ryzen 5 5600X)</u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>Corsair Vengeance LPX 16GB</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Kingston A2000 1TB NVMe</u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Corsair CV650 80 PLUS BRONZE</u></b></h4>
                </div>
                <span>The SkyTech Gaming Case houses a robust system featuring an Intel Core i5-11600K processor and an AMD Radeon RX 6700 XT GPU, ensuring high-performance gaming. Paired with the MSI B550-A PRO motherboard for compatibility with AMD Ryzen 5 5600X, it offers a stable foundation. The configuration includes Corsair Vengeance LPX 16GB RAM for efficient multitasking. Storage is handled by a spacious Kingston A2000 1TB NVMe SSD, delivering fast data access. The power supply is a reliable Corsair CV650 80 PLUS BRONZE unit, providing efficient and stable power for the entire system. This setup combines powerful components for a compelling gaming experience.</span>
