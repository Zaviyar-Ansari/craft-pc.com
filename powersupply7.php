...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 179; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/powersupply/9f2fe3d0007218ca122c5b55e76e1e39.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Powersupply</h6>
                <h3 class="py-4"> HX Series HX-750Watt 80 PLUS PLATINUM</h3>
                <h2>PKR 44,352</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u> HX Series HX-750Watt 80 PLUS PLATINUM</u></b></h4>
                </div>
                <span>The HX Series HX-750Watt is a premium power supply unit boasting 80 PLUS PLATINUM certification, ensuring exceptional efficiency. With a power output of 750 watts, it provides abundant power for demanding computing tasks. Crafted with reliability and performance in mind, this PSU delivers stable power to all your PC components. Designed by Corsair, a trusted brand in PC hardware, it guarantees seamless operation and compatibility with a variety of systems. Upgrade your PC's power performance with the HX Series HX-750Watt for dependable and efficient operation.</span>
            </div>
        </div>
        </form?>
    </section>
