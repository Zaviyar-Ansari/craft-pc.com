...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 246; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingfan/images (20).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / Cooling Fan</h6>
                <h3 class="py-4">Thermaltake SWAFAN 14 RGB Radiator Fan TT Premium </h3>
                <h2> PKR 24,989</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/download (2).png" alt=""> <b><u>Thermaltake SWAFAN 14 RGB Radiator Fan TT Premium</u></b>
                </div>
                <span> The Thermaltake SWAFAN 14 RGB Radiator Fan TT Premium – a top-of-the-line cooling solution designed to enhance both performance and aesthetics in your PC build. Featuring vibrant RGB lighting and a sleek design, this fan adds a stunning visual element to your setup. Engineered for optimal airflow and heat dissipation, it ensures efficient cooling for your components, even under heavy workloads. Compatible with Thermaltake's TT RGB PLUS software, you can customize the RGB lighting effects to match your build's theme or sync it with other RGB components. Elevate your cooling system with the Thermaltake SWAFAN 14 RGB Radiator Fan TT Premium for superior cooling performance and customizable RGB effects.</span>
            </div>
        </div>
    </form>
