...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 221; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/cpucooler/b0809daf785ac2ef468c336c2b3c5bfb.jpg"" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4">Corsair A500 Dual Fan CPU Cooler </h3>
                <h2> PKR 28,507</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/istockphoto-1373113476-612x612 (1).jpg" alt=""> <b><u> Corsair A500 Dual Fan CPU Cooler</u></b>
                </div>
                <span> The Corsair A500 Dual Fan CPU Cooler provides exceptional cooling performance for your processor. With its innovative design and dual-fan configuration, it efficiently dissipates heat to maintain optimal temperatures even under heavy workloads or gaming sessions. The A500 features a high-surface-area cold plate and four direct-contact copper heat pipes for maximum heat transfer. Its adjustable fan speeds and low-noise operation make it ideal for both overclocked systems and quiet builds. Upgrade your cooling solution with the Corsair A500 for reliable performance and efficient heat management.</span>
            </div>
        </div>
    </form>
