...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 157; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ssd/9fbf80c80c6c195e8a53b417e8ba824b.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / SSD</h6>
                <h3 class="py-4">Corsair MP600 PRO XT 1TB M.2 NVMe PCIe Gen.4x4 SSD</h3>
                <h2>PKR 21,118</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Corsair MP600 PRO XT 1TB M.2 NVMe PCIe Gen.4x4 SSD</u></b></h4>
                </div>
                <span>The Corsair MP600 PRO XT 1TB M.2 NVMe PCIe Gen.4x4 SSD is a top-tier storage solution offering exceptional performance and reliability. With its PCIe Gen.4x4 interface, it delivers blazing-fast data transfer speeds, ensuring swift system boot-up and application loading times. Boasting a spacious 1TB capacity, it provides ample storage space for your operating system, games, and multimedia files. Designed for enthusiasts and professionals, this SSD features advanced technologies like dynamic thermal throttling and error correction for optimal performance and data integrity. Upgrade to the Corsair MP600 PRO XT SSD for unparalleled speed and efficiency in your computing tasks.</span>
            </div>
        </div>
        </form>
    </section>
