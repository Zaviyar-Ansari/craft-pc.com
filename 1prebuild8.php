...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 8; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg1/JONSBO MechWarrior MOD3.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Titan Forge X1</h3>
                <h2>PKR 140,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u> JONSBO MechWarrior MOD3</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i5-10400F</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>AMD Radeon RX 580 </u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u> ASUS Prime B460M-A</u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>  16GB DDR4</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>1TB HDD + 120GB SSD </u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Cooler Master MWE 550W (80+ White) </u></b></h4>
                </div>
                <span>The JONSBO MechWarrior MOD3 combines an Intel Core i5-10400F processor with an AMD Radeon RX 580 for a well-rounded gaming setup. The ASUS Prime B460M-A motherboard ensures stability and reliability. With 16GB of DDR4 RAM, multitasking is smooth, complemented by a 1TB HDD and a fast 120GB SSD for ample storage and quick data access. The Cooler Master MWE 550W (80+ White) power supply provides efficient and reliable energy delivery. Encased in the sleek NZXT H510 Mid Tower, this PC offers a compelling blend of performance and storage for an immersive computing experience.</span>
