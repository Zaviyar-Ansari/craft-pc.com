...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 15; // Set the product ID to 3
    ...
    <form action="#" method="post">
        ...
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg1/download.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Electro Elysium</h3>
                <h2>PKR 170,000</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>OcUK Gaming Glaciar</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>AMD Ryzen 9 5900X  </u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GeForce RTX 3070  </u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>ASUS ROG Strix B550-F Gaming</u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u> Corsair Vengeance RGB Pro 32GB </u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Samsung 970 EVO Plus 1TB NVMe M.2 </u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>EVGA SuperNOVA 750 G5 </u></b></h4>
                </div>
                <span>The OcUK Gaming Glaciar is equipped with a potent AMD Ryzen 9 5900X processor and a high-performance NVIDIA GeForce RTX 3070 graphics card for exceptional gaming and graphics capabilities. The ASUS ROG Strix B550-F Gaming motherboard ensures stability and features. With 32GB of Corsair Vengeance RGB Pro DDR4 RAM, it offers efficient multitasking. Storage is handled by a speedy 1TB Samsung 970 EVO Plus NVMe M.2 SSD. The system is powered by the reliable EVGA SuperNOVA 750 G5, providing ample power for the components. Overall, it's a high-end gaming PC with top-notch specifications.
                </span>
