...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 20; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg1/MYRMICA SERIES BY ANT PC_ Video editing workstation.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">Spectrum Supreme</h3>
                <h2>PKR 175,000 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>MSI MPG Series SEKIRA 500P</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>AMD Ryzen 5 5600X </u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GeForce RTX 3060  </u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>MSI B450 TOMAHAWK MAX </u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u> Corsair Vengeance LPX 16GB DDR4 </u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u> Kingston A2000 2TB NVMe M.2 </u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>EVGA 600 W1, 80+ WHITE </u></b></h4>
                </div>
                <span>The MSI MPG Series SEKIRA 500P system is powered by the AMD Ryzen 5 5600X processor and a NVIDIA GeForce RTX 3060, offering a balanced performance for gaming and multitasking. The MSI B450 TOMAHAWK MAX motherboard provides stability and essential features. With 16GB of Corsair Vengeance LPX DDR4 RAM, the system ensures efficient multitasking. Storage is managed by a fast 2TB Kingston A2000 NVMe M.2 SSD for quick access to data. The EVGA 600 W1, 80+ WHITE power supply, delivers reliable and efficient power to the components, completing a well-rounded and budget-friendly PC setup.</span>
