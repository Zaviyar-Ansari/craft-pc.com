...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 93; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/3d05d51cc87c6c6d23b8a0546b0a7919.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">AMD Ryzen 7 5800X</h3>
                <h2>PKR 75,990</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>AMD Ryzen 7 5800X</u></b></h4>
                </div>
                <span>
                    The AMD Ryzen 7 5800X is a high-performance processor from the Ryzen 5000 series. It features 8 cores and 16 threads, based on the Zen 3 architecture. With a base clock speed of 3.8 GHz and a maximum boost clock of 4.7 GHz, it offers strong single-threaded and multi-threaded performance. The processor is designed for gaming and content creation tasks, making it a popular choice among enthusiasts seeking a balance of high-speed computing and multitasking capabilities. Please note that specific details, such as clock speeds and core counts, may vary depending on the specific SKU and regional availability.</span>
            </div>
        </div>
        </form?>
    </section>
