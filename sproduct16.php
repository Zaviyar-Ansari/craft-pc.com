...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 285; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg/ASUS GeForce® RTX 2080 O8G ROG STRIX OC Edition GDDR6 HDMI DP 1_4 Type-C graphics card (ROG-STRIX-RTX2080-O8G-GAMING).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">ASUS GeForce® RTX 2080 O8G</h3>
                <h2>PKR 105,570</h2>
                ...
                <span>The ASUS GeForce RTX 2080 O8G is a powerhouse of a graphics card designed for gamers and content creators seeking top-tier performance. With 8GB of GDDR6 memory, it's well-equipped to handle demanding gaming scenarios and resource-intensive tasks. This GPU's "O8G" designation suggests it's factory-overclocked for enhanced speeds straight out of the box, ensuring smooth gaming experiences. It also boasts the advanced Ray Tracing and AI capabilities of the RTX series, providing stunning visual effects and realism in compatible games. ASUS's cooling solutions and robust build quality make sure the card operates efficiently and reliably, even during extended gaming sessions. If you're aiming for high-quality gaming and content creation, the RTX 2080 O8G is a formidable choice.</span>
            </div>
