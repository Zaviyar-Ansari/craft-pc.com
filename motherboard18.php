...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 89; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/motherboard/Make it your own_ The ASUS 3D Printing Project 2.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Motherboards</h6>
                <h3 class="py-4">Asus ROG Maximus IX Extreme LGA 1151</h3>
                <h2>PKR 99,639</h2>
                ...
                <div class="icon">
                    <h4> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>Asus ROG Maximus IX Extreme LGA 1151</u></b>
                </div>
                <span>The Asus ROG Maximus IX Extreme is a motherboard designed for 7th generation Intel Core processors, utilizing the LGA 1151 socket. Built on the Intel Z270 chipset, it offers high-end features for gaming and performance. With an ATX form factor, it supports multiple PCIe slots, DDR4 memory, and advanced overclocking capabilities. The motherboard is part of the Republic of Gamers (ROG) series, known for catering to gaming enthusiasts with premium components and customizable aesthetics. Please note that specifications and availability may vary based on region and updates.</span>
            </div>
        </div>
        </form>
    </section>
