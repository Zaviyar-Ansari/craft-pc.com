...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 30; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="prebuildimg2/Clx Set Vr Gaming Desktop, I9-13900Kf, 64Gb, 1Tb Ssd+6Tb Hdd, Rtx 4080, W11H In White.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Pre Build</h6>
                <h3 class="py-4">ProCreator Plus</h3>
                <h2>PKR 160,000 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-pc-case-6011776.png" alt=""> <b><u>CLX SET Gaming Case</u></b> <img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i5-11400</u></b></h4>
                    <h4> <img src="preduilticon/noun-graphic-card-2071184.png" alt=""> <b><u>NVIDIA GeForce RTX 3060</u></b> <img src="preduilticon/noun-motherboard-3140591.png" alt=""> <b><u>ASUS ROG Strix B550-F</u></b></h4>
                    <h4> <img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>Corsair Vengeance LPX 16GB</u></b> <img src="preduilticon/noun-ssd-2374273.png" alt=""> <b><u>Kingston A2000 500GB NVMe PCIe M.2 & Seagate Barracuda 1TB HDD</u></b></h4>
                    <h4><img src="preduilticon/noun-power-supply-6376705.png" alt=""> <b><u>Corsair CV550</u></b></h4>
                </div>
                <span>
                    CLX SET Gaming Case with an Intel Core i5-11400 processor and powerful NVIDIA GeForce RTX 3060 graphics, providing an immersive gaming experience. It features the ASUS ROG Strix B550-F motherboard for reliable performance. The system is equipped with Corsair Vengeance LPX 16GB RAM, ensuring smooth multitasking. Storage includes a speedy Kingston A2000 500GB NVMe PCIe M.2 SSD for quick access and a Seagate Barracuda 1TB HDD for ample data storage. The setup is powered by a Corsair CV550 PSU, offering stable and efficient power delivery. This configuration delivers a balanced gaming PC with performance and storage versatility.</span>
            </div>
        </div>
        </form>
    </section>
