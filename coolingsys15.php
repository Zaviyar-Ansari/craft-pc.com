...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 268; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingsystem/images (41).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                ...
                <span>The DIY Water Cooling System Pack priced at PKR 43,990. This comprehensive pack provides an efficient water cooling solution for your PC, ensuring optimal performance and temperature management. With its easy installation process and inclusive components, it offers convenience and reliability. Upgrade your PC's cooling system with this pack for improved thermal efficiency and enhanced performance. </span>
            </div>
        </div>
    </form>
