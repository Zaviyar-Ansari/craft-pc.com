...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 225; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/cpucooler/f9fa8c4490c42723e30462f6cc922b54.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4">Cooler Master Hyper TX3 EVO </h3>
                <h2>PKR 31,113 </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/istockphoto-1373113476-612x612 (1).jpg" alt=""> <b><u> Cooler Master Hyper TX3 EVO</u></b>
                </div>
                <span>The Cooler Master Hyper TX3 EVO CPU Air Cooler – a high-performance cooling solution designed to keep your processor running smoothly. With its sleek design and advanced cooling technology, it delivers efficient heat dissipation for optimal performance. Featuring a compact profile, it fits easily into various PC builds without compromising space. Equipped with three direct contact heat pipes and a unique fin design, it effectively cools your CPU even under heavy loads. Compatible with a wide range of Intel and AMD sockets, it offers versatility for different system configurations. Upgrade your cooling setup with the Cooler Master Hyper TX3 EVO and enjoy enhanced performance for your gaming or productivity needs. </span>
            </div>
        </div>
    </form>
