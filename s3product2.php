...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 311; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg3/EK® is releasing a new AM4 monoblock for the ASRock®Fatal1ty X470 Gaming K4 motherboards!.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">EK® AM4 monoblock ASRock®Fatal1ty X470 motherboards</h3>
                <h2>PKR 40,895</h2>
                <input type="hidden" name="product_id" value="311"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Details</h4>
                <span>The EK® AM4 monoblock is a specialized cooling solution designed for ASRock® Fatal1ty X470 motherboards. This monoblock efficiently cools both the CPU and the VRM (Voltage Regulator Module), ensuring optimal thermal performance, which is especially beneficial for overclocking and demanding tasks. By covering both components, it simplifies the cooling system and enhances the aesthetic appeal with its sleek design. The AM4 compatibility ensures it works seamlessly with AMD Ryzen processors. If you own an ASRock® Fatal1ty X470 motherboard and seek efficient cooling for your CPU and VRM components, the EK® AM4 monoblock is a practical choice.</span>
            </div>
        </div>
        </form>
    </section>
