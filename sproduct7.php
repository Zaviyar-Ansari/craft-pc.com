...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 276; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg/Best Buy_ ASUS ROG STRIX Z390-E GAMING (Socket LGA1151) USB 3_1 Gen 1 Intel Motherboard with LED Lighting ROG STRIX Z390-E GAMING.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">ASUS ROG STRIX Z390-E</h3>
                <h2>PKR 44,160</h2>
                ...
                <span>The ASUS ROG STRIX Z390-E is a high-end motherboard tailored for gaming and performance enthusiasts. It's designed to support Intel 8th and 9th generation processors, featuring the LGA1151 socket. With an ATX form factor, it offers plenty of room for expansion and customization. The motherboard comes with robust features, including dual M.2 slots, support for USB 3.1 Gen2, and comprehensive RGB lighting options. It also boasts SupremeFX audio for immersive gaming experiences. Additionally, its Wi-Fi connectivity and excellent overclocking capabilities make it a popular choice among gamers and power users seeking top-tier performance and aesthetics.</span>
            </div>
        </div>
        </form>
    </section>
