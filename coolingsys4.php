...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 257; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/collingsystem/images (30).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6>Home / Acessories / CPU Cooler</h6>
                <h3 class="py-4">Aragon 900 Liquid Cooling System</h3>
                <h2>PKR 23,445  </h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/resized-images.png" alt=""> <b><u> Aragon 900 Liquid Cooling System </u></b>
                </div>
                <span> The Aragon 900 Liquid Cooling System. This system offers efficient water cooling for your PC, ensuring optimal performance. With its advanced design, it effectively dissipates heat from your components, maintaining stable temperatures. The Aragon 900 is easy to install and provides reliable cooling for your system. Upgrade your PC's cooling with the Aragon 900 and enjoy quieter operation and improved performance.</span>
            </div>
        </div>
    </form>
