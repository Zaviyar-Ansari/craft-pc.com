...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 113; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/ram/0dedd143eb36ab2b4d35d9dbe70adce1.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / RAM</h6>
                <h3 class="py-4">Trident Z Royal 16gb</h3>
                <h2>PKR 28,199</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-ram-1724288.png" alt=""> <b><u>Trident Z Royal 16gb</u></b></h4>
                </div>
                <span>
                    The Trident Z Royal 16GB RGB RAM offers a stunning combination of aesthetics and performance. Its regal design, featuring a polished aluminum heat spreader and customizable RGB lighting, transforms your PC into a visual masterpiece. Beyond the captivating exterior, this RAM excels in delivering efficient multitasking and responsive performance, making it ideal for gaming and resource-intensive tasks. While priced at a premium, the Trident Z Royal justifies its cost by providing a royal upgrade that enhances both the look and capabilities of your system.</span>
