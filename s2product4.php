...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 293; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="shopprodimg2/ADATA XPG SPECTRIX D41 3000MHz RGB Memory Review.jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Shop / Featured Products</h6>
                <h3 class="py-4">ADATA XPG SPECTRIX D41 3000MHz RGB</h3>
                <h2>PKR 39,559</h2>
                ...
                <span>The ADATA XPG SPECTRIX D41 3000MHz RGB is a standout memory module that not only offers impressive performance but also adds a vibrant visual element to your PC build. With a clock speed of 3000MHz, it delivers rapid data access and transfer speeds, ideal for gaming and multitasking. The RGB lighting on this memory module is customizable, allowing you to match your build's color scheme and create dynamic lighting effects. The XPG SPECTRIX D41 is built with both reliability and aesthetics in mind, making it a great choice for gamers and enthusiasts looking to boost their system's performance and style. It's a solid addition to any gaming rig or high-performance PC.</span>
