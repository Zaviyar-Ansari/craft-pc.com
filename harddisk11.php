...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 203; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/harddisk/images (5).jpeg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Harddisk</h6>
                <h3 class="py-4">WD 1000 Hard Drive 1TB</h3>
                <h2>PKR 7,999</h2>
                <input type="hidden" name="product_id" value="203"> <!-- Set the product ID -->
                    <input type="submit" class="buy-btn" value="Add to Cart" name="add_to_cart">
                <h4 class="mt-5 mb-5">Product Specification</h4>
                <div class="icon">
                    <h4><img src="preduilticon/1969572 (1).png" alt=""> <b><u>WD 1000 Hard Drive 1TB</u></b>
                </div>
                <span>The WD 1000 Hard Drive offers 1TB of storage capacity, providing ample space for your files, documents, and multimedia content. With its reliable design and sturdy construction, it ensures durability and longevity for your data storage needs. Ideal for both personal and professional use, this hard drive delivers consistent performance and fast data access speeds. Whether you're storing documents, photos, videos, or games, the WD 1000 Hard Drive offers a reliable storage solution at an affordable price point. Upgrade your storage capabilities with this dependable 1TB hard drive from WD.</span>
            </div>
        </div>
        </form>
    </section>
