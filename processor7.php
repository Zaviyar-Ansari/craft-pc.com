...
if(isset($_POST['add_to_cart'])){
    ...
    $product_id = 99; // Set the product ID to 3
    ...
    <form action="#" method="post">
        <div class="row mt-5">
            <div class="col-lg-5 col-md-12 col-12">
                <img class="img-fluid w-100 pb-1" src="accessories/processor/919597ed66f9cb3ff6c812b64dad08f2.jpg" id="MainImg" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-12">
                <h6> Home / Acessories / Processor</h6>
                <h3 class="py-4">Intel Core i7-8700K</h3>
                <h2>PKR 68,520</h2>
                ...
                <div class="icon">
                    <h4><img src="preduilticon/noun-cpu-1136736.png" alt=""> <b><u>Intel Core i7-8700K</u></b></h4>
                </div>
                <span>
                    The Intel Core i7-8700K is a high-performance processor from the 8th generation Intel Core series. It features 6 cores and 12 threads, with a base clock speed of 3.7 GHz and a maximum turbo frequency of 4.7 GHz. Built on the Coffee Lake architecture and utilizing the LGA 1151 socket, it delivers strong multi-threaded and single-threaded performance. Widely used for gaming, content creation, and multitasking, the i7-8700K is known for its versatility and solid performance. It's often chosen by enthusiasts for its overclocking capabilities. Specific details may vary based on regional availability and exact SKU.</span>
            </div>
        </div>
        </form?>
    </section>
